...
switch($mode) {
    ...
    default:
        ...
        $tab .= "</tbody>";
        $tab .= "<tfoot><tr class=rowcontent><td colspan=5>Total</td><td align=right>".number_format($tmaterial,2)."</td><td align=right>".number_format($tharga)."</td><td align=right>".number_format($tluas,2)."</td><td>&nbsp;</td></tr></tbody>";
