...
$str=" select a.idkomponen,a.karyawanid,a.jumlah,b.namakaryawan,b.subbagian from ".$dbname.".sdm_gaji a
			...
			$rJrnid=mysql_fetch_assoc($qJrnid);
					...
					if(substr($_SESSION['empl']['lokasitugas'],3,1)=='E'){
						...
						if($_SESSION['empl']['lokasitugas']=='KARO'){
							$sJrnid="select jurnalid,noakundebet,noakunkredit from ".$dbname.".keu_5parameterjurnal where jurnalid='SAPI0'";
							$qJrnid=mysql_query($sJrnid) or die(mysql_error($conn));
							$rJrnid=mysql_fetch_assoc($qJrnid);
						}
						$dataRes['detail'][] = array(
