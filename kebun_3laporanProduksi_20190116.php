...
$frm[1].="<tr><td>".$_SESSION['lang']['periode']."</td><td><select id=periodeId style=width:150px>".$optper."</select></td></tr>";
$frm[1].="<tr><td>".$_SESSION['lang']['unit']."</td><td><select id=unitId style=width:150px>".$optUniDt."</select></td></tr>";
$frm[1].="<tr><td>".$_SESSION['lang']['intiplasma']."</td><td><select id=intiplasma style=width:150px>".$intiplasma."</select></td></tr>";
