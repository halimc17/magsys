...
OPEN_BOX('','<b>'.strtoupper($_SESSION['lang']['breakdown']."/".$_SESSION['lang']['unit']).'</b>'); //1 O
?>
<!--<script type="text/javascript" src="js/log_2keluarmasukbrg.js" /></script>
-->
<script type="text/javascript" src="js/vhc_2breakdownunit.js" /></script>
<div id="action_list">
<?php
...
echo"<table>
     <tr valign=moiddle>
                 <td><fieldset><legend>".$_SESSION['lang']['pilihdata']."</legend>"; 
                        ...
                        echo $_SESSION['lang']['jenisvch'].":<select id=jnsVhc name=jnsVhc onchange=\"getKdVhc()\" style=width:100px><option  value=''>".$_SESSION['lang']['pilihdata']."</option></select>&nbsp;";
                        echo $_SESSION['lang']['kodevhc'].":<select id=kdVhc name=kdVhc style=width:100px><option  value=''>".$_SESSION['lang']['pilihdata']."</option></select>&nbsp;";
...
<div id="cari_barang" name="cari_barang">
   <div id="hasil_cari" name="hasil_cari">
    ...
    <legend><?php echo $_SESSION['lang']['result']?></legend>
     <img onclick=dataKeExcel(event,'vhc_slave_2breakdownunit.php') src=images/excel.jpg class=resicon title='MS.Excel'> 
