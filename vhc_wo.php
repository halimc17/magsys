...
if(empty($optKaryawan2)) $optKaryawan2 = "<option value=''></option>";
...
echo"<fieldset style='width:500px;'>
    ...
    <tr><td>".$_SESSION['lang']['tanggal']."</td>
        <td><input type=text class=myinputtext id=tanggal onchange=cekBalaka() onmousemove=setCalendar(this.id)
		onkeypress=return false;  size=10 maxlength=10 style=\"width:100px;\"/></td>
    </tr>
    ...
    <tr><td>".$_SESSION['lang']['operator']."</td>
        <td><select id=operator style='width:150px;' onchange=cekBalaka()>".$optOperator."</select></td>
    </tr>
    ...
    <tr><td>".$_SESSION['lang']['noberitaacara']."</td>
        <td><select id=noberitaacara style='width:150px;' onchange='setSebab()'><option value=''></option></select></td>
    </tr>
	<tr><td>".$_SESSION['lang']['penyebabrusak']."</td>
        <td><select id=penyebabrusak style='width:150px;' disabled>".$optSebabRusak."</select></td>
    </tr>
