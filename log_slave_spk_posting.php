...
switch($proses)
{
	...
	if($rCek>0)
	{
		...
		{
			$sUp="update  ".$dbname.".log_spkht set posting='1' where notransaksi='".$noTrans."' and kodeorg='".$param['kodeorg']."'";
			...
			{
				$sUpBaspk="update ".$dbname.".log_baspk set posting='1' where notransaksi='".$noTrans."' and kodeblok like '".$param['kodeorg']."%'";
				if(!mysql_query($sUpBaspk))
				{
					$sUp="update  ".$dbname.".log_spkht set posting='0' where notransaksi='".$noTrans."' and kodeorg='".$param['kodeorg']."'";
