...
$nmOrg=makeOption($dbname,'organisasi','kodeorganisasi,namaorganisasi');
	...
	$pdf->Ln();	
        ...
        $pdf->Cell(50,$heightMesin,'',1,0,'L');
        $pdf->Cell(15,$heightMesin,'Nomor',1,0,'L');
        $pdf->Cell(20,$heightMesin,'',1,0,'L');
        $pdf->Cell(25,$heightMesin,'Stasiun',1,0,'L');
        ...
        //$pdf->SetXY(90, $ybaru);
        $pdf->SetFont('Arial','BU',9); 
        $pdf->Cell(80,5,'Komentar / Saran  -  Spv. / Mill Head. Proses  :',TRL,0,'L');
        $pdf->SetFont('Arial','',9); 
