<?php
	...
	if($jenistransaksi=='' or $jenistransaksi=='spatbs'){
		$str="select 'SPATBS' as jenistr,a.nospb as notransaksi,a.tanggal,a.kodeorg,b.namaorganisasi,if(isnull(left(e.blok,6)),a.penerimatbs,left(e.blok,6)) as tipe_tr
