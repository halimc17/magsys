<?php
	...
	$stream.="<B>Outstanding Cntract:</B>";
    ...
    $stream.="<table cellspacing='1' border='".$brd."' class='sortable'>
        ...
        <tr>
	        ...
	        <td width='20%' ".$bgclr.">".$_SESSION['lang']['NoKontrak']."</td>
	        <td width='7%' ".$bgclr.">".$_SESSION['lang']['tanggal']."</td>
	        <td width='9%' ".$bgclr.">Storage 01</td>
	        <td width='9%' ".$bgclr.">Storage 02</td>
		    <td width='9%' ".$bgclr.">Luar Storage</td>
			<td width='9%' ".$bgclr.">CPO</td>
	        <td width='9%' ".$bgclr.">Kernel</td>
		    <td width='9%' ".$bgclr.">".$_SESSION['lang']['harga']."/Kg (Excl) </td>
	        <td width='14%' ".$bgclr.">Outstanding ".$_SESSION['lang']['rupiah']."</td>";
	$stream.="</tr></thead><tbody>";
    ...
    $stream.="<table cellspacing='1' border='".$brd."' class='sortable'>
        ...
        <tr>
	        ...
	        <td width='14%' ".$bgclr.">Outstanding ".$_SESSION['lang']['rupiah']."</td>";
	$stream.="</tr></thead><tbody>";
	$str2="SELECT a.*,if(isnull(b.beratkirim),0,b.beratkirim) as beratkirim,a.qtykontrak-if(isnull(b.beratkirim),0,b.beratkirim) as extoutstanding 
			FROM ".$dbname.".pmn_traderht a
			LEFT JOIN  (SELECT nokontrakext,sum(beratbersih) as beratkirim FROM ".$dbname.".pmn_traderdt WHERE posting=1
