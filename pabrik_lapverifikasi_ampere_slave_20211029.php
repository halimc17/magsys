<?php
	...
	foreach($kodemesin as $mdid=>$mdval)
    {
		...
		for ($tangval = 1; $tangval <= 12; $tangval++){
			...
			$stream.="<td title='Click untuk cetak detail.' align=right style=\"cursor: pointer\" onclick=showpopup('".$mdid."','".$bln."','".$kdOrg."','".$stasiun."','',event)>".@number_format($standard[$mdid][$bulan],2)."</td>";
			$stream.="<td title='Click untuk cetak detail.' align=right style=\"cursor: pointer\" onclick=showpopup('".$mdid."','".$bln."','".$kdOrg."','".$stasiun."','',event)>".@number_format($ukur1[$mdid][$bulan],2)."</td>";
			$stream.="<td title='Click untuk melihat detail.' align=right style=\"cursor: pointer\" onclick=showpopup('".$mdid."','".$bln."','".$kdOrg."','".$stasiun."','',event)>".@number_format($ukur2[$mdid][$bulan],2)."</td>";
			$stream.="<td title='Click untuk cetak detail.' align=right style=\"cursor: pointer\" onclick=showpopup('".$mdid."','".$bln."','".$kdOrg."','".$stasiun."','',event)>".@number_format($ukur3[$mdid][$bulan],2)."</td>";
			$stream.="<td title='Click untuk melihat detail.' align=right style=\"cursor: pointer\" onclick=showpopup('".$mdid."','".$bln."','".$kdOrg."','".$stasiun."','',event)>".@number_format($ukurrata2[$mdid][$bulan],2)."</td>";
			$stream.="<td title='Click untuk melihat detail.' align=right style=\"cursor: pointer\" onclick=showpopup('".$mdid."','".$bln."','".$kdOrg."','".$stasiun."','',event)>".@number_format($selisih[$mdid][$bulan],2)."</td>";
		}
