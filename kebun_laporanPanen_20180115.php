...
//=================================================
	...
	while($bar=mysql_fetch_object($res))
	{
		...
		echo"<tr class=rowcontent>
				  ...
				  <td align=center style='cursor:pointer;' title='Click' onclick=\"zDetail(event,'kebun_slave_2panen.php','".$arr."');\">".$kodeorg."</td>
				  <td align=center style='cursor:pointer;' title='Click' onclick=\"zDetail(event,'kebun_slave_2panen.php','".$arr."');\">".$bar->intiplasma."</td>
                                  ...
                                  <td align=right style='cursor:pointer;' title='Click' onclick=\"zDetail(event,'kebun_slave_2panen.php','".$arr."');\">".number_format($bar->premibasis,2)."</td>
