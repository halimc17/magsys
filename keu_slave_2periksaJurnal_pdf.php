...
### Get Organition Unit ###
$optOrgName = makeOption($dbname, 'organisasi', 'kodeorganisasi,namaorganisasi');
...
//		$this->Cell(20,3,$unit.' '.$periode,'',1,'L');
		$this->SetFont('Arial','B',9);
		$this->Cell(190,20,$_SESSION['org']['namaorganisasi'],0,1,'R');
		...
		$this->Cell(2,3,':','',0,'L');
		$this->Cell(35,3,date('d-m-Y'),0,1,'L'); 
		$this->Cell(150,3,'UNIT : '.$optOrgName[$unit],'',0,'L');
