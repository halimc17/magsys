...
$frm[0].="<div><fieldset>
<legend><b>".$_SESSION['lang']['rpperjamKend']."</b></legend>
...
<tr><td colspan=2><button onclick=\"zPreview('bgt_slave_laporan_rp_jam_kendaraan','".$arr."','printContainer')\" class=mybutton name=preview id=preview>Preview</button>
...
$frm[1].="<div><fieldset>
<legend><b>".$_SESSION['lang']['alokasi'].' '.$_SESSION['lang']['rpperjamKend']."</b></legend>
<table cellspacing=1 border=0 >
<tr><td><label>".$_SESSION['lang']['budgetyear']."</label></td><td><select id='thnBudget2' style=\"width:150px;\">".$optThn."</select></td></tr>
<tr><td><label>".$_SESSION['lang']['kodetraksi']."</label></td><td><select id='kdUnit2'  style=\"width:150px;\">".$optOrg."</select></td></tr>
<tr height=20><td colspan=2>&nbsp;</td></tr>
<tr><td colspan=2><button onclick=\"zPreview('bgt_slave_laporan_rp_jam_kendaraan2','".$arr2."','printContainer2')\" class=mybutton name=preview id=preview>Preview</button>
