...
$millcode= checkPostGet('pabrik2','');
$tgl1 = tanggalsystemn(checkPostGet('tgl12',''));
$tgl2 = tanggalsystemn(checkPostGet('tgl22',''));
...
//,SUM(if(jjgsortasli>0,1,0)) as truck,SUM(if(jjgsortasli>0,beratbersih,0)) as nettogrding,sum(jjgsortasli) as jjggrading
...
$iList="select x.millcode,left(x.tanggal,10) as tanggal,if(substr(x.nospb,9,6)='' or substr(x.nospb,9,6)='0','XT_TBS',substr(x.nospb,9,6)) as afdeling
			...
			,sum(x.beratbersih) as beratbersih,sum(x.jumlahtandan1) as janjang,sum(if(x.jjgsortasli>0,1,0)) as truck
			,sum(if(x.kgpotsortasli>0,x.beratbersih,0)) as kgsortasi,sum(x.kgpotsortasli) as kgpotsortasi
			,sum(x.kgpotsortasli)/sum(if(x.kgpotsortasli>0,x.beratbersih,0))*100 as penaltygrading,sum(x.jjgsortasli) as jjgsortasi
			,sum(w.A) as A,sum(w.B) as B,sum(w.C) as C,sum(w.D) as D,sum(w.E) as E,sum(w.F) as F,sum(w.G) as G
 			,sum(w.A)/sum(x.jjgsortasli)*100 as pA
 			,sum(w.B)/sum(x.jjgsortasli)*100 as pB
			,sum(w.C)/sum(x.jjgsortasli)*100 as pC
			,sum(w.D)/sum(x.jjgsortasli)*100 as pD
			,sum(w.E)/sum(x.jjgsortasli)*100 as pE
			,sum(w.F)/sum(x.jjgsortasli)*100 as pF
			,sum(w.G)/sum(x.jjgsortasli)*100 as pG
			,sum(w.A)/sum(x.jjgsortasli)*100*(sum(w.pA)/sum(x.jjgsortasli)*100) as gA
 			,if((sum(w.B)/sum(x.jjgsortasli)*100)-5<=0,0,((sum(w.B)/sum(x.jjgsortasli)*100)-5)*(sum(w.pB)/sum(x.jjgsortasli)*100)) as gB
			,sum(w.C)/sum(x.jjgsortasli)*100*(sum(w.pC)/sum(x.jjgsortasli)*100) as gC
			,sum(w.D)/sum(x.jjgsortasli)*100 as gD
			,sum(w.E)/sum(x.jjgsortasli)*100*(sum(w.pE)/sum(x.jjgsortasli)*100) as gE
			,sum(w.F)/sum(x.jjgsortasli)*100*(sum(w.pF)/sum(x.jjgsortasli)*100) as gF
			,(12.5-(sum(w.G)/sum(x.jjgsortasli)*100))*(sum(w.pG)/sum(x.jjgsortasli)*100) as gG
			,(sum(w.A)/sum(x.jjgsortasli)*100*(sum(w.pA)/sum(x.jjgsortasli)*100))
			+(if((sum(w.B)/sum(x.jjgsortasli)*100)-5<=0,0,((sum(w.B)/sum(x.jjgsortasli)*100)-5)*(sum(w.pB)/sum(x.jjgsortasli)*100)))
			+(sum(w.C)/sum(x.jjgsortasli)*100*(sum(w.pC)/sum(x.jjgsortasli)*100))
			+(sum(w.E)/sum(x.jjgsortasli)*100*(sum(w.pE)/sum(x.jjgsortasli)*100))
			+(sum(w.F)/sum(x.jjgsortasli)*100*(sum(w.pF)/sum(x.jjgsortasli)*100))
			+((12.5-(sum(w.G)/sum(x.jjgsortasli)*100))*(sum(w.pG)/sum(x.jjgsortasli)*100)) as pengrading
 			,sum(w.A)/sum(x.jjgsortasli)*100*(sum(w.pA)/sum(x.jjgsortasli)*100)*sum(x.beratbersih)/100 as kgunripe
 			,if((sum(w.B)/sum(x.jjgsortasli)*100)-5<=0,0,((sum(w.B)/sum(x.jjgsortasli)*100)-5)*(sum(w.pB)/sum(x.jjgsortasli)*100))*sum(x.beratbersih)/100 as kgoverripe
			,sum(w.C)/sum(x.jjgsortasli)*100*(sum(w.pC)/sum(x.jjgsortasli)*100)*sum(x.beratbersih)/100 as kgemptybunch
			,sum(w.D)/sum(x.jjgsortasli)*100*sum(x.beratbersih)/100 as kgabnormal
			,sum(w.E)/sum(x.jjgsortasli)*100*(sum(w.pE)/sum(x.jjgsortasli)*100)*sum(x.beratbersih)/100 as kgrottenbunch
			,sum(w.F)/sum(x.jjgsortasli)*100*(sum(w.pF)/sum(x.jjgsortasli)*100)*sum(x.beratbersih)/100 as kglongstalk
			,(12.5-(sum(w.G)/sum(x.jjgsortasli)*100))*(sum(w.pG)/sum(x.jjgsortasli)*100)*sum(x.beratbersih)/100 as kgfruitlooses
			,((sum(w.A)/sum(x.jjgsortasli)*100*(sum(w.pA)/sum(x.jjgsortasli)*100))
			+(if((sum(w.B)/sum(x.jjgsortasli)*100)-5<=0,0,((sum(w.B)/sum(x.jjgsortasli)*100)-5)*(sum(w.pB)/sum(x.jjgsortasli)*100)))
			+(sum(w.C)/sum(x.jjgsortasli)*100*(sum(w.pC)/sum(x.jjgsortasli)*100))
			+(sum(w.E)/sum(x.jjgsortasli)*100*(sum(w.pE)/sum(x.jjgsortasli)*100))
			+(sum(w.F)/sum(x.jjgsortasli)*100*(sum(w.pF)/sum(x.jjgsortasli)*100))
			+((12.5-(sum(w.G)/sum(x.jjgsortasli)*100))*(sum(w.pG)/sum(x.jjgsortasli)*100)))*sum(x.beratbersih)/100 as kggrading
...
switch($proses){
	...
	case 'excel':
		...
		$judul.="<BR>".($divisi=='' ? $nmOrg[$millcode] : $nmOrg[$divisi])."";
