			...
			case'loadData':
				...
				if($_SESSION['empl']['tipelokasitugas'] == 'HOLDING' and ($_SESSION['empl']['bagian'] == 'HHRD' || $_SESSION['empl']['bagian'] == 'HHRS' || $_SESSION['empl']['bagian'] == 'HHSE' || $_SESSION['empl']['bagian'] == 'HRA'|| substr($_SESSION['empl']['bagian'],0,3) == 'URD')){
					...
					if($_SESSION['empl']['bagian'] == 'HHRD' || $_SESSION['empl']['bagian'] == 'HHRS' || $_SESSION['empl']['bagian'] == 'HRA'|| substr($_SESSION['empl']['bagian'],0,3) == 'URD'){
						...
						$tmbWhere = " and a.karyawanid like '%".$karyidCari."%'";
						$tmbWhere .= " and if(b.subbagian='',b.lokasitugas,left(b.subbagian,4)) like '".$unit."%'";
						$ql2="select count(a.karyawanid) as jmlhrow from ".$dbname.".sdm_ijin a, ".$dbname.".datakaryawan b where a.karyawanid = b.karyawanid and a.tanggal between '".$pAwal."' and '".$pAkhir."' and a.jenisijin like '%".$jnsCuti."%' and (a.persetujuan1='".$_SESSION['standard']['userid']."' or hrd='".$_SESSION['standard']['userid']."') ".$tmbWhere." order by a.tanggal desc";
					}
				}
				//$ql2="select count(a.karyawanid) as jmlhrow from ".$dbname.".sdm_ijin a, ".$dbname.".datakaryawan b where a.karyawanid = b.karyawanid and a.tanggal between '".$pAwal."' and '".$pAkhir."' and a.jenisijin like '%".$jnsCuti."%' ".$tmbWhere." order by a.tanggal desc";
				//exit('Warning: '.$ql2);
				...
				if($_SESSION['empl']['tipelokasitugas'] == 'HOLDING' and ($_SESSION['empl']['bagian'] == 'HHRD' || $_SESSION['empl']['bagian'] == 'HHRS' || $_SESSION['empl']['bagian'] == 'HHSE' || $_SESSION['empl']['bagian'] == 'HRA'|| substr($_SESSION['empl']['bagian'],0,3) == 'URD')){
					...
					if($_SESSION['empl']['bagian'] == 'HHRD' || $_SESSION['empl']['bagian'] == 'HHRS' || $_SESSION['empl']['bagian'] == 'HRA'|| substr($_SESSION['empl']['bagian'],0,3) == 'URD'){
						...
						$tmbWhere = " and a.karyawanid like '%".$karyidCari."%'";
						$tmbWhere .= " and if(b.subbagian='',b.lokasitugas,left(b.subbagian,4)) like '".$unit."%'";
						$slvhc="select a.* from ".$dbname.".sdm_ijin a, ".$dbname.".datakaryawan b where a.karyawanid = b.karyawanid and a.tanggal between '".$pAwal."' and '".$pAkhir."' and a.jenisijin like '%".$jnsCuti."%' and (a.persetujuan1='".$_SESSION['standard']['userid']."' or hrd='".$_SESSION['standard']['userid']."') ".$tmbWhere." order by a.tanggal desc limit ".$offset.",".$limit." ";
					}
				}
				//$slvhc="select a.* from ".$dbname.".sdm_ijin a, ".$dbname.".datakaryawan b where a.karyawanid = b.karyawanid and a.tanggal between '".$pAwal."' and '".$pAkhir."' and a.jenisijin like '%".$jnsCuti."%' ".$tmbWhere." order by a.tanggal desc limit ".$offset.",".$limit." ";
				//exit('Warning: '.$slvhc);
...
//                {
	...
	if($rKet['jenisijin']=='CUTI' or $rKet['jenisijin']=='ALASANPENTING' or $rKet['jenisijin']=='MELAHIRKAN' or $rKet['jenisijin']=='SKRIPSI_TESIS'){
		...
		foreach($rangeTgl as $val){
			...
			if($Ada==1){
				$strAbs = "update ".$dbname.".sdm_absensidt set absensi='C' where karyawanid='".$krywnId."' and tanggal='".$val."'";
			}else{
				$strAbs = "insert into ".$dbname.".sdm_absensidt (kodeorg,tanggal,karyawanid,shift,absensi,jam,jamPlg,penjelasan,catu,penaltykehadiran,premi,insentif,fingerprint) values ('".$subbagian."','".$val."','".$krywnId."','','C','00:00:00','00:00:00','".$keterangan."','0','0','0','0','0')";
			}
			mysql_query($strAbs);
		}
	}
