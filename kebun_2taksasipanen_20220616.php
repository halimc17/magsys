...
// kebun
$sOrg="select distinct kodeorganisasi,namaorganisasi from ".$dbname.".organisasi where tipe='KEBUN' ".$add;
...
<legend><b>".$title[3]."</b></legend>
<table cellspacing=\"1\" border=\"0\" >
<tr>
    <td><label>".$_SESSION['lang']['kebun']."</label></td>
    <td><select id=\"kebun3\" name=\"kebun3\"  style=\"width:150px\" onchange=getPeriode(3)>".$optOrg."</select></td>
</tr>
<tr>
    <td><label>".$_SESSION['lang']['afdeling']."</label></td>
    <td><select id=\"afdeling3\" name=\"afdeling3\"  style=\"width:150px\">".$optAfd."</select></td>
</tr>
<tr>
    <td><label>".$_SESSION['lang']['periode']."</label></td>
    <td><select id=\"periode3\" name=\"periode3\"  style=\"width:150px\">".$optPer."</select></td>
</tr>
...
<legend><b>".$title[4]."</b></legend>
<table cellspacing=\"1\" border=\"0\" >
<tr>
    <td><label>".$_SESSION['lang']['kebun']."</label></td>
    <td><select id=\"kebun4\" name=\"kebun4\"  style=\"width:150px\" onchange=getPeriode(4)>".$optOrg."</select></td>
</tr>
<tr>
    <td><label>".$_SESSION['lang']['afdeling']."</label></td>
    <td><select id=\"afdeling4\" name=\"afdeling4\"  style=\"width:150px\">".$optAfd."</select></td>
</tr>
<tr>
    <td><label>".$_SESSION['lang']['periode']."</label></td>
    <td><select id=\"periode4\" name=\"periode4\"  style=\"width:150px\">".$optPer."</select></td>
</tr>
