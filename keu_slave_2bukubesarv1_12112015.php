...
if(!empty($aqun))foreach($aqun as $akyun){
	...
	if(!empty($isidata))foreach($isidata as $baris)
    {
        if($baris['noaku']==$akyun){
            ...
            echo"<td style='width:80px;'>".substr($baris['nojur'],14,8)."</td>";
            echo"<td style='width:100px;'>".tanggalnormal($baris['tangg'])."</td>";
            echo"<td style='width:80px;'>".$baris['noaku']."</td>";
            echo"<td style='width:150px;'>".$nmKar[$baris['nik']]."</td>";
			echo"<td style='width:160px;'>".$baris['namasupplier']."</td>";
			echo"<td style='width:160px;'>".$baris['noreferensi']."</td>";
            echo"<td style='width:160px;'>".$baris['nodok']."</td>";
            echo"<td style='width:160px;'>".$baris['nocekgiro']."</td>";
            echo"<td style='width:200px;'>".$baris['keter']."</td>";
			echo"<td align=right style='width:150px;'>".number_format($baris['debet'],2)."</td>";
            $totaldebet+=$baris['debet'];
            $grandtotaldebet+=$baris['debet'];
            echo"<td align=right style='width:150px;'>".number_format($baris['kredi'],2)."</td>";
            $totalkredit+=$baris['kredi'];
            $grandtotalkredit+=$baris['kredi'];
            $salwal=$salwal+($baris['debet'])-($baris['kredi']);
            echo"<td align=right style='width:150px;'>".number_format($salwal,2)."</td>";
            echo"<td style='width:80px;'>".$baris['organ']."</td>";
            echo"<td style='width:80px;'>".$baris['kodeb']."</td>";
            echo"<td>".(isset($tahuntanam[$baris['kodeb']])? $tahuntanam[$baris['kodeb']]: '')."</td>";
            echo"</tr>";
            $subsalak=$salwal;
        }
    } 
// subtotal    
    echo"<tr class=rowtitle>";
        echo"<td align=right colspan=10>SubTotal</td>";
...
// total
    ...
    echo"<tr class=rowtitle>";
        echo"<td align=right colspan=10>GrandTotal</td>";
