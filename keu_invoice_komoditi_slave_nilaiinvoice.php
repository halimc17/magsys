...
switch($param['proses']){
    ...
    case'postingData':
		...
		// Nilai
		$jumlahUM = $rdata['nilaiinvoice']-$rdata['nilaippn']+$rdata['nilaipph']-$rdata['ongkoskirim'];
		...
		$jumlahPiutang = $rdata['nilaiinvoice'];
	...
	case'loadDetail':
		...
		$sBrg2="select a.kodebarang,a.namabarang,a.satuan from ".$dbname.".log_5masterbarang a
				where a.inactive='0' and (a.kodebarang like '4%' or a.kodebarang like '386%' or a.kodebarang like '387%') order by a.namabarang";
		...
		echo "<table>
				...
				<tr class=rowcontent>
					...
					<td align=right><input type=text id=subtotalinv value=".number_format($subtotaltransaksi,2)." disabled class=myinputtextnumber style=\"width:130px;\"></td>
					<td></td>
				</tr>
				<tr class=rowcontent>
				...
				<tr class=rowcontent>
					...
					<td align=right><input type=text id=nilaiinvoice value=".number_format($gtotaltransaksi,2)." disabled class=myinputtextnumber style=\"width:130px;\"></td>
					<td></td>
				</tr>
			</table>";
