...
echo"<br /><br /><fieldset style='float:left;'>
                <legend>".$_SESSION['lang']['entryForm']."</legend> 
                        <table border=0 cellpadding=1 cellspacing=1>
                                ...
                                <tr><td>".$_SESSION['lang']['bjr']."</td><td>:</td><td><input type=text class=myinputtextnumber disabled id=bjr name=bjr onkeypress=\"return angka_doang(event);\" style=\"width:125px;\" readyonly onkeyup=jumlahkan()></td></tr>
                                <tr><td>".$_SESSION['lang']['jenjangpokoktahun']."</td><td>:</td><td><input type=text class=myinputtextnumber id=jjg name=jjg onkeypress=\"return angka_doang(event);\" onkeyup=jumlahkan() style=\"width:125px;\" readyonly  ></td></tr>
								<tr><td>".$_SESSION['lang']['luasareal']."</td><td>:</td><td><input type=text class=myinputtextnumber id=luas name=luas style=\"width:125px;\" disabled ></td></tr>
								<tr><td>".$_SESSION['lang']['total']." (KG)</td><td>:</td><td><input type=text class=myinputtextnumber id=totalKg name=totalKg onkeypress=\"return angka_doang(event);\" style=\"width:125px;\" readyonly disabled ></td></tr>
