...
switch($proses)
{
	...
	while($rNotiket=mysql_fetch_assoc($qNotiket))
	{
			...
			$qFraksi=mysql_query($sFraksi) or die(mysql_error());
			$sJjg="select jjgsortasli,tanggal,persenBrondolan,kgpotsortasli from ".$dbname.".pabrik_timbangan 
...
//                    echo"</pre><br />";
	...
	while($rNotiket=mysql_fetch_assoc($qNotiket))
	{
			...
			$sJjg="select jjgsortasli,tanggal,persenBrondolan,kgpotsortasli from ".$dbname.".pabrik_timbangan where notransaksi='".$rNotiket['notiket']."'";
			$qJjg=mysql_query($sJjg) or die(mysql_error());
			$rJjg=mysql_fetch_assoc($qJjg);
			while($rFraksi=mysql_fetch_assoc($qFraksi))
			{
...
//echo "warning:".$sTim;exit();
	...
	$table .= "<thead>";
	$table .= "<tr>";
	$table .= "<td>".$_SESSION['lang']['noTiket']."</td><td>Netto</td><td>".$_SESSION['lang']['janjang']."</td><td>BJR</td><td>".$_SESSION['lang']['sortasi']."(JJG)</td>";
