...
$sOrg="select distinct kodegudang,namaorganisasi from ".$dbname.".log_5saldobulanan a
    ...
    if($_SESSION['empl']['tipelokasitugas']=='KANWIL' and substr($_SESSION['empl']['subbagian'],-2)!='PK'){
       $sOrg="select namaorganisasi,kodeorganisasi as kodegudang from ".$dbname.".organisasi where tipe='GUDANG'
       ...
       $sOrg="select namaorganisasi,kodeorganisasi as kodegudang from ".$dbname.".organisasi 
