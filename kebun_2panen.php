     ...
     <legend>".$_SESSION['lang']['laporanpanen']." ".$_SESSION['lang']['detail']."</legend>
		<table>
			<tr>
				...
				<td>:</td>
				<td><select id=pt style='width:200px;' onchange=getKbn()>".$optpt."</select></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>:</td>
				<td>
					<input type=text class=myinputtext id=tgl1 onmousemove=setCalendar(this.id); onkeypress=\"return false;\" size=9 maxlength=10> - <input type=text class=myinputtext id=tgl2 onmousemove=setCalendar(this.id); onkeypress=\"return false;\" size=9 maxlength=10>
				</td>
			</tr>
			<tr>
				<td></td>
				<td></td>
				<td><button class=mybutton onclick=getLaporanPanen()>".$_SESSION['lang']['proses']."</button></td>
			</tr>
		</table>
         </fieldset>";
...
$frm[1].="<table cellspacing=1 border=0>
			<tr>
				...
				<td>:</td>
				<td><select id=pt_1 name=pt_1 style='width:200px;' onchange=getKbn_1()>".$optpt."</select></td>
			</tr>
			<tr>
				<td>".$_SESSION['lang']['unit']."</td>
				<td>:</td>
				<td><select id=unit_1 name=unit_1 style=width:150px; onchange=bersih_1()>".$optgudang."</select></td>
			</tr>
			<tr>
				<td>".$_SESSION['lang']['intiplasma']."</td>
				<td>:</td>
				<td><select id=intiplasma_1>".$optIP."</select></td>
			</tr>
			<tr>
				<td>".$_SESSION['lang']['tanggal']."</td>
				<td>:</td>
				<td><input type=text class=myinputtext id=tgl1_1 onchange=bersih_1() onmousemove=setCalendar(this.id); onkeypress=\"return false;\" size=9 maxlength=10> - <input type=text class=myinputtext id=tgl2_1 onchange=bersih_1() onmousemove=setCalendar(this.id); onkeypress=\"return false;\" size=9 maxlength=10></td>
			</tr>
			<tr>
				<td colspan=2></td>
				<td><button class=mybutton onclick=getLaporanPanen_1() >".$_SESSION['lang']['proses']."</button>
...
$frm[2].="<table cellspacing=1 border=0>
			<tr>
				<td>".$_SESSION['lang']['perusahaan']."</td>
				<td>:</td>
				<td><select id=pt_2 name=pt_2 style='width:200px;' onchange=getKbn_2()>".$optpt."</select></td>
			</tr>
			<tr>
				<td>".$_SESSION['lang']['unit']."</td>
				<td>:</td>
				<td><select id=unit_2 name=unit_2 style=width:150px; onchange=bersih_2()>".$optgudang."</select></td>
			</tr>
			<tr>
				<td>".$_SESSION['lang']['intiplasma']."</td>
				<td>:</td>
				<td><select id=intiplasma_2>".$optIP."</select></td>
			</tr>
			<tr>
				<td>".$_SESSION['lang']['tanggal']."</td>
				<td>:</td>
				<td><input type=text class=myinputtext id=tgl1_2 onchange=bersih_2() onmousemove=setCalendar(this.id); onkeypress=\"return false;\" size=9 maxlength=10> - <input type=text class=myinputtext id=tgl2_2 onchange=bersih_2() onmousemove=setCalendar(this.id); onkeypress=\"return false;\" size=9 maxlength=10></td>
			</tr>
			<tr>
				<td>".$_SESSION['lang']['pilih']."</td>
				<td>:</td>
				<td><select id=pil_2 name=pil_2 style='width:100px;'>".$optpil."</select></td>
			</tr>
			<tr>
				<td colspan=2></td>
				<td><button class=mybutton onclick=getLaporanPanen_2() >".$_SESSION['lang']['proses']."</button>
...
$frm[3].="<table cellspacing=1 border=0>
			<tr>
				<td>".$_SESSION['lang']['perusahaan']."</td>
				<td>:</td>
				<td><select id=pt_3 name=pt_3 style='width:200px;' onchange=getKbn_3()>".$optpt."</select></td>
			</tr>
			<tr>
				<td>".$_SESSION['lang']['unit']."</td>
				<td>:</td>
			...
			<tr>
				<td>".$_SESSION['lang']['intiplasma']."</td>
				<td>:</td>
				<td><select id=intiplasma_3>".$optIP."</select></td>
			</tr>
			<tr>
				<td>".$_SESSION['lang']['tanggal']."</td>
				<td>:</td>
				<td><input type=text class=myinputtext id=tgl1_3 onchange=bersih_3() onmousemove=setCalendar(this.id); onkeypress=\"return false;\" size=9 maxlength=10> - <input type=text class=myinputtext id=tgl2_3 onchange=bersih_3() onmousemove=setCalendar(this.id); onkeypress=\"return false;\" size=9 maxlength=10></td>
			</tr>
			<tr>
				<td colspan=2></td>
				<td><button class=mybutton onclick=getLaporanPanen_3() >".$_SESSION['lang']['proses']."</button>
