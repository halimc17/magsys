...
{
	$str="select
		  sum(tbsdiolah)/1000 as tbsdiolah, sum(sisahariini)/1000  as sisahariini from ".$dbname.".pabrik_produksi
	...
	$res=mysql_query($str);
        ...
        {
            $datay1[$x]=$bar->tbsdiolah;
            $datay2[$x]=$bar->sisahariini;	
        }
        if($datay1[$x]==null)
        {
            $datay1[$x]=0;
...
{
	$str="select
		  sum(tbsdiolah) as tbsdiolah, sum(sisahariini)  as sisahariini  from ".$dbname.".pabrik_produksi
