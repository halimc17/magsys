...
<?
	...
	$sOrg="select induk from ".$dbname.".organisasi where kodeorganisasi='".$kdOrg."'";
	...
	$stream2.="<tbody><tr>
				<td rowspan=4><img src='images/logo.jpg' style='width:80px;height:80px;'></td>
				<th colspan=6 align=center valign=middle style='font-size:12;width:440px'><b>SPECIFICATION OF</b></th>
				<td rowspan=4><img src='".$path."' style='width:80px;height:80px;'></td>
			</tr>
			<tr>
				<th colspan=6></th>
			</tr>
