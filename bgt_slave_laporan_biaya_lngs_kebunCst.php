                ...
                if($ktKrgng2!='' and $ktKrgng2!=$new2)
                {
                    ...
                    if(substr($ktKrgng2,0,1)!='6')
                    {
                        if($ktKrgng2=='126')
                        {
                            ...
                            $pdf->Cell(50,10,number_format(($ttlLuastbm?0>(@$totalKplaSDM[$thnBudget][$ktKrgng2][sdm]/$ttlLuastbm):0),2),1,0,'L',1);
                            $pdf->Cell(50,10,number_format($totalKplaSDM[$thnBudget][$ktKrgng2][mat],2),1,0,'R',1);
                            $pdf->Cell(50,10,number_format(($ttlLuastbm?0>(@$totalKplaSDM[$thnBudget][$ktKrgng2][mat]/$ttlLuastbm):0),2),1,0,'L',1);
                            $pdf->Cell(50,10,number_format($totalKplaSDM[$thnBudget][$ktKrgng2][tool],2),1,0,'R',1);
                            $pdf->Cell(50,10,number_format(($ttlLuastbm?0>(@$totalKplaSDM[$thnBudget][$ktKrgng2][tool]/$ttlLuastbm):0),2),1,0,'L',1);
                            $pdf->Cell(50,10,number_format($totalKplaSDM[$thnBudget][$ktKrgng2][vhc],2),1,0,'R',1);
                            $pdf->Cell(50,10,number_format(($ttlLuastbm?0>(@$totalKplaSDM[$thnBudget][$ktKrgng2][vhc]/$ttlLuastbm):0),2),1,0,'L',1);
                            $pdf->Cell(50,10,number_format($totalKplaSDM[$thnBudget][$ktKrgng2][kntrk],2),1,0,'R',1);
                            $pdf->Cell(50,10,number_format(($ttlLuastbm?0>(@$totalKplaSDM[$thnBudget][$ktKrgng2][kntrk]/$ttlLuastbm):0),2),1,1,'L',1);
