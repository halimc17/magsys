	...
	case 'countPremi':
		...
		*/
		...
		// 3. Premi Over Basis
		   ...
		   if($libur) {
		  	   $premi += $hasiltbs * $rumusPremi['premilebihbasis'];
		   }else {
              //Over Basis 1-300 Kg
			  if($overbasis-$param['brondolan'] <=0){
			     $premi += 0 * $rumusPremi['premilebihbasis'];
				 $premilebih += 0 * $rumusPremi['premilebihbasis'];
			  }elseif($overbasis-$param['brondolan'] >=$bataslebih){
			     $premi += $bataslebih * $rumusPremi['premilebihbasis'];
				 $premilebih += $bataslebih * $rumusPremi['premilebihbasis'];
			  }else{
			     $premi += ($overbasis-$param['brondolan']) * $rumusPremi['premilebihbasis'];
				 $premilebih += ($overbasis-$param['brondolan']) * $rumusPremi['premilebihbasis'];
			  }
              //Over Basis 301-600 Kg
			  if($overbasis-$param['brondolan']-$bataslebih <=0){
			     $premi += 0 * $rumusPremi['premilebihbasis2'];
				 $premilebih += 0 * $rumusPremi['premilebihbasis2'];
			  }elseif($overbasis-$param['brondolan']-$bataslebih >=$bataslebih){
			     $premi += $bataslebih * $rumusPremi['premilebihbasis2'];
				 $premilebih += $bataslebih * $rumusPremi['premilebihbasis2'];
			  }elseif($overbasis-$param['brondolan']-$bataslebih <$bataslebih){
			     $premi += ($overbasis-$param['brondolan']-$bataslebih) * $rumusPremi['premilebihbasis2'];
				 $premilebih += ($overbasis-$param['brondolan']-$bataslebih) * $rumusPremi['premilebihbasis2'];
			  }
              //Over Basis 601-Lebih Kg
			  if($overbasis-$param['brondolan']-($bataslebih*2) <=0){
			     $premi += 0 * $rumusPremi['premilebihbasis3'];
				 $premilebih += 0 * $rumusPremi['premilebihbasis3'];
			  }elseif($overbasis-$param['brondolan']-($bataslebih*2) >0){
			     $premi += ($overbasis-$param['brondolan']-($bataslebih*2)) * $rumusPremi['premilebihbasis3'];
				 $premilebih += ($overbasis-$param['brondolan']-($bataslebih*2)) * $rumusPremi['premilebihbasis3'];
			  }
