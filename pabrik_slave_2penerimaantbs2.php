...
$kdPabrik=checkPostGet('kdPabrik__2','');
$tgl=checkPostGet('tgl__2','');
$kdUnit=checkPostGet('kdUnit__2','');
$kdAfdeling=checkPostGet('kdAfdeling__2','');

$tanggal=substr($tgl,6,4)."-".substr($tgl,3,2)."-".substr($tgl,0,2);

$totaljanjang=$totalberat=$totalmasuk=$subbrtnor=$subbrtpot=
$totalkeluar=$totalbersih=$subBrtNor=$subBrtPot=0;
...
switch($proses)
{
    ...
    {
            echo"<tr class=rowcontent><td colspan=15 align=center>".$_SESSION['lang']['datanotfound']."</td></tr>";
    }
    break;
    case'pdf':
    ...
    {
            $pdf->Cell(103/100*$width,$height,$_SESSION['lang']['datanotfound'],1,1,'C',1);
    }
