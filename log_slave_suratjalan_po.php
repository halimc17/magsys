...
<table cellpadding=1 cellspacing=1 border=0 class='sortable'>
	...
	<tbody id=bodySearch>
		...
		<tr class=rowcontent>
			<td><?php echo makeElement('po_'.$i,'checkbox',0)?></td>
			...
			<td id="nopp_<?php echo $i?>"><?php echo $row['nopp']?></td>
			<td id="jumlah_<?php echo $i?>" align=right><?php echo $row['jumlahpesan']?></td>
