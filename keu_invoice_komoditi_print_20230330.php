...
$iAkunBank="select a.*,b.pemilik as pemilikakun,c.induk as ptakun from ".$dbname.".keu_5akunbank a
			left join ".$dbname.".keu_5akun b on b.noakun=a.noakun
			left join ".$dbname.".organisasi c on c.kodeorganisasi=b.pemilik
			where a.pemilik='".$bar->kodept."' and a.noakun = '".$bar->bayarke."' ";
...
$RnmPtS=explode(".",$nmPt[$bar->kodept]);
$nmPtS=explode(".",$nmPt[$dAkunBank['ptakun']]);
