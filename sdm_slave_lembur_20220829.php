...
$offset=$page*$limit;
		...
		case'updateDetail':
			if(($tpLmbr!='')&&($Jam!='')){
				...
				//exit('Warning: '.$noba);
                $sUp="update ".$dbname.".sdm_lemburdt set tipelembur='".$tpLmbr."',jamaktual='".$Jam."',uangmakan='".$ungMkn."',uangtransport='".$ungTrans."',uangkelebihanjam='".$ungLbhjm."',noba='".$noba."',posting=".$stspost." where kodeorg='".$kdOrg."' and tanggal='".$tgl."' and karyawanid='".$krywnId."'";
                if(mysql_query($sUp))
                        echo"";
                        else
                        echo "DB Error : ".mysql_error($conn);
