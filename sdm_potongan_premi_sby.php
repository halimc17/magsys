...
$strKom="select * from ".$dbname.".sdm_ho_component where id in('36','37')";	  
...
echo"<fieldset style='width:500px;'>
    EN: Make sure the entire payroll process is carried out either daily or monthly based,if not then the 'Potongan HK' data will be replaced but 'Potongan HK/Premi Sudah Dibayar' will not change<br>
    ID:Pastikan proses penggajian sudah dilaksanakan keseluruhan baik yang berbasis harian maupun bulanan, jika belum maka data 'Potongan HK' ini akan tertimpa, tetapi 'Potongan HK/Premi Sudah Dibayar' tidak tertimpa.
     <table>
     <tr>
