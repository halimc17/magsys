		...
		switch($proses)
        {
                ...
                if($rCek<1)
                {
                        ...
                        if(mysql_query($sIns))
                        {
							if(($tpLmbr!='')&&($Jam!=''))
                            {
                                ...
                                (`kodeorg`,`tanggal`,`karyawanid`,`tipelembur`,`jamaktual`,`uangmakan`,`uangtransport`,`uangkelebihanjam`,`noba`,`posting`)
                ...
                else
                {
					if(($tpLmbr!='')&&($Jam!=''))
                    {
						...
						$sDetIns="insert into ".$dbname.".sdm_lemburdt 
                     (`kodeorg`,`tanggal`,`karyawanid`,`tipelembur`,`jamaktual`,`uangmakan`,`uangtransport`,`uangkelebihanjam`,`noba`,`posting`) values ('".$kdOrg."','".$tgl."','".$krywnId."','".$tpLmbr."','".$Jam."','".$ungMkn."','".$ungTrans."','".$ungLbhjm."','".$noba."',".$stspost.")";
                        //echo"warning:".$sDetIns;exit();
