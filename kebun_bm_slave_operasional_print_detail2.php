...
switch($proses) {
    case 'pdf':
        ...
        $sPres="select a.*,d.namaorganisasi from (select distinct sum(a.insentif) as upahpremi, sum(a.umr) as umr,sum(a.jhk) as jumlahhk,kodekegiatan,
        ...
        $pdf->Cell(13/100*$width,$height,$rPres['namaorganisasi'],1,0,'C',1);
...
//        }
    ...
    case'html':
        ...
        $tab.="<td>".$_SESSION['lang']['notransaksi']." ".$_SESSION['lang']['sloc']."</td>";
        $tab.="</tr></thead><tbody>";
        while($rMat=mysql_fetch_assoc($qMat)){
            $tab.="<tr class=rowcontent>";
            ...
            $tab.="<td>".$optTrnsGdng[$rMat['notransaksi']]."</td>";
            $tab.="</tr>";
        }
        $tab.="</table><br />";
         //$col3 = 'kodeorg,kodebarang,kwantitas,kwantitasha,hargasatuan';
