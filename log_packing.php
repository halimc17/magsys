...
if($_SESSION['empl']['tipelokasitugas']=='HOLDING')
        $aKar="select karyawanid,namakaryawan from ".$dbname.".datakaryawan  where lokasitugas like '%HO%' ";
else
        $aKar="select karyawanid,namakaryawan from ".$dbname.".datakaryawan  where  lokasitugas='".$_SESSION['empl']['lokasitugas']."' ";
