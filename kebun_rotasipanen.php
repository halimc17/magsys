...
<script>
	function getDivisi(){
	    ...
	    tujuan='kebun_rotasipanen_slave.php';
...
<div>
	<fieldset style="float: left;">
		<legend><b><?php echo 'Monitoring '.$_SESSION['lang']['rotasi']." ".$_SESSION['lang']['panen'];?></b></legend>
		<table cellspacing="1" border="0" >
			...
			<tr><td colspan="2">
					<button onclick="zPreview('kebun_rotasipanen_slave','<?php echo $arr;?>','printContainer')" class="mybutton" name="preview" id="preview">Preview</button>
					<button onclick="zExcel(event,'kebun_rotasipanen_slave.php','<?php echo $arr;?>')" class="mybutton" name="preview" id="preview">Excel</button>
