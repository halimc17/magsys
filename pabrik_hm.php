...
echo "<fieldset style='width:935px;'>
								...
								<table>
									<tr>
										...
										<td><select id=tipeservice name=tipeservice onchange=getEnable()>
												...
												<option value='2'>Pergantian Sparepart2 (Bearing Depan/Press Cage)/Intermediate/Top Overhaul</option>
												<option value='3'>Pergantian Sparepart3 (Bearing Belakang)/Major/General Overhaul</option>
											</select>
										</td>
