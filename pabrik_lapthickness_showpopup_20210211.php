...
<?php
	...
	$strtb="select a.tebal1,a.tipeservice from ".$dbname.".pabrik_thickness a where a.kodemesin like '".$kodemesin."%' and a.tipeservice<>0 ".$where."
	...
	if($row==0){
		...
		while($barz=mysql_fetch_object($resz)){
            ...
            $stream2.="<tr class=rowcontent>
						...
						<td align=right>".number_format($tebalsisa,2,'.',',')."</td>
