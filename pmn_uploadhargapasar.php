...
echo"  <fieldset><legend>Form</legend>
                     <div id=uForm>
                     	<span id=sample><b>".$_SESSION['lang']['absensi']." Uploader. This form must be preceded by a header on the first line</b> <a href=tool_slave_getExample.php?form=HARGAHARIANPASAR target=frame>Click here for example</a></span><br><br>
                                        ...
                                        <input type=hidden name=jenisdata id=jenisdata value='HARGAHARIANPASAR'>
