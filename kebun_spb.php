...
//$optIntex.="<option value='0'>Ditanam(Internal)</option>";
//$optIntex.="<option value='1'>Disisip(Internal)</option>";
//$optIntex.="<option value='2'>Dijual(External)</option>";
//$optIntex.="<option value='3'>Afiliasi</option>";
...
echo"
    <tr>
        ...
        <td>:</td>
        <td><select id=intex name=intex onchange=getPks() style=width:120px;>".$optIntex."</select></td>
    </tr>
    
    <tr>
        <td>".$_SESSION['lang']['pabrik']."</td>
        <td>:</td>
        <td><select id=pks name=pks style=width:120px;>".$optPks."</select></td>
    </tr>
...
<thead>
 <tr class="rowheader">
    ...
    <td><?php echo $_SESSION['lang']['kgwb'] ?></td>
