...
$tab.="<td align=right>".number_format($totalha_tm,2)."</td>";   /*TM DIDIEUU !!!*/
...
$tab.="<td align=right>".number_format($totalha_tbm,2)."</td>";    /*TBM DIDIEUU !!!*/
...
$tab.="<td align=right>".number_format($totalha,2)."</td>";    /*TP DIDIEUU !!!*/
