...
switch($proses)
{
        ...
        $sql="select b.kmhmawal as kmhmawal,(b.kmhmawal+sum(jumlah)) as   
              kmhmakhir,b.satuan,a.notransaksi,a.jenisvhc,a.jenisbbm,a.kodevhc,a.tanggal, 
              ...
              left join ".$dbname.".vhc_rundt b on a.notransaksi=b.notransaksi where kodeorg like '%".$_SESSION['empl']['lokasitugas']."%' 
                  group by b.notransaksi order by tanggal desc,posting asc limit ".$offset.",".$limit."";
        //echo $sql;
        //exit("Error".$sql);
                ...
                $ql2="select count(notransaksi) as jmlhrow from ".$dbname.".vhc_runht 
                      ...
                      order by notransaksi desc"; //echo $ql2;
                        ...
                        /*$strx="select a.kmhmawal as kmhmawal,(a.kmhmawal+sum(jumlah)) as
                               kmhmakhir,a.satuan,a.notransaksi,b.jenisvhc,b.jenisbbm,b.kodevhc,b.tanggal,b.jlhbbm,b.posting from ".$dbname.".vhc_rundt a
                      left join ".$dbname.".vhc_runht b on a.notransaksi=b.notransaksi where kodeorg like '%".$_SESSION['empl']['lokasitugas']."%'   
                                  ".$where."
                        ...
                        $strx="select b.kmhmawal as kmhmawal,(b.kmhmawal+sum(jumlah)) as
                               kmhmakhir,b.satuan,a.notransaksi,a.jenisvhc,a.jenisbbm,a.kodevhc,a.tanggal,a.jlhbbm,a.posting from ".$dbname.".vhc_runht a
                      left join ".$dbname.".vhc_rundt b on a.notransaksi=b.notransaksi where kodeorg like '%".$_SESSION['empl']['lokasitugas']."%'   
                                  ".$where."
                          group by a.notransaksi order by notransaksi  limit ".$offset.",".$limit."";
