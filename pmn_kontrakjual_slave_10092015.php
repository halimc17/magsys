...
$arrBulan=array("01"=>"I","02"=>"II","03"=>"III","04"=>"IV","05"=>"V","06"=>"VI","07"=>"VII","08"=>"VIII","09"=>"IX","10"=>"X","11"=>"XI","12"=>"XII");
        switch($param['method']){
                ...
                // $sSum="select * from ".$dbname.".keu_jurnaldt where noreferensi in (select noinvoice from ".$dbname.".keu_penagihanht where nokontrak='".$res['nokontrak']."')";
		 ...
		 echo"</td>
                ...
                $qSat2=mysql_query($sSat2) or die(mysql_error());
                $rsat2=mysql_fetch_assoc($qSat2);
                $optSatuan.="<option value=".$rsat2['satuan']." ".($rsat2['satuan']==$res['satuan']?'selected':'')."  >".$rsat2['satuan']."</option>";
                ...
                $sUpd="update ".$dbname.".pmn_kontrakjual set   `tanggalkontrak`='".tanggalsystem($param['tlgKntrk'])."', `koderekanan`='".$param['custId']."', `kodebarang`='".$param['kdBrg']."', `satuan`='".$param['satuan']."', `hargasatuan`='".$param['HrgStn']."', `terbilang`='".$param['tBlg']."', `tanggalkirim`='".tanggalsystem($param['tglKrm0'])."', `sdtanggal`='".tanggalsystem($param['tglSd0'])."', `tanggalkirim1`='".tanggalsystem($param['tglKrm1'])."', `sdtanggal1`='".tanggalsystem($param['tglSd1'])."', `tanggalkirim2`='".tanggalsystem($param['tglKrm2'])."', `sdtanggal2`='".tanggalsystem($param['tglSd2'])."', `tanggalkirim3`='".tanggalsystem($param['tglKrm3'])."', `sdtanggal3`='".tanggalsystem($param['tglSd3'])."', `rekening`='".$param['byrKe']."', `kdtermin`='".$param['syrtByr']."', `franco`='".$param['franco']."', `ffa`='".$param['kualitasffa']."', `dobi`='".$param['kualitasdob']."', `mdani`='".$param['kualitasmdani']."', `kuantitaskirim`='".$param['jmlh0']."', `kuantitaskirim1`='".$param['jmlh1']."', `kuantitaskirim2`='".$param['jmlh2']."', `kuantitaskirim3`='".$param['jmlh3']."', `penandatangan`='".$param['tndtng']."', `penandatangan2`='".$param['tndtngPembli']."', `namajabatan`='".$param['tndtngJbtn']."', `namajabatan2`='".$param['jtbnPembli']."', `catatanlain`='".$param['cttnLain']."', `kuantitaskontrak`='".$param['qty']."', `toleransi`='".$param['tlransi']."', `kodept`='".$param['kdPt']."', `matauang`='".$param['kurs']."',idkontak='".intval($param['nmPerson'])."',ppn='".$param['ppnId']."',`tglpembayarpertama`='".tanggalsystem($param['tglByr'])."',moist=".$param['moist'].",dirt=".$param['dirt'].",grading=".$param['grading'].",nokontrak_ref='".$param['kntrkRef']."' where nokontrak='".$param['noKntrk']."'"; 
