...
jdl_bwhv_0='<?php echo $_SESSION['lang']['find']?>';
jdl_bwhv_1='<?php echo $_SESSION['lang']['findvhc']?>';
contentv_1='<fieldset><legend><?php echo $_SESSION['lang']['findvhc']?></legend>Find<input type=text class=myinputtext id=no_vhc><button class=mybutton onclick=findVhc()>Find</button></fieldset><div id=container></div>';
	...
	<table cellspacing="1" border="0" id="opl">
	 <tr>
		  ...
		  <td><?php
			...
			?>
			<select id="kd_bag" style='width:150px;'>
		...
		<tr>
			...
			<button class=mybutton id="dtl_pem" onclick="get_isi()"><?php echo $_SESSION['lang']['save']?></button>			</td>
		</tr>
	</table>
</fieldset><br />
<br />
