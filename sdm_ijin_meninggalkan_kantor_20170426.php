...
$sHRD="select karyawanid, namakaryawan from ".$dbname.".datakaryawan where (tanggalkeluar = '0000-00-00' or tanggalkeluar > '".date("Y-m-d")."') and tipekaryawan in ('0','7','8') and bagian in ('HRD','HHRD','HRA','HHRS') and karyawanid!='".$_SESSION['standard']['userid']."' order by namakaryawan asc";
...
<td>:</td>
<td><input type='text' class='myinputtext' id='tglAwal' onmousemove='setCalendar(this.id)' onchange="javascript:jumlahhari()" onkeypress='return false;'  size='10' maxlength='10' style="width:150px;" /><select id="jam1"><?php echo $jm;?></select>:<select id="mnt1"><?php echo $mnt;?></select></td>
</tr>
<tr>
<td><?php echo $_SESSION['lang']['tglcutisampai']."  ".$_SESSION['lang']['tanggal']."&".$_SESSION['lang']['jam']?></td>
<td>:</td>
<td><input type='text' class='myinputtext' id='tglEnd' onmousemove='setCalendar(this.id)' onchange="javascript:jumlahhari()" onkeypress='return false;'  size='10' maxlength='10' style="width:150px;" /><select id="jam2"><?php echo $jm;?></select>:<select id="mnt2"><?php echo $mnt;?></select></td>
</tr>
<tr>
