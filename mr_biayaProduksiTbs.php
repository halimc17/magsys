...
$frm[1].="<table cellspacing=1 border=0>
    <!--<tr><td>" . $_SESSION['lang']['perusahaan'] . "</td><td>:</td><td>
    <select id=pt1 name=pt1 style=width:150px; onchange=getkebun1()>" . $optpt . "</select>
    </td></tr>
    <tr><td>" . $_SESSION['lang']['unit'] . "</td><td>:</td><td>
...
$frm[2].="<fieldset><legend>".$_SESSION['lang']['biaya']." ".$_SESSION['lang']['produksitbs']." ".$_SESSION['lang']['detail']."</legend>";
