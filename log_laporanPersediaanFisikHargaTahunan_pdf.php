...
foreach($arrBarang as $barang)
    {
        ...
        $pdf->Cell(9,4,number_format(isset($arrAwal[$barang]['saldoawalqty'])? $arrAwal[$barang]['saldoawalqty']: 0,2),0,0,'R');
        $pdf->Cell(9,4,number_format(isset($arrAwal[$barang]['hargaratasaldoawal'])? $arrAwal[$barang]['hargaratasaldoawal']: 0,2),0,0,'R');						
        $pdf->Cell(9,4,number_format(isset($arrAwal[$barang]['nilaisaldoawal'])? $arrAwal[$barang]['nilaisaldoawal']: 0,2),0,0,'R');	
	...
	$pdf->Cell(80,4,$_SESSION['lang']['total'],'T',0,'C');
	$pdf->Cell(27,4,number_format($totalSaldoAwal,2),'T',0,'R');
	$pdf->Cell(27,4,number_format($totalMasuk,2),'T',0,'R');
	$pdf->Cell(27,4,number_format($totalKeluar,2),'T',0,'R');
	$pdf->Cell(27,4,number_format($totalSaldo,2),'T',0,'R');
}
