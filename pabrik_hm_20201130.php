								...
								<table>
									<tr>
										...
										<td><select id=tipeservice name=tipeservice onchange=getEnable()>
												...
												<option value='1'>Pergantian Sparepart1</option>
												<option value='2'>Intermediate/Top Overhaul/Sparepart2</option>
												<option value='3'>Major/General Overhaul/Sparepart3</option>
											</select>
										</td>
									</tr>
									<tr>
