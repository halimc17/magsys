...
<script>
	...
	function getSub(num){
		...
		tujuan='kebun_laporan_penalty_pemanen_per_tanggal.php';
...
<?
	...
	OPEN_BOX();
	$arr0="##kebun0##divisi0##tgl10##tgl20##pemanen0";
	$arr1="##kebun1##divisi1##periode1##pemanen1";

	###form input 1
	################
	$frm[0].="<fieldset style='float:left;'><legend><b>Form Filter Per Tanggal</b></legend>
			<table>
				<tr>
				...
				<tr>
					<td>".$_SESSION['lang']['pemanen']."</td>
					<td>:</td>
					<td><select id=pemanen0 style=\"width:240px;\" >".$optKary."</select></td>
				</tr>
				<tr>
					<td colspan=100>&nbsp;</td>
				</tr>
				<tr>
					<td colspan=100>
						<button onclick=zPreview('kebun_laporan_penalty_pemanen_per_tanggal','".$arr0."','printContainer0') class=mybutton name=preview0 id=preview0>".$_SESSION['lang']['preview']."</button>
						<button onclick=zExcel(event,'kebun_laporan_penalty_pemanen_per_tanggal.php','".$arr0."') class=mybutton name=preview0 id=preview0>".$_SESSION['lang']['excel']."</button>
	...
	###form input 2
	################
	$frm[1].="<fieldset style='float:left;'><legend><b>Form Filter Per Tahun</b></legend>
			<table>
				<tr>
					<td>".$_SESSION['lang']['kebun']."</td>
					<td>:</td>
				...
				<tr>
					<td>".$_SESSION['lang']['pemanen']."</td>
					<td>:</td>
					<td><select id=pemanen1 style=\"width:240px;\" >".$optKary."</select></td>
				</tr>
				<tr>
					<td colspan=100>&nbsp;</td>
				</tr>
				<tr>
					<td colspan=100>
						<button onclick=zPreview('kebun_laporan_penalty_pemanen_per_bulan','".$arr1."','printContainer1') class=mybutton name=preview1 id=preview1>".$_SESSION['lang']['preview']."</button>
						<button onclick=zExcel(event,'kebun_laporan_penalty_pemanen_per__bulan.php','".$arr1."') class=mybutton name=preview1 id=preview1>".$_SESSION['lang']['excel']."</button>
	...
	$hfrm[0]=$_SESSION['lang']['laporan'].' Penalty Pemanen Per Tanggal';
	$hfrm[1]=$_SESSION['lang']['laporan'].' Penalty Pemanen Per Tahun';
