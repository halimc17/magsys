	...
	global $namasupplier;
		...
		$bar=mysql_fetch_object($res);
			...
			$nopo=$bar->nopo;
                        ...
                        $biayatot=$bar->biaya;
                        $biayaperkg=$bar->biayaperkg;
                        $beratd=$bar->berat;
                        $modatrans=$bar->moda_trans;//
			$byapacking=$bar->biayapacking;
			//ambil nama pt
	...
	$pdf->SetFillColor(255,255,255);
		...
		while($bar=mysql_fetch_object($res))
		{
		   ...
		   $namabarang='';
                ...
                $pdf->Ln(5);
                $pdf->Cell(50,5,$_SESSION['lang']['modatransportasi'],0,0,'L',1);
                $pdf->Cell(8,5,": ",0,0,'L',1);
                $pdf->Cell(20,5,$modatrans,0,1,'L',1);
                $pdf->Cell(50,5,$_SESSION['lang']['biaya']." per Kg",0,0,'L',1);
                $pdf->Cell(8,5,": Rp.",0,0,'L',1);
                $pdf->Cell(20,5,number_format($biayaperkg,0),0,1,'R',1);
                $pdf->Cell(50,5,$_SESSION['lang']['berat'],0,0,'L',1);
                $pdf->Cell(8,5,": ",0,0,'L',1);
                $pdf->Cell(20,5,number_format($beratd,0). " Kg",0,1,'R',1);
                $pdf->Cell(50,5,$_SESSION['lang']['biaya']." Packing",0,0,'L',1);
                $pdf->Cell(8,5,": Rp.",0,0,'L',1);
                $pdf->Cell(20,5,number_format($byapacking,0),0,1,'R',1);
                $pdf->Cell(50,5,$_SESSION['lang']['biaya'],0,0,'L',1);
                $pdf->Cell(8,5,": Rp.",0,0,'L',1);
                $pdf->Cell(20,5,number_format($biayatot,0),0,1,'R',1);
...
//global $biayaperkg;
//global $beratd;
        $pdf->Cell(50,$height,$_SESSION['lang']['mengetahui'].",",0,0,'C',0);
        $pdf->Cell(70,$height," ",0,0,'C',0);
        $pdf->Cell(65,$height,$_SESSION['lang']['dibuat'].",",0,1,'C',0);
        $pdf->ln(25);
        ...
        $pdf->Cell(70,$height," ",0,0,'C',0);
        $pdf->SetFont('Arial','U',8);
        $pdf->Cell(65,$height,$optKary[$pengirim],0,1,'C',0);
