...
//pilihan kodeakun    
    ...
    $str="select noakun,".$dd." from ".$dbname.".keu_5akun
                    where detail=1 and tipeakun = 'Biaya' and noakun like '7%' order by noakun
                    ";
    $optakun="";
    $res=mysql_query($str);
    while($bar=mysql_fetch_object($res))
...
echo"<table cellspacing=1 border=0>
  ...
  <tr><td>".$_SESSION['lang']['abkend']."</td>
   ...
   <tr><td>".$_SESSION['lang']['kmhmtahun']."</td><td>:</td><td>
        <input disabled type=text class=myinputtextnumber name=jamperthn id=jamperthn onkeypress=\"return angka_doang(event);\" onblur=kalikanRp()></td></tr>
