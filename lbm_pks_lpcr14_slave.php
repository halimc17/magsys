...
while($rMill=mysql_fetch_assoc($qMill)){
    ...
    $kapasitasvs[$rMill['kodeorg'].$rMill['tanggal']]=$rMill['kapasitasvs'];
...
if($proses=='excel'){
	...
	for ($x=1;$x<=$lastday;$x++){
		...
		$vsolah=($kapasitasvs[$unit.$xtgl]==0 ? 0 : $tbsdiolah[$unit.$xtgl]/$kapasitasvs[$unit.$xtgl]);
		$vssisa=($kapasitasvs[$unit.$xtgl]==0 ? 0 : $sisahariini[$unit.$xtgl]/$kapasitasvs[$unit.$xtgl]);
		$tab.="<td align=right ".$bg.">".number_format($tbsdiolah[$unit.$xtgl],0,'.',',')."</td>";
		$tab.="<td align=right ".$bg.">".number_format($sdhitbsdiolah,0,'.',',')."</td>";
		$tab.="<td align=right ".$bg.">".number_format($vsolah,0,'.',',')."</td>";
		$tab.="<td align=right ".$bg.">".number_format($vssisa,0,'.',',')."</td>";
		$tab.="<td align=right ".$bg.">".number_format($kapasitasvs[$unit.$xtgl],0,'.',',')."</td>";
	...
	$gtkapasitasvs=($gtvsolah==0 ? 0 : $gttbsdiolah/$gtvsolah);
	$tab.="<tr class=rowcontent>";
	$tab.="<td align=center rowspan=1 ".$bg.">Total</td>";
	$tab.="<td align=right ".$bg.">".number_format($gttbsdiolah,0,'.',',')."</td>";
	$tab.="<td align=right ".$bg.">".number_format($sdhitbsdiolah,0,'.',',')."</td>";
	$tab.="<td align=right ".$bg.">".number_format($gtvsolah,0,'.',',')."</td>";
	$tab.="<td align=right ".$bg.">".number_format($gtsisahariini/$gtkapasitasvs,0,'.',',')."</td>";
	$tab.="<td align=right ".$bg.">".number_format($gtkapasitasvs,0,'.',',')."</td>";
