...
OPEN_BOX('',"<b>".$_SESSION['lang']['keluarmasukbibit']."</b>");
...
<tr><td>".$_SESSION['lang']['kodetransaksi']."</td><td>:</td><td><input type='text' class='myinputtext'  style='width:150px;' id='kdTransAfk' value='AFB'  disabled /></td></tr>
...
<tr><td>".$_SESSION['lang']['dari']."</td><td>:</td><td><select id='kdOrgPnb' style=width:150px>".$optKdorg2."</select></td></tr>
...
<tr><td>".$_SESSION['lang']['nomorspb']."</td><td>:</td><td><input type='text' class='myinputtext'  style='width:150px;' id='ketPnb' onkeypress='return tanpa_kutip(event)' maxlength=45 /></td></tr>";
...
<tr><td>".$_SESSION['lang']['tujuan']."</td><td>:</td><td><select id='custId' style=width:150px onchange='getKodeorgBlok()'>".$optKode."</select></td></tr>
