...
OPEN_BOX('',"<b>".$_SESSION['lang']['pemeliharaanMesin']." - Predictive</b>");
?>
<script language=javascript1.2 src='js/pabrik_prediktif.js'></script>
...
$iKar="select a.karyawanid,a.namakaryawan,a.nik from ".$dbname.".datakaryawan a
		...
		where a.lokasitugas='".$_SESSION['empl']['lokasitugas']."' and a.tipekaryawan not in ('0','7','8') 
			and	(b.namajabatan like '%mecha%' or b.namajabatan like '%process%' 
...
*/
$optPerbaikan="<option value='predictive'>Predictive Maintenance</option>";
#shift
$optShift='';
for($i=1;$i<=3;$i++){
...
<fieldset>
	...
	<table cellspacing=1 border=0>
        ...
        <tr>
            ...
            <td>:</td>		
            <td><select id=statusPemohon  style=\"width:300px;\">".$optStPemohon."</select></td>
		</tr> -->
        <tr>
            <td>".$_SESSION['lang']['pabrik']."</td>
            <td>:</td>
            <td><select id=pabrik disabled style=\"width:300px;\">'".$optPabrik."'</select></td>
		</tr>
        <tr>
            <td>".$_SESSION['lang']['station']."</td>
            <td>:</td>		
            <td><select id=station onchange=getMesin() style=\"width:300px;\">'".$optStation."'</select></td>
		</tr>
        <tr>
        ...
        <tr>
            ...
            <td>:</td>
            <td><textarea onkeypress=\"return tanpa_kutip(event)\" id=uraianKerusakan style=\"width:500px;\" rows=3></textarea></td>
        </tr>
        <tr>
            <td>".$_SESSION['lang']['keterangan']."</td>
            <td>:</td>
            <td><textarea onkeypress=\"return tanpa_kutip(event)\" id=komMain style=\"width:500px;\" rows=3></textarea></td>
        </tr>
        <tr>
            <td>Jam Mulai</td>
            <td>:</td>
