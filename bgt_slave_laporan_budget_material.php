...
$sListData="select distinct tahunbudget,substr(kodeorg,1,4) as kodeorg,substr(kodebudget,3,3) as kelompokbarang,kodebarang,sum(fis01) as fis1,sum(fis02) as fis2,
            ...
            sum(fis10) as fis10,sum(fis11) as fis11,sum(fis12) as fis12,sum(jumlah) as jmlhStaon,satuanj from ".$dbname.".bgt_budget_detail where (substr(kodebudget,1,1)='M' or kodebudget='TOOL') ".$where."
            group by kodebarang";
}
else
{
    $sListData="select distinct tahunbudget,substr(kodeorg,1,4) as kodeorg,substr(kodebudget,3,3) as kelompokbarang,kodebarang,sum(rp01) as fis1,sum(rp02) as fis2,
            ...
            sum(rp10) as fis10,sum(rp11) as fis11,sum(rp12) as fis12,sum(rupiah) as jmlhStaon,satuanj from ".$dbname.".bgt_budget_detail where (substr(kodebudget,1,1)='M' or kodebudget='TOOL') ".$where."
            group by kodebarang";
}
//echo $sListData;
