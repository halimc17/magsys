...
if($proses=='excel')
{
	...
	<tbody>";
       ...
       $qKaryLangsung=mysql_query($sKaryLangsung) or die(mysql_error());
        ...
        foreach($dataAfd as $listAfd)
        {
            @$AfdLak[$listAfd]=$totManAfdLak[$listAfd][L]>0?$totKaryLang[$listAfd][L]/$totManAfdLak[$listAfd][L]:0;
            @$AfdPer[$listAfd]=$totManAfdPer[$listAfd][P]>0?$totKaryLang[$listAfd][P]/$totManAfdPer[$listAfd][P]:0;
