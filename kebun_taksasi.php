...
echo"<td><input id=\"tanggal\" name=\"tanggal\" class=\"myinputtext\" onkeypress=\"return tanpa_kutip(event)\" onchange='getSPH()' style=\"width:150px\" readonly=\"readonly\" onmousemove=\"setCalendar(this.id)\" type=\"text\">
     </td></tr>";
echo"<tr>";
...
//    echo"<tr>";
//    echo"<td></td>";
//    echo"<td><input id=\"sph\" name=\"sph\" type=\"hidden\">
//         </td></tr>";
//}
echo"<tr>";
echo"<tr>";
...
//if($regional!='KALTIM'){
    echo"<td><input id=\"jmlhpokok\" name=\"jmlhpokok\" class=\"myinputtextnumber\" onkeypress=\"return angka_doang(event)\"  style=\"width:100px\" type=\"text\" disabled>
         </td></tr>";
//}else{
...
//if($regional!='KALTIM'){
    echo"<td><input id=\"persenbuahmatang\" name=\"persenbuahmatang\" class=\"myinputtextnumber\" onkeypress=\"return angka_doang(event)\" onchange='getMasak()'  style=\"width:100px\" type=\"text\">
         </td></tr>";
//}else{
...
//if($regional!='KALTIM'){
    echo"<td><input id=\"jjgmasak\" name=\"jjgmasak\" class=\"myinputtextnumber\" onkeypress=\"return angka_doang(event)\"   style=\"width:100px\" type=\"text\" disabled>
         </td></tr>";
//}else{
...
//if($regional!='KALTIM'){
    echo"<td><input id=\"jjgoutput\" name=\"jjgoutput\" class=\"myinputtextnumber\" onkeypress=\"return angka_doang(event)\"   style=\"width:100px\" type=\"text\" disabled>
         </td></tr>";
//}else{
...
//if($regional!='KALTIM'){
    echo"<td><input id=\"hkdigunakan\" name=\"hkdigunakan\" class=\"myinputtextnumber\" onkeypress=\"return angka_doang(event)\"   style=\"width:100px\" type=\"text\" disabled>
         </td></tr>";
//}else{
...
//if($regional!='KALTIM'){
    echo"<td><input id=\"bjr\" name=\"bjr\" class=\"myinputtextnumber\" onkeypress=\"return angka_doang(event)\"   style=\"width:100px\" type=\"text\" disabled>
         </td></tr>";
//}else{
...
//if($regional!='KALTIM'){
    ...
    echo"<td><input id=\"bisapanen\" name=\"bisapanen\" class=\"myinputtextnumber\" onkeypress=\"return angka_doang(event)\"   style=\"width:100px\" type=\"text\" disabled>
         </td></tr>";
//}else{
//    echo"<td><input id=\"bisapanen\" name=\"bisapanen\" type=\"hidden\">
//         </td></tr>";
//}
