<?php
	...
	while($dPlan=mysql_fetch_assoc($qPlan)){
		...
		$centangP[$dPlan['kodestasiun']][$dPlan['kodemesin']][$dPlan['nomor']][$bulanke][$mingguke]='&radic;';
	}
	...
	while($dReal=mysql_fetch_assoc($qReal)){
		...
		$mingguke=($mingguke==6 ? 5 : $mingguke);
		$centangR[$dReal['kodestasiun']][$dReal['kodemesin']][$dReal['nomor']][$bulanke][$mingguke]='&radic;';
	}
