...
<?
	...
	OPEN_BOX();
	$arr0="##kodept0##kodeunit0##kodedivisi0##kodeblok0##tanggal10##tanggal20";
	$arr1="##kodept1##kodeunit1##jenis1##tahun1";

	###form input 1
	################
	$frm[0].="<fieldset style='float:left;'><legend><b>".$_SESSION['lang']['laporan'].' Langsir vs Kirim Detail'."</b></legend>
			<table>
				<tr>
				...
				<tr>
					<td colspan=100>
						<button onclick=zPreview('kebun_lap_langsir_detail','".$arr0."','printContainer0') class=mybutton name=preview0 id=preview0>".$_SESSION['lang']['preview']."</button>
						<button onclick=zExcel(event,'kebun_lap_langsir_detail.php','".$arr0."') class=mybutton name=excel0 id=excel0>".$_SESSION['lang']['excel']."</button>
...
/*
	###form input 2
	################
	$frm[1].="<fieldset style='float:left;'><legend><b>".$_SESSION['lang']['laporan'].' Langsir vs Kirim Rekap'."</b></legend>
			<table>
				<tr>
					<td>".$_SESSION['lang']['pt']."</td>
					<td>:</td>
...
*/
	$hfrm[0]=$_SESSION['lang']['laporan'].' Langsir vs Kirim Detail';
//	$hfrm[1]=$_SESSION['lang']['laporan'].' Langsir vs Kirim Rekap';
