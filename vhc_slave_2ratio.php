...
$res=mysql_query($str);   
  ...
  while($bar=mysql_fetch_object($res))
  {
      ...
      $str="select kodevhc,jenisvhc,tahunperolehan from ".$dbname.".vhc_5master where kodetraksi like '".$kodeorg."%'";
      ...
      $tab="Penggunaan BBM  Sat./Litre  Kendaraan-Alat Berat-Mesin ".$kodeorg." Periode:".substr($waktu,0,4)."                   
               ...
               <td rowspan=3>".$_SESSION['lang']['kodevhc']."</td>
                <td rowspan=3>".$_SESSION['lang']['jenis']."</td>
                    <td rowspan=3>".$_SESSION['lang']['namajenisvhc']."</td>
                        <td rowspan=3>".$_SESSION['lang']['tahunperolehan']."</td>
