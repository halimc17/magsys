				...
				<td valign=top>  
					<table>
						...
						<tr>
							...
							<td><input type=text id=jamganti1 value=0 class=myinputtextnumber maxlength=8 size=12 onkeypress=\"return angka_doang(event);\"></td>
						</tr>
						<tr>
							<td>Pergantian Sparepart 2 /Intermediate/Top Overhaul</td>
							<td><input type=text id=jamganti2 value=0 class=myinputtextnumber maxlength=8 size=12 onkeypress=\"return angka_doang(event);\"></td>
						</tr>
						<tr>
							<td>Pergantian Sparepart 3 /Major/General Overhaul</td>
							<td><input type=text id=jamganti3 value=0 class=myinputtextnumber maxlength=8 size=12 onkeypress=\"return angka_doang(event);\"></td>
						</tr>
						<tr>
							<td>HM Akhir</td>
		...
		<table class=sortable cellspacing=1 border=0 width=100%>
			<thead>
				<tr class=rowheader>
					...
					<td width='7%' align=center>Pergantian Sparepart 2/ Intermediate/ Top.Overhaul</td>
					<td width='7%' align=center>Pergantian Sparepart 3/ Major/ Gen.Overhaul</td>
