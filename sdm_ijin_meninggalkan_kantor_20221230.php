...
if(trim($_SESSION['empl']['tipelokasitugas'])=='HOLDING'){
   ...
   if($_SESSION['empl']['tipekaryawan']=='1' or $_SESSION['empl']['tipekaryawan']=='2' or $_SESSION['empl']['tipekaryawan']=='3'){
		...
		or ((tanggalkeluar = '0000-00-00' or tanggalkeluar > '".date("Y-m-d")."') and karyawanid!='".$_SESSION['standard']['userid']."' and (kodejabatan=200 or kodejabatan=332 or kodejabatan=344 or kodejabatan=119 or ((kodejabatan=1 or kodejabatan=117) and kodegolongan like '%MGR%' and lokasitugas in (select kodeunit from ".$dbname.".bgt_regional_assignment where regional='".$_SESSION['empl']['regional']."')))) 
		or karyawanid!='".$_SESSION['standard']['userid']."' and karyawanid in
		(select karyawanid from ".$dbname.".datakaryawan where (tanggalkeluar = '0000-00-00' or tanggalkeluar > '".date("Y-m-d")."') and tipekaryawan in ('0','2','6','7','8','9') and lokasitugas='".$_SESSION['empl']['lokasitugas']."' and (kodejabatan in (select kodejabatan from ".$dbname.".sdm_5jabatan WHERE namajabatan like '%assis%' or namajabatan like '%Coordinator%' or namajabatan like '%PJS%') or kodejabatan=332 or kodejabatan=344 or kodejabatan=119))
