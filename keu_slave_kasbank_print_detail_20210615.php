                    ...
                    else
                    {
                           ...
                           $dht['tipetransaksi']=='M'){
											...
											*/
                                            ...
                                            $pdf->vcell2(25/100*$width,$height+5,57.5,'(Budget & Cost Control)',15,'BLR',0,'C');
											if($kodept=='MPA'){
                                            ...
                                            $pdf->Cell(18/100*$width,$height,$_SESSION['lang']['diketahuioleh'],1,0,'C',1);
                                            ...
                                            for($i=0;$i<5;$i++) {
                                                            ...
                                                            $pdf->Cell(18/100*$width,$height,'','LR',0,'C',1);
                                            ...
                                            if(isset($userId[$dht['userid']])) {
                                                            $pdf->Cell(14/100*$width,$height+5,$userId[$dht['userid']],'BLR',0,'C',1);
                                            } else {
                                                            $pdf->Cell(14/100*$width,$height+5,'','BLR',0,'C',1);
                                            }
                                            //$pdf->Cell(15/100*$width,$height,'(Budget)','BLR',0,'C',1);
											$pdf->vcell2(18/100*$width,$height+5,36.5,'(Budget & Cost Control)',15,'BLR',0,'C');
											if($kodept=='MPA'){
												$pdf->Cell(17/100*$width,$height+5,'(Director)','BLR',0,'C',1);
											}else{
												$pdf->Cell(17/100*$width,$height+5,'','BLR',0,'C',1);
											}	
                                            
                                            $pdf->Cell(16/100*$width,$height+5,'(Finance Director)','BLR',0,'C',1);
                                            $pdf->Cell(20/100*$width,$height+5,'(President Director)','BLR',0,'C',1);
                                            $pdf->Cell(15/100*$width,$height+5,'(Acct & Tax)','BLR',0,'C',1);
                        }
                    }
