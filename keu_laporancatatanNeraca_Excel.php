...
while($bar=mysql_fetch_object($res))
{
    ...
    $stream.="<tr class=rowcontent>";
        ...
        $stream.="<td align=right>".number_format($saldoawal,2)."</td>";
        $stream.="<td align=right>".number_format($saldodebet,2)."</td>";
        $stream.="<td align=right>".number_format($saldokredit,2)."</td>";
        $stream.="<td align=right>".number_format($saldoakhir,2)."</td>";
     $stream.="</tr>";
}
    $stream.="<tr class=rowcontent>";
        $stream.="<td align=center colspan=4>Total</td>";
        $stream.="<td align=right>".number_format($totalawal,2)."</td>";
        $stream.="<td align=right>".number_format($totaldebet,2)."</td>";
        $stream.="<td align=right>".number_format($totalkredit,2)."</td>";
        $stream.="<td align=right>".number_format($totalakhir,2)."</td>";
     $stream.="</tr>";
$stream.="</tbody>
		 <tfoot>
		 </tfoot>		 
