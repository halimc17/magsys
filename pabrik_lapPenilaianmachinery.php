...
<legend><b><?php echo $_SESSION['lang']['laporan']." Penilaian Kondisi Mesin";?></b></legend>
...
<tr><td colspan="2">
	<button onclick="zPreview('pabrik_lapPenilaianmachinery_slave','<?php echo $arr;?>','printContainer')" class="mybutton" name="preview" id="preview">Preview</button>
	<button onclick="zExcel(event,'pabrik_lapPenilaianmachinery_slave.php','<?php echo $arr;?>')" class="mybutton" name="preview" id="preview">Excel</button>
