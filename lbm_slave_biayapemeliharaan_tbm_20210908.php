...
$iptarpthn="select sum(rupiah) as rupiah,sum(volume) as volume,noakun from ".$dbname.".pta_dt_blok_vw where "
        . " tahun='".$tahun."' and kodeorg like '%".$sortUnit."%' and (left(noakun,5) between '12606' and '12616')"
        . " group by noakun";
...
$iptarpbln="select sum(rupiah) as rupiah,sum(volume) as volume,noakun from ".$dbname.".pta_dt_blok_vw where "
        . " bulan='".$periode."' and kodeorg like '%".$sortUnit."%' and (left(noakun,5) between '12606' and '12616')"
        . " group by noakun";
...
$iptarpsdbln="select sum(rupiah) as rupiah,sum(volume) as volume,noakun from ".$dbname.".pta_dt_blok_vw where "
        ...
        . " and kodeorg like '%".$sortUnit."%' "
        . " and (left(noakun,5) between '12606' and '12616') group by noakun";
...
// excel array content =========================================================================
    ...
    if(!empty($dzArr))foreach($dzArr as $keg){
        if(strlen($keg['noakun'])==5){
            ...
            @$total[812]=$keg[811]/1000/$keg[810];
            ...
            @$total[822]=$keg[821]/1000/$keg[820];
            ...
            @$total[832]=$keg[831]/1000/$keg[830];
