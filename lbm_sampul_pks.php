...
$sOrg="select namaorganisasi,kodeorganisasi from ".$dbname.".organisasi where CHAR_LENGTH(kodeorganisasi)='4' 
    and tipe in ('PABRIK') order by namaorganisasi asc";
...
<table cellspacing=\"1\" border=\"0\" >
    ...
    <tr><td><input type='hidden' id='afdId' name='afdId' value=''></td></tr>
    <!--<tr><td><label>".$_SESSION['lang']['afdeling']."</label></td><td><select id='afdId' style=\"width:200px;\">".$optafd."</select></td></tr>-->
    <tr height=\"20\"><td colspan=\"2\">&nbsp;</td></tr>
    <tr><td colspan=\"2\">
    <button onclick=\"zPdf('lbm_slave_sampul_pks','".$arr."','reportcontainer')\" class=\"mybutton\" name=\"pdf\" id=\"pdf\">". $_SESSION['lang']['pdf']."</button>
