...
$arr="##unit##periode##judul##afdId##kegId"; 
...
<table cellspacing=\"1\" border=\"0\" >
    ...
    <tr><td><label>".$_SESSION['lang']['kegiatan']."</label></td><td><select id='kegId' style=\"width:200px\">".$optkeg."</select></td></tr>
    <tr height=\"20\"><td colspan=\"2\"><input type=hidden id=judul name=judul value='".$judul."'></td></tr>
    <tr><td colspan=\"2\"> 
    <button onclick=\"zPreview('lbm_slave_semprot','".$arr."','reportcontainer')\" class=\"mybutton\" name=\"preview\" id=\"preview\">".$_SESSION['lang']['preview']."</button>
    <button onclick=\"zExcel(event,'lbm_slave_semprot.php','".$arr."','reportcontainer')\" class=\"mybutton\" name=\"excel\" id=\"excel\">".$_SESSION['lang']['excel']."</button>    
