...
//						  {
        ...
        case 'loadData':
			...
			$sql2="select count(*) as jmlhrow from ".$dbname.".log_poht_del where 1=1 ".$addTmbh."  ORDER BY nopo DESC";
			$query2=mysql_query($sql2) or die(mysql_error());
			while($jsl=mysql_fetch_object($query2)){
			$jlhbrs= $jsl->jmlhrow;
			}
	 // stat_release='1'
		$str="SELECT * FROM ".$dbname.".log_poht_del where 1=1 ".$addTmbh."  ORDER BY tanggal DESC limit ".$offset.",".$limit."";
