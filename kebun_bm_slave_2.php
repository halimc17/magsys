...
switch($proses)
{
    ...
    echo"<link rel=stylesheet type=text/css href=style/generic.css>
        ...
        <script language=javascript1.2 src='js/kebun_bm.js'></script>";
    ...
    echo"<br /><img onclick=fisikKeExcel2(event,'kebun_bm_slave_2.php') src=images/excel.jpg class=resicon title='MS.Excel'> ";
    ...
    $sPrestasi="select a.*,b.tanggal,b.nikmandor,c.namaorganisasi from ".$dbname.".kebun_prestasi a 
        ...
        left join ".$dbname.".kebun_aktifitas b on a.notransaksi=b.notransaksi 
            where a.kodeorg='".$kodeorg."' and b.tanggal='".$tgl."' and b.tipetransaksi='BM'";
//    echo $sPrestasi;
    ...
    echo"<br /><img onclick=fisikKeExcel2Denda(event,'kebun_bm_slave_2.php') src=images/excel.jpg class=resicon title='MS.Excel'> ";
    echo"<input type='hidden' id='tanggal' value='".$tgl."' /><input type='hidden' id='kdOrg' value='".$kodeorg."' />
        <table class=sortable cellpadding=1 border=0>
        <thead>
        <tr class=rowheader>
    ...
    $sPrestasi="select a.*,b.tanggal,b.nikmandor,c.namaorganisasi from ".$dbname.".kebun_prestasi a 
        left join ".$dbname.".organisasi c on a.kodeorg=c.kodeorganisasi 
        left join ".$dbname.".kebun_aktifitas b on a.notransaksi=b.notransaksi 
            where a.rupiahpenalty>0 and a.kodeorg='".$kodeorg."' and b.tanggal='".$tgl."' and b.tipetransaksi='BM'";
//    echo $sPrestasi;
    ...
    echo"<br /><img onclick=fisikKeExcel3(event,'kebun_bm_slave_2.php') src=images/excel.jpg class=resicon title='MS.Excel'> ";
...
//    echo $str;	
    ...
    $tab.="</tbody>";
			...
			$nop_="laporanBMDetailDenda_".$kodeorg."_".$tgl;
			if(strlen($tab)>0)
			{
    ...
    $tab.="</tbody>";
			...
			$nop_="laporanBMDetail_".$kodeorg."_".$tgl;
			if(strlen($tab)>0)
			{
			if ($handle = opendir('tempExcel')) {
			while (false !== ($file = readdir($handle))) {
