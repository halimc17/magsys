		...
		while($bar=mysql_fetch_object($res)){
			...
			echo"<tr class=rowcontent >
					...
					<td align=center width='6%'>
						<img src='images/skyblue/edit.png' class='resicon' title='Edit' onclick=\"fillfield('".$bar->kodeorg."','".tanggalnormal($bar->tanggal)."','".$bar->jenis."','".substr($bar->waktu,0,5)."','".$bar->janjang."','".$bar->supirlangsir."','".$bar->keterangan."','')\">&nbsp
						...
						<img src=images/pdf.jpg class=resicon title='Print BA' onclick=\"preview_BAPDF('".$bar->kodeorg."','".$bar->tanggal."','".$bar->jenis."',event);\">
					</td>
				</tr>";	
		}
		echo"
