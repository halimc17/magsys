...
{*/
	...
	if($kodeorg=='')
	{
		$iList="select * from ".$dbname.".keu_jurnaldt_vw where kodeblok='' and kodeorg='".$unit."' and periode='".$per."'"
            . " and  noakun='".$noakun."' ";
	}
	else if (strlen($kodeorg)==4)
	{
		$iList="select * from ".$dbname.".keu_jurnaldt_vw where kodeblok = '".$kodeorg."' and periode='".$per."'"
            . " and  noakun='".$noakun."' ";
	}
	else
	{
