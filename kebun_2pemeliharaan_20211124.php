...
$arr="##kdOrg##kdAfd##tgl1##tgl2##kegiatan##sumber##kdbarang##intiplasma";
...
<tr><td><label>".$_SESSION['lang']['sumber']."</label></td><td><select id=\"sumber\" name=\"sumber\" style=\"width:150px\">".$optSumber."</select></td></tr>
<tr><td><label>".$_SESSION['lang']['namabarang']."</label></td><td><select id=\"kdbarang\" name=\"kdbarang\" style=\"width:150px\">".$optbarang."</select></td></tr>
<tr><td><label>".$_SESSION['lang']['intiplasma']."</label></td><td><select id=\"intiplasma\" name=\"intiplasma\" style=\"width:150px\"><option value=''>".$_SESSION['lang']['all']."</option><option value='I'>Inti</option><option value='P'>Plasma</option></select></td></tr>
...
<tr><td><label>".$_SESSION['lang']['afdeling']."</label></td><td><select id=\"kdAfd1\" name=\"kdAfd1\" style=\"width:150px\"><option value=\"\"></option></select></td></tr>
