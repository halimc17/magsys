...
$stream.="<thead><tr class=rowheader>
			...
			<td rowspan=4 align=center width='45px'>Selisih Janjang</td>
...
while($dList=mysql_fetch_assoc($nList)){
	...
	$stream.="<tr class=rowcontent>
				...
				<td align='right'>".number_format(($dList['janjang']-$dList['jjgsortasi']),0)."</td>
...
$stream.="<tr bgcolor='#FEDEFE'>
			...
			<td align='right'>".number_format(($gtjanjang-$gtjjgsortasi),0)."</td>
