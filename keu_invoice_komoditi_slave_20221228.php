	...
	case'loadDetail':
		...
		while($bar=mysql_fetch_assoc($res)){
			...
			<tr class=rowcontent>
				...
				<td align=center><input type=text id=hargasatuan".$no." value=".number_format($bar['nilaitransaksi']/$bar['nilaiinventory'],4)." disabled class=myinputtextnumber onblur=getNilaiTransaksi(".$no.") style=\"width:105px;\"></td>
