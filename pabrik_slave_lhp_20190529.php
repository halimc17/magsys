...
//exit($sql);
			...
			if($row>0)
			{
				...
				{
					$no+=1;
					$waktumulai=substr($tanggalmulai,0,4).substr($tanggalmulai,5,2).substr($tanggalmulai,8,2).sprintf("%02d",$no);
					if($no+12==24){
						$waktumulai2=substr($tanggalakhir,0,4).substr($tanggalakhir,5,2).substr($tanggalakhir,8,2).sprintf("%02d",0);
					}else{
						$waktumulai2=substr($tanggalmulai,0,4).substr($tanggalmulai,5,2).substr($tanggalmulai,8,2).sprintf("%02d",$no+12);
					}
					$waktuakhir=substr($tanggalakhir,0,4).substr($tanggalakhir,5,2).substr($tanggalakhir,8,2).sprintf("%02d",$no);
					if($res['namaunit']!=$namaunit){
						if($totalTonageday==0){
							echo"<tr class=rowcontent>
								<td colspan=12>".$res['namaunit']."</td>

								<td colspan=2 style='text-align:center;'>".($no).':00'."</td>
								<td colspan=2 style='text-align:right;'>".number_format($tonage[$waktumulai])."</td>
								<td colspan=2 style='text-align:center;'>".($no+12).':00'."</td>
								<td colspan=2 style='text-align:right;'>".number_format($tonage[$waktumulai2])."</td>
								<td colspan=2 style='text-align:center;'>".($no).':00'."</td>
								<td colspan=2 style='text-align:right;'>".number_format($tonage[$waktuakhir])."</td>
								</tr>";
							$no+=1;
							$waktumulai=substr($tanggalmulai,0,4).substr($tanggalmulai,5,2).substr($tanggalmulai,8,2).sprintf("%02d",$no);
							if($no+12==24){
						...
						if($no<=12){
						echo"<td colspan=2 style='font-weight:normal;text-align:center;'>".($no).':00'."</td>
							<td colspan=2 style='font-weight:normal;text-align:right;'>".number_format($tonage[$waktumulai])."</td>
							<td colspan=2 style='font-weight:normal;text-align:center;;'>".($no+12).':00'."</td>
							<td colspan=2 style='font-weight:normal;text-align:right;'>".number_format($tonage[$waktumulai2])."</td>
							<td colspan=2 style='font-weight:normal;text-align:center;;'>".($no).':00'."</td>
							<td colspan=2 style='font-weight:normal;text-align:right;'>".number_format($tonage[$waktuakhir])."</td>";
						}else if($no==13){
						echo"<td colspan=10 style='font-weight:bold;'>TOTAL PENERIMAAN TBS [Kg]</td>
					...
					echo"<tr class=rowcontent>
						...
						echo"<td colspan=12 style='text-align:center;'>K. STOCK AWAL MKS DAN IKS</td>";
						}else if($no==15){
						echo"<td colspan=10 style='text-align:center;'>Uraian</td>";
						echo"<td colspan=2 style='text-align:center;'>Pagi Ini</td>";
						}else if($no==16){
						echo"<td colspan=1 style='text-align:center;'></td>";
						echo"<td colspan=9>Stock MKS di PKS [Kg]</td>";
						echo"<td colspan=2 style='text-align:right;'>".number_format($mkslalu)."</td>";
						}else if($no==17){
						echo"<td colspan=1 style='text-align:center;'></td>";
						echo"<td colspan=9>Stock IKS di PKS [Kg]</td>";
						echo"<td colspan=2 style='text-align:right;'>".number_format($ikslalu)."</td>";
						}
					echo"</tr>";
