 ...
 ***************************************************/
// 1. Setup Blok
$qBlok = selectQuery($dbname,'setup_blok','*',"kodeorg like '".$param['kebun']."%'");
...
$qBlokBgt = selectQuery($dbname,'bgt_blok',"*",
    "tahunbudget='".$year."' and kodeblok like '".$param['kebun']."%'");
...
if($mode=='excel') {
	...
	$tab = "<div style='overflow:auto; max-width:1000px;max-height:400px'>";
