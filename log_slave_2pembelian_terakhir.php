...
$tglDr=			empty($_POST['tglDr'])? (isset($_GET['tglDr'])? $_GET['tglDr']: ''): $_POST['tglDr'];
$tanggalSampai=	empty($_POST['tanggalSampai'])? (isset($_GET['tanggalSampai'])? $_GET['tanggalSampai']: ''): $_POST['tanggalSampai'];
	...
	case'preview':
        ...
        else
        {
            ...
            foreach($dataBrg as $row => $rList)
            {
                ...
                foreach($dtBLn as $brsBln)
                {
					if(!isset($dataTgl[$brsBln][$rList])) $dataTgl[$brsBln][$rList]='';
					if(!isset($dataMtUang[$brsBln][$rList])) $dataMtUang[$brsBln][$rList]='';
					if(!isset($dataPrice[$brsBln][$rList])) $dataPrice[$brsBln][$rList]=0;
					if(!isset($dataNmSupplier[$brsBln][$rList])) $dataNmSupplier[$brsBln][$rList]='';
					if(!isset($dataStatus[$brsBln][$rList])) $dataStatus[$brsBln][$rList]='';
