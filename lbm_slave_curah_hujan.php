...
if($proses=='excel')
{
	...
	<tbody>";
        for($tglMula=1;$tglMula<=$jmlHari;$tglMula++)
        {
            ...
            $tab.="<td align=right>".number_format($jmlh[$lstTgl],2)."</td>"; /* HH */
            $tab.="</tr>";
...
//            $hariHujan=count($dtHarSore);
            ...
            $tab.="<td align=right>".$totSemua."</td>"; /* HH */
            $tab.="</tr>";
            ...
            $tab.="<td align=right>".number_format($hariHujan)."</td>";  /* MM */
            $tab.="</tr>";
        $tab.="</tbody></table>";
...
//           $totMm[$dtThn8]+=$dtMm[$dtThn8][10];
         ...
         {            
           ...
           $tab.="<td align=right> ".$mmdt[$dtThn8][11]."</td>"; /*DISINI*/
//           $totHh[$dtThn8]+=$dtHh[$dtThn8][11];
//           $totMm[$dtThn8]+=$dtMm[$dtThn8][11];
         ...
         {           
            ...
            $mmdt[$dtThn8][12]=($dtMm[$dtThn8][12]+$dtMm[$dtThn8][11]+$dtMm[$dtThn8][10]+$dtMm[$dtThn8][9]+$dtMm[$dtThn8][8]+$dtMm[$dtThn8][7]+$dtMm[$dtThn8][6]+$dtMm[$dtThn8][5]+$dtMm[$dtThn8][4]+$dtMm[$dtThn8][3]+$dtMm[$dtThn8][2]+$dtMm[$dtThn8][1]); 
