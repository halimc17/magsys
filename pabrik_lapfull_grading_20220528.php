...
<?php
	...
	$frm[0].="<fieldset style='float:left;'><legend><b>Form Detail</b></legend>
			<table>
				...
				<tr>
					<td colspan=100>
						<button onclick=zPreview('pabrik_lapfull_grading_per_divisi','".$arr0."','printContainer0') class=mybutton name=preview0 id=preview0>".$_SESSION['lang']['preview']."</button>
						<button onclick=zExcel(event,'pabrik_lapfull_grading_per_divisi.php','".$arr0."') class=mybutton name=preview0 id=preview0>".$_SESSION['lang']['excel']."</button>
	...
	$frm[1].="<fieldset style='float:left;'><legend><b>Form Harian</b></legend>
			<table>
				...
				<tr>
					<td colspan=100>
						<button onclick=zPreview('pabrik_lapfull_grading_all_divisi','".$arr1."','printContainer1') class=mybutton name=preview1 id=preview1>".$_SESSION['lang']['preview']."</button>
						<button onclick=zExcel(event,'pabrik_lapfull_grading_all_divisi.php','".$arr1."') class=mybutton name=preview1 id=preview1>".$_SESSION['lang']['excel']."</button>
	...
	$hfrm[0]=$_SESSION['lang']['laporan'].' Full Grading Per Divisi';
	$hfrm[1]=$_SESSION['lang']['laporan'].' Full Grading All Divisi';
