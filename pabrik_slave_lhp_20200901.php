...
if($tanggal==''){
	...
	if($proses=='preview' or $proses=='excel'){
		...
		$tab2[$no2].="
			...
			.number_format( (($kuantitas[1]*$cpoffa[1])+($kuantitas[2]*$cpoffa[2]))/($kuantitas[1]+$kuantitas[2]),2)."</td>";
		$no2+=1;
		$tab2[$no2].="
			...
			<td colspan=2 style='text-align:right;'>"
			.number_format( (($kuantitas[1]*$cpokdair[1])+($kuantitas[2]*$cpokdair[2]))/($kuantitas[1]+$kuantitas[2]),2)."</td>";
		$no2+=1;
		$tab2[$no2].="
			...
			<td colspan=2 style='text-align:right;'>"
			.number_format( (($kuantitas[1]*$cpokdkot[1])+($kuantitas[2]*$cpokdkot[2]))/($kuantitas[1]+$kuantitas[2]),2)."</td>";
		$no2+=1;
		$tab2[$no2].="
			...
			<td colspan=2 style='text-align:right;'>"
			.number_format( (($kuantitas[1]*$dobi[1])+($kuantitas[2]*$dobi[2]))/($kuantitas[1]+$kuantitas[2]),2)."</td>";
		$no2+=1;
		$tab2[$no2].="
