...
#akuun debet
$sakundbt="select distinct noakun,namaakun from ".$dbname.".keu_5akun where noakun like '21401%' and detail=1
...
echo"<td>".$_SESSION['lang']['jatuhtempo']."</td><td><input type=text class=myinputtext id=jatuhtempo onmousemove=setCalendar(this.id) onkeypress=return false;  style=width:150px;  maxlength=10 /></td></tr>";//onchange=\"getKursInvoice()\"  
echo"<tr><td>".$_SESSION['lang']['NoKontrak']."</td><td><input type=text id=noorder class=myinputtext style=width:150px; readonly onclick=\"searchNosibp('".$_SESSION['lang']['find']." ".$_SESSION['lang']['NoKontrak']."','<div id=formPencariandata></div>',event)\" /></td>";
echo"<td>".$_SESSION['lang']['kuantitas']."</td><td>
<input type=text class=myinputtextnumber  id=kuantitas  style=width:150px;  onkeypress='return angka_doang(event)' value='0'/>
...
echo"<td>".$_SESSION['lang']['bayarke']."</td><td><select id=bayarke  style=width:150px; disabled>".$optAkun."</select></td></tr>";
echo"<tr><td>".$_SESSION['lang']['unitkerja']."</td><td><input type=text id=kodeorganisasi class=myinputtext style=width:150px; readonly value='' /></td>";
...
echo"<tr><td>".$_SESSION['lang']['nmcust']."</td><td><select id=kodecustomer style=width:150px disabled>".$optCust."</select></td>";
...
echo"<tr><td>".$_SESSION['lang']['matauang']."</td><td><select id=matauang onchange=getKursInvoice() style=width:150px; >".$optMtuang."</select></td><td>".$_SESSION['lang']['kurs']."</td><td><input type=text id=kurs class=myinputtextnumber style=width:150px; onkeypress='return angka_doang(event)' value='1' /></td></tr>";
