...
<?php
			...
			<table>
				...
				<tr>
					<td colspan=100>
						...
						<button onclick=zExcel(event,'kebun_laporan_penalty_pemanen_per_tanggal.php','".$arr0."') class=mybutton name=excel0 id=excel0>".$_SESSION['lang']['excel']."</button>
			...
			<table>
				...
				<tr>
					<td colspan=100>
						...
						<button onclick=zExcel(event,'kebun_laporan_penalty_pemanen_per__bulan.php','".$arr1."') class=mybutton name=excel1 id=excel1>".$_SESSION['lang']['excel']."</button>
	...
	$hfrm[1]=$_SESSION['lang']['laporan'].' Penalty Pemanen Per Bulan';
