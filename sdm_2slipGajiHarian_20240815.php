...
$sPeriode="select distinct periode from ".$dbname.".sdm_5periodegaji where jenisgaji='H' order by periode desc ";
...
{
		$sOrg="select namaorganisasi,kodeorganisasi from ".$dbname.".organisasi 
               where tipe in ('PABRIK','KANWIL','KEBUN','TRAKSI') and CHAR_LENGTH(kodeorganisasi)=4 and induk='".$_SESSION['empl']['kodeorganisasi']."' order by namaorganisasi asc";	
}
else
{
