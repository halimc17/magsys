...
if($_SESSION['empl']['tipelokasitugas']=='HOLDING')
{
	...
	$sPeriode="select distinct periode from ".$dbname.".setup_periodeakuntansi where kodeorg like '%M' order by periode desc";
...
else
{
	...
	$sPeriode="select distinct periode from ".$dbname.".setup_periodeakuntansi where kodeorg like '%M' and kodeorg='".$lksiTugas."' order by periode desc";
...
<legend><b><?php echo $_SESSION['lang']['laporan']." HM ";?></b></legend>
...
<tr>
	...
	<td><select id="periode" name="periode" style="width:80px">
...
<tr><td colspan="2">
	<button onclick="zPreview('pabrik_laphm_slave','<?php echo $arr;?>','printContainer')" class="mybutton" name="preview" id="preview">Preview</button>
	<button onclick="zExcel(event,'pabrik_laphm_slave.php','<?php echo $arr;?>')" class="mybutton" name="preview" id="preview">Excel</button>
...
<div id='printContainer' style='overflow:auto;height:330px;max-width:1235px'>
