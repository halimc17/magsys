        ...
        foreach($karyawannik as $mdid=>$mdval)
        {
			...
			foreach($mdval as $kpid=>$kpval)
			{
				...
				foreach($tgltgl as $key=>$tangval)
				{
                    ...
                    $stream.="<td title='Click untuk melihat notransaksi.' align=right style=\"cursor: pointer\" onclick=showpopup('".$mdid."','".$kpid."','".$tangval."','".$kdOrg."','".$afdId."','".$pengawas."',event)>".@number_format(($premibersih[$mdid][$kpid][$tangval]/$jmlpemanen[$mdid][$tangval])-($premibersih[$mdid][$kpid][$tangval]/$jmlpemanen[$mdid][$tangval]*$grading[$mdid][$tangval]),2)."</td>";
                    ...
                    $ttgrpremibersih+=($premibersih[$mdid][$kpid][$tangval]/$jmlpemanen[$mdid][$tangval])-($premibersih[$mdid][$kpid][$tangval]/$jmlpemanen[$mdid][$tangval]*$grading[$mdid][$tangval]);
                    ...
                    $stgrpremibersih[$tangval]+=($premibersih[$mdid][$kpid][$tangval]/$jmlpemanen[$mdid][$tangval])-($premibersih[$mdid][$kpid][$tangval]/$jmlpemanen[$mdid][$tangval]*$grading[$mdid][$tangval]);
                    ...
                    $gtgrpremibersih[$tangval]+=($premibersih[$mdid][$kpid][$tangval]/$jmlpemanen[$mdid][$tangval])-($premibersih[$mdid][$kpid][$tangval]/$jmlpemanen[$mdid][$tangval]*$grading[$mdid][$tangval]);
