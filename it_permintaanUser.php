...
$s_karyawan="select karyawanid,namakaryawan from ".$dbname.".datakaryawan
             where (tanggalkeluar = '0000-00-00' or tanggalkeluar > '".date("Y-m-d")."') and tipekaryawan in ('0','7','8') and karyawanid not like '".$_SESSION['standard']['userid']."' order by namakaryawan asc";
