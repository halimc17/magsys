...
$str="select a.kodeorganisasi,a.namaorganisasi from ".$dbname.".organisasi a where a.kodeorganisasi in 
...
//exit('Warning: '.$notransaksi.' = '.$str.' - '.$kodeorganisasi.' - '.$namaorganisasi);
//create Header
