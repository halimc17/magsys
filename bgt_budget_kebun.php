...
$frm[5].="<td></td></tr>
    ...
    $frm[5].="<table><tr class=rowcontent>
              ...
              <td>Goto Page</td><td id='pagingDrop'>&nbsp;<select id='pageSebaran' onchange='loadDetailTotal()'><option value=''></option></select><span id=awalPageSebaran></span> &nbsp;".$_SESSION['lang']['dari']." &nbsp;<span id=totalPageSebaran></span></td></tr>
              </table>";
