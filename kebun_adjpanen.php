...
echo open_body();
?>
<script language=javascript1.2 src='js/kebun_adjpanen.js'></script>
<?php
include('master_mainMenu.php');

OPEN_BOX('',"<b>".'Adjustment Panen Afkir/Hilang/Temuan'."</b>");
//Pilih org
		...
		<table>
			<tr>
				<td valign=top>  
					<table>
						...
						<tr>
							...
							<td><input type=text id=janjang value=0 class=myinputtextnumber maxlength=7 size=10 onkeypress=\"return angka_doang(event);\"></td>
						</tr>
					</table>
				</td>
				...
				<td valign=top>  
					<table>
						<tr>
							<td>Driver Langsir</td>
							<td><input type=text id=supirlangsir class=myinputtext maxlength=30 size=80></td>
						</tr>
						<tr>
							<td>Keterangan</td>
						...
						<tr>
							<td>Catatan</td>
							<td><textarea id=catatan name=catatan rows=5 cols=50 onkeypress=\"return tanpa_kutip(event);\"></textarea></td>
						</tr>
						<tr>
		...
		<table class=sortable cellspacing=1 border=0 width=100%>
			<thead>
				<tr class=rowheader>
					...
					<td width='6%' align=center>".$_SESSION['lang']['blok']."</td>
					<td width='6%' align=center>".$_SESSION['lang']['tanggal']."</td>
					<td width='3%' align=center>".$_SESSION['lang']['waktu']."</td>
					<td width='8%' align=center>".$_SESSION['lang']['jenis']."</td>
					<td width='5%' align=center>".$_SESSION['lang']['janjang']."</td>
					<td width='5%' align=center>".$_SESSION['lang']['kgtbs']."</td>
					<td align=center>Driver Langsir</td>
