...
$frm[0]="<fieldset>
	 ...
	 ".$_SESSION['lang']['pt']."<select id=pt style='width:150px;' onchange=getGudang()>".$optpt."</select>
...
$frm[1]="<fieldset>
     <legend>".$_SESSION['lang']['persediaanfisikharga']." ".$_SESSION['lang']['setahun']."</legend>
	 ".$_SESSION['lang']['pt']."<select id=pt1 style='width:150px;' onchange=getGudang3()>".$optpt."</select>
