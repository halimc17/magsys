...
$sJjg="select distinct sum(hasilkerja) as jjg,left(tanggal,7) as periode,kodeorg 
       from ".$dbname.".kebun_prestasi_vw 
       where kodeorg like '".$unit."%' and left(tanggal,7) = '".$tahuntahuntahun."-".$bulanbulanbulan."' 
       and jurnal=1
       group  by kodeorg
       ";
//echo $sJjg;
