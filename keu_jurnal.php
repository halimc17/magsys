...
#== Prep List Header
$header = array($_SESSION['lang']['kodeabs'],$_SESSION['lang']['nojurnal'],$_SESSION['lang']['tanggal'],$_SESSION['lang']['nodok'],$_SESSION['lang']['matauang'],$_SESSION['lang']['debet'],$_SESSION['lang']['kredit']);
