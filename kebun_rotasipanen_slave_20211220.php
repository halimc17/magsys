<?php
	...
	$tglAwal=$periodeData."-01";
	$lastday = date('t',strtotime($tglAwal));
	$tglAkhir=$periodeData."-".$lastday;
	$laluAwal=(substr($periode,5,2)=='01' ? (substr($periode,0,4)-1).'-12-01' : substr($periode,0,4).'-'.sprintf('%02d',substr($periode,5,2)-1).'-01');
    ...
    $stream.="<table cellspacing='1' border='".$brd."' class='sortable'>
        ...
        <tr>
			...
			<td width='6%' ".$bgclr.">".$_SESSION['lang']['kg']."</td>
			<td width='4%' ".$bgclr.">".$_SESSION['lang']['jjg']."</td>
			<td width='6%' ".$bgclr.">".$_SESSION['lang']['kg']."</td>
			<td width='4%' ".$bgclr.">".$_SESSION['lang']['jjg']."</td>
			<td width='6%' ".$bgclr.">".$_SESSION['lang']['kg']."</td>
