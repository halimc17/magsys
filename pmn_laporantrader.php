...
$arr="##kdUnit##kdCust##nokontrakext##periode##kdBrg";
...
function getSub()
{
    ...
    tujuan='sdm_slave_laporantrader.php';
...
<legend><b><?php echo $_SESSION['lang']['laporan']." ".$_SESSION['lang']['kontrak']." ".$_SESSION['lang']['eksternal'];?></b></legend>
...
<tr>
	<td><label><?php echo $_SESSION['lang']['NoKontrak'].' '.$_SESSION['lang']['eksternal'];?></label></td>
	<td><input type=text class=myinputtext  id=nokontrakext name=nokontrakext style="width:200px" /></td>
</tr>

<tr height="20"><td colspan="2">&nbsp;</td></tr>
<tr><td colspan="2">
	<button onclick="zPreview('pmn_slave_laporantrader','<?php echo $arr;?>','printContainer')" class="mybutton" name="preview" id="preview">Preview</button>
	<button onclick="zExcel(event,'pmn_slave_laporantrader.php','<?php echo $arr;?>')" class="mybutton" name="preview" id="preview">Excel</button>
