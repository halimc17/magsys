    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0"><?php echo $_SESSION['lang']['laporan']." ".$_SESSION['lang']['kontrak']." ".$_SESSION['lang']['eksternal'];?></h5>
            </div>
            <div class="card-body">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label class="form-label"><?php echo $_SESSION['lang']['NoKontrak'].' '.$_SESSION['lang']['eksternal'];?></label>
                    <input type="text" class="form-control form-control-sm" id="nokontrakext" name="nokontrakext" />
                </div>
                <div class="d-grid gap-2">
                    <button onclick="zPreview('pmn_slave_laporantrader','<?php echo $arr;?>','printContainer')" class="btn btn-primary btn-sm">Preview</button>
                    <button onclick="zExcel(event,'pmn_slave_laporantrader.php','<?php echo $arr;?>')" class="btn btn-success btn-sm">Excel</button>
