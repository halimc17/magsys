				...
				<td valign=top>  
					<table>
						<tr>
							...
							<td><select id=nik style='width:265px'>".$optKry."</select></td>
						</tr>
						<tr>
...
echo "<fieldset>
		...
		<table>
			<tr>
				<td>".$_SESSION['lang']['kodeorganisasi']."</td>
				<td><select id=carikodeorg style='width:165px'>".$cariorg."</select></td>
				<td>Inventaris</td>
				<td><input type=text id=carinamainv class=myinputtext maxlength=150 size=30></td>
				<td>Karyawan</td>
				<td><select id=carikaryawan style='width:165px'>".$optKry."</select></td>
				<td>Ruangan</td>
				<td><input type=text id=cariruangan class=myinputtext maxlength=50 size=30></td>
				...
				<td><button class=mybutton title='Print BA' onclick=cariinventaris('qrxls',event)>QR ".$_SESSION['lang']['excel']."</button></td>
			</tr>
		</table>
	</fieldset>";
CLOSE_BOX();
