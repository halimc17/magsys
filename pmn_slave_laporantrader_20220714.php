<?php
	...
	$str = "select a.*,b.nokontrak,b.nosipb,b.tanggal,b.beratbersih
			,if(d.ppn='0',d.hargasatuan,d.hargasatuan/if(d.tanggalkontrak<='2022-03-31',1.1,1.11)) as hargakirim
			,c.tanggalkontrak, c.kuantitaskontrak,if(c.ppn='0',c.hargasatuan,c.hargasatuan/if(c.tanggalkontrak<='2022-03-31',1.1,1.11)) as hargasatuan 
			from ".$dbname.".pmn_traderht a
			LEFT JOIN (select z.* from ".$dbname.".pmn_traderdt z where z.posting='1') b on b.nokontrakext=a.nokontrakext
			...
			where ".$whr." order by a.tanggalext desc,a.nokontrakext desc
			";
	//exit('Warning : '.$str);
	$res=mysql_query($str);
	$nokontrakextd="";
