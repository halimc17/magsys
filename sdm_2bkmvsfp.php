...
if(trim($_SESSION['empl']['tipelokasitugas'])=='HOLDING'){
	...
	$iUnit="select kodeorganisasi, namaorganisasi from ".$dbname.".organisasi where (tipe='KEBUN' or tipe='KANWIL') and detail='1'";
}elseif(trim($_SESSION['empl']['tipelokasitugas'])=='KANWIL'){
	$optUnit="<option value=''>".$_SESSION['lang']['pilihdata']."</option>";
	$iUnit="select kodeorganisasi, namaorganisasi from ".$dbname.".organisasi where (tipe='KEBUN' or tipe='KANWIL') and induk='".$_SESSION['empl']['induk']."' and detail='1'";
}else{
...
$iDivisi="select kodeorganisasi, namaorganisasi from ".$dbname.".organisasi where tipe not like 'GUDANG%' and (induk='".$_SESSION['empl']['lokasitugas']."' or kodeorganisasi='".$_SESSION['empl']['lokasitugas']."')";
