...
//    echo $blk.'<br>';
    ...
    $str="SELECT noakun, namaakun FROM ".$dbname.".keu_5akun
        WHERE substr(noakun,1,5) between '61101' and '61102' order by noakun";
    $query=mysql_query($str) or die(mysql_error($conn));
    while($res=mysql_fetch_assoc($query))
    {
    ...
    // noakun 711
    $str="SELECT noakun, namaakun FROM ".$dbname.".keu_5akun
        WHERE substr(noakun,1,5) between '71101' and '71199' order by noakun";
    $query=mysql_query($str) or die(mysql_error($conn));
    while($res=mysql_fetch_assoc($query))
    {
    ...
    // noakun 712
    $str="SELECT noakun, namaakun FROM ".$dbname.".keu_5akun
        WHERE substr(noakun,1,5) between '71201' and '71299' order by noakun";
    $query=mysql_query($str) or die(mysql_error($conn));
    while($res=mysql_fetch_assoc($query))
    {
    ...
    // noakun 713
    $str="SELECT noakun, namaakun FROM ".$dbname.".keu_5akun
        WHERE substr(noakun,1,5) between '71301' and '71399' order by noakun";
    $query=mysql_query($str) or die(mysql_error($conn));
    while($res=mysql_fetch_assoc($query))
    {
    ...
    // noakun 714
    $str="SELECT noakun, namaakun FROM ".$dbname.".keu_5akun
        WHERE substr(noakun,1,5) between '71401' and '71499' order by noakun";
    $query=mysql_query($str) or die(mysql_error($conn));
    while($res=mysql_fetch_assoc($query))
    {
    ...
    // noakun 71501
    $str="SELECT noakun, namaakun FROM ".$dbname.".keu_5akun
        WHERE substr(noakun,1,5) between '71501' and '71501' order by noakun";
    $query=mysql_query($str) or die(mysql_error($conn));
    while($res=mysql_fetch_assoc($query))
    {
    ...
    // noakun 716
    $str="SELECT noakun, namaakun FROM ".$dbname.".keu_5akun
        WHERE substr(noakun,1,5) between '71601' and '71699' order by noakun";
    $query=mysql_query($str) or die(mysql_error($conn));
    while($res=mysql_fetch_assoc($query))
    {
    ...
    // noakun 71502
    $str="SELECT noakun, namaakun FROM ".$dbname.".keu_5akun
        WHERE length( noakun ) = 7 and substr(noakun,1,5) between '71502' and '71502' order by noakun";
    $query=mysql_query($str) or die(mysql_error($conn));
    while($res=mysql_fetch_assoc($query))
    {
...
//    }
    ...
    $str="SELECT kodeblok, intiplasma, substr(noakun,1,7) as noakun, debet, kredit FROM ".$dbname.".keu_jurnalsum_blok_vw
...
//    }
    ...
    $str="SELECT kodeorg, intiplasma, substr(noakun,1,7) as noakun, (rp".$bulan.") as rp, rupiah FROM ".$dbname.".bgt_budget_kebun_perblok_vw
...
//// jamhari
$str="select (rp".$bulan.") as rp,substr(noakun,1,7) as noakun,rupiah from ".$dbname.".bgt_budget_detail 
...
//    }
    ...
    $str="SELECT kodeorg, intiplasma, substr(noakun,1,7) as noakun, ".$addstr." as rp, rupiah as rupiah FROM ".$dbname.".bgt_budget_kebun_perblok_vw
        WHERE ".$kode_org." and tahunbudget = '".$tahun."' and (noakun like '621%' or noakun like '611%' or noakun like '7%')";
    $query=mysql_query($str) or die(mysql_error($conn));
    while($res=mysql_fetch_assoc($query))
    {
...
//// jamhari
$str="select ".$addstr." as rp,substr(noakun,1,7) as noakun,rupiah as rupiah from ".$dbname.".bgt_budget_detail 
          where ".$kode_org." and tahunbudget='".$tahun."' and substr(noakun,1,1)='7'";
    $query=mysql_query($str) or die(mysql_error($conn));
    while($res=mysql_fetch_assoc($query))
    {
...
//echo "<br>kepala7:".$d7sdundeaktu[0];         
    ...
    if(!empty($akuntm))foreach($akuntm as $akun){
        ...
        if(strlen($akun)==7){
            ...
            <td align=right colspan=2>".$akun."</td>
