	...
	if($proses=='preview' or $proses=='excel'){
		...
		if($row>0){
				...
				if($res['namaunit']!=$namaunit){
					if($totalTonageday==0){
						...
						$tab[$no].="
									...
									<td width='5%' style='text-align:right;font-weight:bold;'>".($totaljanjangday==0 ? number_format(0,2) : number_format($totalgradA/$totaljanjangday*100,2))."</td>
									<td width='5%' style='text-align:right;font-weight:bold;'>".($totaljanjangday==0 ? number_format(0,2) : number_format($totalgradB/$totaljanjangday*100,2))."</td>
									<td width='5%' style='text-align:right;font-weight:bold;'>".($totaljanjangday==0 ? number_format(0,2) : number_format($totalgradC/$totaljanjangday*100,2))."</td>
									<td width='5%' style='text-align:right;font-weight:bold;'>".($totaljanjangday==0 ? number_format(0,2) : number_format($totalgradD/$totaljanjangday*100,2))."</td>
									<td width='5%' style='text-align:right;font-weight:bold;'>".($totaljanjangday==0 ? number_format(0,2) : number_format($totalgradE/$totaljanjangday*100,2))."</td>
									<td width='5%' style='text-align:right;font-weight:bold;'>".($totaljanjangday==0 ? number_format(0,2) : number_format((1-(($totalgradA+$totalgradB+$totalgradC+$totalgradD+$totalgradE)/$totaljanjangday))*100,2))."</td>
									<td width='5%' style='text-align:right;font-weight:bold;'>".($totaljanjangday==0 ? number_format(0,2) : number_format($totalgradG/$totaljanjangday*100,2))."</td>
									<td width='5%' style='text-align:right;font-weight:bold;'>".($totaljanjangday==0 ? number_format(0,2) : number_format($totalgradH/$totaljanjangday*100,2))."</td>
			...
			$tab[$no].="
						...
						<td width='5%' style='text-align:right;font-weight:bold;'>".($gtotaljanjangday==0 ? number_format(0,2) : number_format($gtotalgradA/$gtotaljanjangday*100,2))."</td>
						<td width='5%' style='text-align:right;font-weight:bold;'>".($gtotaljanjangday==0 ? number_format(0,2) : number_format($gtotalgradB/$gtotaljanjangday*100,2))."</td>
						<td width='5%' style='text-align:right;font-weight:bold;'>".($gtotaljanjangday==0 ? number_format(0,2) : number_format($gtotalgradC/$gtotaljanjangday*100,2))."</td>
						<td width='5%' style='text-align:right;font-weight:bold;'>".($gtotaljanjangday==0 ? number_format(0,2) : number_format($gtotalgradD/$gtotaljanjangday*100,2))."</td>
						<td width='5%' style='text-align:right;font-weight:bold;'>".($gtotaljanjangday==0 ? number_format(0,2) : number_format($gtotalgradE/$gtotaljanjangday*100,2))."</td>
						<td width='5%' style='text-align:right;font-weight:bold;'>".($gtotaljanjangday==0 ? number_format(0,2) : number_format((1-(($gtotalgradA+$gtotalgradB+$gtotalgradC+$gtotalgradD+$gtotalgradE)/$gtotaljanjangday))*100,2))."</td>
						<td width='5%' style='text-align:right;font-weight:bold;'>".($totaljanjangday==0 ? number_format(0,2) : number_format($gtotalgradG/$gtotaljanjangday*100,2))."</td>
						<td width='5%' style='text-align:right;font-weight:bold;'>".($gtotaljanjangday==0 ? number_format(0,2) : number_format($gtotalgradH/$gtotaljanjangday*100,2))."</td>
		...
		$sql="select kodeorg,tanggal,jammulai,jamselesai,jamdinasbruto from ".$dbname.".pabrik_pengolahan where kodeorg='".$idPabrik."' and tanggal between '".substr($tanggalawal,0,10)."' and '".$tanggal."' ORDER BY jammulai";
		$query=mysql_query($sql) or die(mysql_error());
		$jammulai=0;
		$jamolah=0;
		$jamolahsd=0;
		...
		$tab[$no].="
			...
			<td style='text-align:center;'>xx</td>
			<td style='text-align:right;'>".number_format($kernelkapasitasolah,2)."</td>
			<td style='text-align:right;'>".number_format($kernelkapasitasolahsd,2)."</td>";
