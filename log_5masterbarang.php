...
$str="select * from ".$dbname.".log_5subklbarang order by kode asc";
$res=mysql_query($str);
...
Nama Barang <input type=text id=txtcari class=myinputtext size=40 onkeypress=\"return tanpa_kutip(event);\" maxlength=30>
