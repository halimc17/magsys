...
{
	if($lha)
		$awasupah += $bar->jumlah / 30;
	else
		$awasupah += count($awasArr[$bar->karyawanid]) * $bar->jumlah / 30;
}
...
{
	if($lha)
		$admupah += $bar->jumlah / 30;
	else
		$admupah += count($admArr[$bar->karyawanid]) * $bar->jumlah / 30;
}
...
{
	if($lha)
		$umumupah += $bar->jumlah / 30;
	else
		$umumupah += $umumArr[$bar->karyawanid] * $bar->jumlah / 30;
}
