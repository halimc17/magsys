...
echo"<ol>
    <li>Pastikan semua SPAT sudah melakukan pengambilan kg pabrik</li>
    <li>Jika pada tanggal tidak ada angka / kosong, maka hari itu tidak ada pengiriman SPAT atau belum diinputkan SPAT-nya</li>
    <li>Jika pada tanggal muncul angka <b>0</b>, maka ada SPAT belum dilakukan proses ambil Kg timbangan</li>
    ";
echo"</ol></fieldset>";
