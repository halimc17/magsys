...
$isideskripsi2="     @ ".$simbolMataUang[$bar->matauang]." ".number_format($c,2)." ";
...
$pdf->Cell(15,$height,'',RL,0,'C');
$pdf->Cell(120,$height,'Sub Total','L',0,'R');
...
$pdf->Cell(15,$height,'',RL,0,'C'); 
$pdf->Cell(120,$height,$isiPpn,L,0,'R'); 
$pdf->Cell(5,$height,'',R,0,'R'); 
$pdf->Cell(40,$height,number_format($rpPpn),L,0,'R'); 
$pdf->Cell(10,$height,'',R,1,'R');

$pdf->Cell(15,$height,'',RL,0,'C'); 
$pdf->Cell(120,$height,$isiPph,L,0,'R'); 
$pdf->Cell(5,$height,'',R,0,'R'); 
