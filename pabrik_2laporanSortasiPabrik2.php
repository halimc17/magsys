...
<legend><b><?php echo $_SESSION['lang']['laporanSortasi']?> 2</b></legend>
...
<tr><td colspan="2"><button onclick="zPreview('pabrik_slave_2laporanSortasiPabrik2','<?php echo $arr?>','printContainer')" class="mybutton" name="preview" id="preview">Preview</button><!--<button onclick="zPdf('pabrik_slave_2laporanSortasiPabrik2','<?php echo $arr?>','printContainer')" class="mybutton" name="preview" id="preview">PDF</button>--><button onclick="zExcel(event,'pabrik_slave_2laporanSortasiPabrik2.php','<?php echo $arr?>')" class="mybutton" name="preview" id="preview">Excel</button></td></tr>
</table>
</fieldset>
</div>
