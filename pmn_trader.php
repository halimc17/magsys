...
//Pilih Franco
$i="select id_franco,penjualan,franco_name from ".$dbname.".pmn_5franco order by penjualan,franco_name";
$optFranco="";
$n=mysql_query($i) or die (mysql_error($conn));
while($d=mysql_fetch_assoc($n)){
	$optFranco.="<option value='".$d['id_franco']."'>[".strtoupper($d['penjualan']).'] - '.$d['franco_name']."</option>";
}

//Pilih UangMuka
	$optDP.="<option value='0'>0%</option>";
	$optDP.="<option value='5'>5%</option>";
	$optDP.="<option value='10'>10%</option>";
	$optDP.="<option value='15'>15%</option>";
	$optDP.="<option value='20'>20%</option>";
	$optDP.="<option value='25'>25%</option>";
	$optDP.="<option value='30'>30%</option>";
	$optDP.="<option value='35'>35%</option>";
	$optDP.="<option value='40'>40%</option>";
	$optDP.="<option value='45'>45%</option>";
	$optDP.="<option value='50'>50%</option>";
	$optDP.="<option value='55'>55%</option>";
	$optDP.="<option value='60'>60%</option>";
	$optDP.="<option value='65'>65%</option>";
	$optDP.="<option value='70'>70%</option>";
	$optDP.="<option value='75'>75%</option>";
	$optDP.="<option value='80'>80%</option>";
	$optDP.="<option value='85'>85%</option>";
	$optDP.="<option value='90'>90%</option>";
	$optDP.="<option value='95'>95%</option>";
	$optDP.="<option value='100'>100%</option>";

$arr="##kdUnit##kdCust##nokontrakext##tanggalext##kdBrg##jmlExt##hrgExt##nilaiExt##ppnExt##catatan##nokontrakpembanding##uangmuka##franco##ffa##dobi##mdani##moist##dirt##method";
...
echo"<fieldset style='width:450px;float:left;'>
	...
	<table>
		<tr>
			...
			<td><select id=uangmuka>".$optDP."</select></td>
		</tr>
		<tr>
			<td>".$_SESSION['lang']['franco']."</td>
			<td><select id=franco>".$optFranco."</select></td>
		</tr>
		<tr>
			<td>".$_SESSION['lang']['cpoffa']."</td>
			<td><input type=text class=myinputtextnumber id=ffa name=ffa value=0 style=\"width:100px;\" maxlength='18' /></td>
		</tr>
		<tr>
			<td>".$_SESSION['lang']['dobi']."</td>
			<td><input type=text class=myinputtextnumber id=dobi name=dobi value=0 style=\"width:100px;\" maxlength='18' /></td>
		</tr>
		<tr>
			<td>M & I</td>
			<td><input type=text class=myinputtextnumber id=mdani name=mdani value=0 style=\"width:100px;\" maxlength='18' /></td>
		</tr>
		<tr>
			<td>Moisture</td>
			<td><input type=text class=myinputtextnumber id=moist name=moist value=0 style=\"width:100px;\" maxlength='18' /></td>
		</tr>
		<tr>
			<td>Impurties</td>
			<td><input type=text class=myinputtextnumber id=dirt name=dirt value=0 style=\"width:100px;\" maxlength='18' /></td>
		</tr>
	</table>
	</fieldset>";
...
echo"<fieldset  style=width:1150px;><legend>".$_SESSION['lang']['list']."</legend>
...
echo"			<td align=center>".$_SESSION['lang']['nilai']."</td>
				<td align=center>".$_SESSION['lang']['ppn']."</td>
				<td align=center>".$_SESSION['lang']['total']."</td>";
echo"			<td align=center>DP (%)</td>";
echo"			<td align=center>Penyerahan</td>";
echo"			<td align=center>".$_SESSION['lang']['NoKontrak'].' '.$_SESSION['lang']['induk']."</td>
				<td align=center>".$_SESSION['lang']['kirim']."</td>";
//echo"			<td align=center>".$_SESSION['lang']['catatan']."</td>";
