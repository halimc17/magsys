...
while($rhkBlnini=mysql_fetch_assoc($qhkBlnIni)){
    ...
    if($rhkBlnini['kodekegiatan']!=''){
		...
		$listtipekary[$rhkBlnini['tipekaryawan']]=$rhkBlnini['tipekaryawan'];
...
while($rhkBlnLalu=mysql_fetch_assoc($qhkBlnLalu)){
    ...
    if($rhkBlnLalu['kodekegiatan']!=''){
		...
		$listtipekary[$rhkBlnLalu['tipekaryawan']]=$rhkBlnLalu['tipekaryawan'];
    }
}
...
$sHkPanenBlnIni="select kodeorg,tipekaryawan, count(karyawanid) as hasilkerja from ".$dbname.".kebun_prestasi_vw 
                where 1=1 ".$whrip." and tanggal like '%".$periode."%' group by kodeorg,tipekaryawan";
//echo $sHkPanenBlnIni;
...
while($rHkPanenBlnIni=mysql_fetch_assoc($qHkPanenBlnIni)){
	...
	$listtipekary[$rHkPanenBlnIni['tipekaryawan']]=$rHkPanenBlnIni['tipekaryawan'];
}
...
if($proses=='excel'){
	...
	$tab.="<td colspan=".(count($listtipekary)+4)." align=center ".$bg.">".$_SESSION['lang']['blnini']."</td>";
	$tab.="<td colspan=".(count($listtipekary)+4)." align=center ".$bg.">".$_SESSION['lang']['blnlalu']."</td>";
	$tab.="</tr>";

	$tab.="<tr class=rowheader>";
	$tab.="<td colspan=2 align=center ".$bg.">".$_SESSION['lang']['hasilkerjajumlah']."</td>";
	$tab.="<td colspan=".(count($listtipekary)+1)." align=center ".$bg.">".$_SESSION['lang']['jumlahhk']."</td>";
	...
	foreach($listtipekary as $tipekary){
		$tab.="<td align=center ".$bg.">".$tipekary."</td>";
	}
	...
	if($dtblokpertama!=0){
		foreach($arrKeg as $dtKeg){
			foreach($arrBlok as $dtBlok){
				...
				setIt($arrHk[$dtKeg.$dtBlok]['KBL'],0);
				setIt($arrHk[$dtKeg.$dtBlok]['KHT'],0);
				setIt($arrHk[$dtKeg.$dtBlok]['KHL'],0);
				setIt($arrHk[$dtKeg.$dtBlok]['Kontrak'],0);
				setIt($arrHk[$dtKeg.$dtBlok]['Kontrak Karywa (Usia Lanjut)'],0);
				
				setIt($arrHslKrjBlnLalu[$dtKeg][$dtBlok],0);
				setIt($arrHkLalu[$dtKeg.$dtBlok]['KBL'],0);
				setIt($arrHkLalu[$dtKeg.$dtBlok]['KHT'],0);
				setIt($arrHkLalu[$dtKeg.$dtBlok]['KHL'],0);
				setIt($arrHkLalu[$dtKeg.$dtBlok]['Kontrak'],0);
				setIt($arrHkLalu[$dtKeg.$dtBlok]['Kontrak Karywa (Usia Lanjut)'],0);
				 */
				if((@$arrDtBlnIni[$dtKeg][$dtBlok]!=0)) {
					...
					foreach($listtipekary as $tipekary){
						$tab.="<td align=right>".@number_format($arrHk[$dtKeg.$dtBlok][$tipekary],0)."</td>";
						@$totSub[$dtKeg][$dtBlok]+=$arrHk[$dtKeg.$dtBlok][$tipekary];
						@$sbKbl[$dtKeg][$tipekary]+=$arrHk[$dtKeg.$dtBlok][$tipekary];
					}
					...
					foreach($listtipekary as $tipekary){
						$tab.="<td align=right>".@number_format($arrHkLalu[$dtKeg.$dtBlok][$tipekary],0)."</td>";
						@$totSubLalu[$dtKeg][$dtBlok]+=$arrHkLalu[$dtKeg.$dtBlok][$tipekary];
						@$sbKblL[$dtKeg][$tipekary]+=$arrHkLalu[$dtKeg.$dtBlok][$tipekary];
					}
					...
					if($bars==$jmlh[$dtKeg]){
						...
						foreach($listtipekary as $tipekary){
							$tab.="<td align=right>".number_format($sbKbl[$dtKeg][$tipekary],0)."</td>";
						}
						...
						foreach($listtipekary as $tipekary){
							$tab.="<td align=right>".number_format($sbKblL[$dtKeg][$tipekary],0)."</td>";
						}
	...
	if($dtblokkedua!=0){
		foreach($lstKodeorg as $dtBlok2){
			...
			foreach($listtipekary as $tipekary){
				$tab.="<td align=right>".number_format($hkBln[$dtBlok2][$tipekary],0)."</td>";				
				@$totSubPanen[$dtBlok2]+=$hkBln[$dtBlok2][$tipekary];
			}
			...
			foreach($listtipekary as $tipekary){
				$tab.="<td align=right>".number_format($hkBlnLalu[$dtBlok2][$tipekary],0)."</td>";
				@$totSubPanenLalu[$dtBlok2]+=$hkBlnLalu[$dtBlok2][$tipekary];
			}
...
//            $pdf->Cell(70,$height,$pdf->PageNo(),0,1,'R');
		...
		$pdf->Cell(25, $height, $_SESSION['lang']['kontrak'], 'TBLR', 0, 'C',1);
			...
			foreach($arrKeg as $dtKeg){
				foreach($arrBlok as $dtBlok){
				   if(($arrDtBlnIni[$dtKeg][$dtBlok]!=0)||($arrHk[$dtKeg.$dtBlok]['KBL']!=0)||($arrHk[$dtKeg.$dtBlok]['KHT']!=0)||($arrHk[$dtKeg.$dtBlok]['KHL']!=0)||($arrHk[$dtKeg.$dtBlok]['Kontrak']!=0)){
						...
						$pdf->Cell(25, $height, number_format($arrHk[$dtKeg.$dtBlok]['KBL'],0), 'TBLR', 0, 'R',1);
						...
						$pdf->Cell(25, $height, number_format($arrHk[$dtKeg.$dtBlok]['Kontrak'],0), 'TBLR', 0, 'R',1);
						$pdf->Cell(25, $height, number_format($arrHk[$dtKeg.$dtBlok]['Kontrak Karywa (Usia Lanjut)'],0), 'TBLR', 0, 'R',1);
						...
						$pdf->Cell(25, $height, number_format($arrHkLalu[$dtKeg.$dtBlok]['KBL'],0), 'TBLR', 0, 'R',1);
						...
						$pdf->Cell(25, $height, number_format($arrHkLalu[$dtKeg.$dtBlok]['Kontrak'],0), 'TBLR', 0, 'R',1);
						$pdf->Cell(25, $height, number_format($arrHkLalu[$dtKeg.$dtBlok]['Kontrak Karywa (Usia Lanjut)'],0), 'TBLR', 0, 'R',1);
		...
		if($dtblokkedua!=0){
		   foreach($lstKodeorg as $dtBlok2){
				...
				$pdf->Cell(25, $height, number_format($hkBln[$dtBlok2]['KBL'],0), 'TBLR', 0, 'R',1);
				...
				$pdf->Cell(25, $height, number_format($hkBln[$dtBlok2]['Kontrak'],0), 'TBLR', 0, 'R',1);
				$pdf->Cell(25, $height, number_format($hkBln[$dtBlok2]['Kontrak Karywa (Usia Lanjut)'],0), 'TBLR', 0, 'R',1);
				...
				$pdf->Cell(25, $height, number_format($hkBlnLalu[$dtBlok2]['KBL'],0), 'TBLR', 0, 'R',1);
				...
				$pdf->Cell(25, $height, number_format($hkBlnLalu[$dtBlok2]['Kontrak'],0), 'TBLR', 0, 'R',1);
				$pdf->Cell(25, $height, number_format($hkBlnLalu[$dtBlok2]['Kontrak Karywa (Usia Lanjut)'],0), 'TBLR', 0, 'R',1);
