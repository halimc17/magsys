...
function getStasiun(){
    ...
    tujuan='pabrik_lapthickness_slave.php';
...
<div>
	<fieldset style="float: left;">
		<legend><b><?php echo $_SESSION['lang']['laporan']." Thickness ";?></b></legend>
		<table cellspacing="1" border="0" >
			...
			<tr><td colspan="2">
				<button onclick="zPreview('pabrik_lapthickness_slave','<?php echo $arr;?>','printContainer')" class="mybutton" name="preview" id="preview">Preview</button>
				<button onclick="zExcel(event,'pabrik_lapthickness_slave.php','<?php echo $arr;?>')" class="mybutton" name="preview" id="preview">Excel</button>
