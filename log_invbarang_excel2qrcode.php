...
"."app.medcoagro.co.id/invbarang/?kode=".$barz->kodebarang."_".$barz->kodeinventaris;
		...
		$ptbrg="http://app.medcoagro.co.id/magsys/".$tempdir.$namafile;
		//$ptbrg=$tempdir.$namafile;
		$quality="H"; // ini ada 4 pilihan yaitu L (Low), M(Medium), Q(Good), H(High)
		$ukuran=1; // 1 adalah yang terkecil, 10 paling besar
		$padding=1;
		QRCode::png($qrbrg, $tempdir.$namafile, $quality, $ukuran, $padding);
		# ===== Baris 1 ====================
		$stream2.="<tr>";
		...
		$stream2.="<td align=center style='border:none;width:9px;height:9px;'><img src='$ptbrg' width='40' height='40'></td>";
