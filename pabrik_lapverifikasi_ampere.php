...
function getStasiun(){
    ...
    tujuan='pabrik_lapverifikasi_ampere_slave.php';
...
function showpopup(kodemesin,tanggal,kdorg,stasiun,type,ev){
   ...
   showDialog1('Laporan Verifikasi Ampere '+kdorg+' '+stasiun+' '+kodemesin+' '+tanggal,content,width,height,ev); 
}
...
<div>
	<fieldset style="float: left;">
		<legend><b><?php echo $_SESSION['lang']['laporan']." Verifikasi Ampere ";?></b></legend>
		<table cellspacing="1" border="0" >
			...
			<tr><td colspan="2">
				<button onclick="zPreview('pabrik_lapverifikasi_ampere_slave','<?php echo $arr;?>','printContainer')" class="mybutton" name="preview" id="preview">Preview</button>
				<button onclick="zExcel(event,'pabrik_lapverifikasi_ampere_slave.php','<?php echo $arr;?>')" class="mybutton" name="preview" id="preview">Excel</button>
