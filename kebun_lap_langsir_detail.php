<?php
	...
	$where="";
	$where2="";
	if($kodeunit!=$_SESSION['empl']['lokasitugas']){
	...
	$str="select a.kodeblok,a.tanggal,a.hasilkerjarealisasi,c.namaorganisasi as namablok,d.intiplasma,d.tahuntanam,a.statusjurnal
			...
			where a.kodekegiatan='611020201' ".$where." 
	...
	#ambil data SPATBS
	$str="select a.blok as kodeblok,b.tanggal,a.kgwb,c.namaorganisasi as namablok,d.intiplasma,d.tahuntanam,b.posting
	...
	switch($proses){
        ...
        break;
        case 'excel':
			$judul=$_SESSION['lang']['laporan'].' Langsir vs Kirim';
            if(strlen($stream)>0){
