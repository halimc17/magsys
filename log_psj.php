...
<script language=javascript1.2 src='js/log_psj.js'></script>
...
OPEN_BOX('',"<b>Penerimaan Surat Jalan</b>"); //1 O
echo"<table>
     <tr valign=moiddle>
	 <td align=center style='width:100px;cursor:pointer;' onclick=loadData()>
	   <img class=delliconBig src=images/orgicon.png title='".$_SESSION['lang']['list']."'><br>".$_SESSION['lang']['list']."</td>
	 <td><fieldset><legend>".$_SESSION['lang']['find']."</legend>"; 
			echo " ".$_SESSION['lang']['suratjalan']." :<input type=text id=txt size=25 maxlength=30 class=myinputtext>";
