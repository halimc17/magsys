...
echo"</tr>";
echo"<tr><td>".$_SESSION['lang']['unit']."</td>
...
<div id='printContainer8' style='overflow:auto;height:250px;max-width:1220px;display:none;'>
</div>

<div id='printContainer9' style='overflow:auto;height:250px;max-width:1220px;display:none;'>
</div>
</fieldset>";
