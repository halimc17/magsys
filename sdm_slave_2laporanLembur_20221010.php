...
// ambil data lembur ================================================================================
if($pilihan=='rupiah'){
	$sPeople="SELECT a.subbagian,b.karyawanid as karyawanid, b.tanggal as tanggal, (b.uangkelebihanjam + b.uanglembur2) as uangkelebihanjam, b.tipelembur, a.namakaryawan, a.bagian, a.kodejabatan
	...
	$sPeople="SELECT a.subbagian,b.karyawanid as karyawanid, b.tanggal as tanggal,		   (b.jamaktual + b.jamaktual2) as uangkelebihanjam, b.tipelembur, a.namakaryawan, a.bagian, a.kodejabatan
                          FROM ".$dbname.".sdm_lemburdt b 
                          LEFT JOIN ".$dbname.".datakaryawan a on a.karyawanid = b.karyawanid
