...
if($tanggal==''){
	...
	if($proses=='preview' or $proses=='excel'){
		if($proses=='excel'){
			...
			$tab[0]="<table class=sortable cellspacing=1 border=0 style='width:1250px;'>";
		}
		$tab[0].="
				<thead>
					<tr class=rowheader>
		...
		$sql="select if(substr(a.nospb,9,6)='' or substr(a.nospb,9,6)='0','zzzzzz',substr(a.nospb,9,6)) as unit
				...
				,if(substr(a.nospb,9,6)<>'' and substr(a.nospb,9,6)<>'0',substr(a.nospb,9,6),c.namasupplier) as supplier,sum(a.beratbersih) as tonageall,b.tonageday,sum(a.jumlahtandan1) as janjangall
		...
		if($row>0){
				...
				if($res['namaunit']!=$namaunit){
					if($totalTonageday==0){
						...
						$tab[$no].="
									...
									<td width='5%' style='text-align:right;font-weight:bold;'>".($totalgradA==0 ? number_format(0) : number_format($totalTonageday/$totalgradA))."</td>
									<td width='5%' style='text-align:right;font-weight:bold;'>".($totalgradB==0 ? number_format(0) : number_format($totalTonageday/$totalgradB))."</td>
									<td width='5%' style='text-align:right;font-weight:bold;'>".($totalgradC==0 ? number_format(0) : number_format($totalTonageday/$totalgradC))."</td>
									<td width='5%' style='text-align:right;font-weight:bold;'>".($totalgradD==0 ? number_format(0) : number_format($totalTonageday/$totalgradD))."</td>
									<td width='5%' style='text-align:right;font-weight:bold;'>".($totalgradE==0 ? number_format(0) : number_format($totalTonageday/$totalgradE))."</td>
									<td width='5%' style='text-align:right;font-weight:bold;'>".($totalgradF==0 ? number_format(0) : number_format($totalTonageday/$totalgradF))."</td>
									<td width='5%' style='text-align:right;font-weight:bold;'>".($totalgradG==0 ? number_format(0) : number_format($totalTonageday/$totalgradG))."</td>
									<td width='5%' style='text-align:right;font-weight:bold;'>".($totalgradH==0 ? number_format(0) : number_format($totalTonageday/$totalgradH))."</td>
			...
			$tab[$no].="
						...
						<td style='text-align:right;font-weight:bold;'>".($totalgradA==0 ? number_format(0) : number_format($totalTonageday/$totalgradA))."</td>
						<td style='text-align:right;font-weight:bold;'>".($totalgradB==0 ? number_format(0) : number_format($totalTonageday/$totalgradB))."</td>
						<td style='text-align:right;font-weight:bold;'>".($totalgradC==0 ? number_format(0) : number_format($totalTonageday/$totalgradC))."</td>
						<td style='text-align:right;font-weight:bold;'>".($totalgradD==0 ? number_format(0) : number_format($totalTonageday/$totalgradD))."</td>
						<td style='text-align:right;font-weight:bold;'>".($totalgradE==0 ? number_format(0) : number_format($totalTonageday/$totalgradE))."</td>
						<td style='text-align:right;font-weight:bold;'>".($totalgradF==0 ? number_format(0) : number_format($totalTonageday/$totalgradF))."</td>
						<td style='text-align:right;font-weight:bold;'>".($totalgradG==0 ? number_format(0) : number_format($totalTonageday/$totalgradG))."</td>
						<td style='text-align:right;font-weight:bold;'>".($totalgradH==0 ? number_format(0) : number_format($totalTonageday/$totalgradH))."</td>
						<td style='text-align:right;font-weight:bold;'>".number_format($totalTonageday)."</td>
						<td style='text-align:right;font-weight:bold;'>".number_format($totalTonageall)."</td>";
			$no+=1;
			$tab[$no].="
						<td colspan=2 style='font-weight:bold;'>Total TBS Diterima</td>
						<td style='text-align:right;font-weight:bold;'>".($gtotalgradA==0 ? number_format(0) : number_format($gtotalTonageday/$gtotalgradA))."</td>
						<td style='text-align:right;font-weight:bold;'>".($gtotalgradB==0 ? number_format(0) : number_format($gtotalTonageday/$gtotalgradB))."</td>
						<td style='text-align:right;font-weight:bold;'>".($gtotalgradC==0 ? number_format(0) : number_format($gtotalTonageday/$gtotalgradC))."</td>
						<td style='text-align:right;font-weight:bold;'>".($gtotalgradD==0 ? number_format(0) : number_format($gtotalTonageday/$gtotalgradD))."</td>
						<td style='text-align:right;font-weight:bold;'>".($gtotalgradE==0 ? number_format(0) : number_format($gtotalTonageday/$gtotalgradE))."</td>
						<td style='text-align:right;font-weight:bold;'>".($gtotalgradF==0 ? number_format(0) : number_format($gtotalTonageday/$gtotalgradF))."</td>
						<td style='text-align:right;font-weight:bold;'>".($gtotalgradG==0 ? number_format(0) : number_format($gtotalTonageday/$gtotalgradG))."</td>
						<td style='text-align:right;font-weight:bold;'>".($gtotalgradH==0 ? number_format(0) : number_format($gtotalTonageday/$gtotalgradH))."</td>
		...
		$sqlspp="select a.nokontrak,a.nosipb as nospp,b.tanggaldo as tglspp,b.qty,a.netto,a.nettohi,d.namacustomer from
					(select z.nokontrak,z.nosipb,sum(z.beratbersih) as netto,sum(case when z.tanggal between '".$tanggalmulai."' and '".$tanggalakhir."' then z.beratbersih else 0 end) as nettohi
					from ".$dbname.".pabrik_timbangan z
					where z.nokontrak<>'' and z.nokontrak<>'NULL' 
					and millcode in (select kodeorganisasi from ".$dbname.".organisasi where induk='".$indukPabrik."')
					GROUP BY z.nosipb,z.nokontrak) a
				...
				where b.qty<>'' and a.netto<b.qty 
				and b.tanggaldo like '".substr($tanggalakhir,0,4)."%'
				ORDER BY b.tanggaldo";
		//exit('Warning: '.$sqlspp);
		...
		while($resspp=mysql_fetch_assoc($qryspp)){
			...
			$tab[$no].="
				...
				<td colspan=2>".$resspp['namacustomer']."</td>
		...
		$sqltbs="select tanggal,sum(kuantitas) as mkslalu,sum(kernelquantity) as ikslalu from ".$dbname.".pabrik_masukkeluartangki
				where kodeorg='".$idPabrik."' and tanggal='".$tanggalkemarin."'";
		//exit('Warning: '.$sqltbs);
		$qrytbs=mysql_query($sqltbs) or die(mysql_error());
		while($restbs=mysql_fetch_assoc($qrytbs)){
		...
		$sqliks="select a.*,b.keterangan as namatangki from ".$dbname.".pabrik_masukkeluartangki a
				...
				where a.tanggal = '".substr($tanggalmulai,0,10)."'
		...
		$tab2[$no2].="
			...
			if($cpoffa[2]==0){
				$tab2[$no2].="<td colspan=2 style='text-align:right;'>".number_format($cpoffa[1],2)."</td>";
			}else{
				$tab2[$no2].="<td colspan=2 style='text-align:right;'>".number_format(($cpoffa[1]+$cpoffa[2])/2,2)."</td>";
			}
		$no2+=1;
		$tab2[$no2].="
			...
			if($cpoffa[2]==0){
				$tab2[$no2].="<td colspan=2 style='text-align:right;'>".number_format($cpokdair[1],2)."</td>";
			}else{
				$tab2[$no2].="<td colspan=2 style='text-align:right;'>".number_format(($cpokdair[1]+$cpokdair[2])/2,2)."</td>";
			}
		$no2+=1;
		$tab2[$no2].="
			<td colspan=1 style='text-align:center;'>43</td>
			<td colspan=5>Kadar Kotoran [ % ]</td>
			<td colspan=2 style='text-align:right;'>".number_format($cpokdkot[1],2)."</td>
			<td colspan=2 style='text-align:right;'>".number_format($cpokdkot[2],2)."</td>";
			if($cpoffa[2]==0){
				$tab2[$no2].="<td colspan=2 style='text-align:right;'>".number_format($cpokdkot[1],2)."</td>";
			}else{
				$tab2[$no2].="<td colspan=2 style='text-align:right;'>".number_format(($cpokdkot[1]+$cpokdkot[2])/2,2)."</td>";
			}
		$no2+=1;
		$tab2[$no2].="
			...
			if($cpoffa[2]==0){
				$tab2[$no2].="<td colspan=2 style='text-align:right;'>".number_format($dobi[1],2)."</td>";
			}else{
				$tab2[$no2].="<td colspan=2 style='text-align:right;'>".number_format(($dobi[1]+$dobi[2])/2,2)."</td>";
			}
		$no2+=1;
		$tab2[$no2].="
			...
			if($cpoffa[2]==0){
				$tab2[$no2].="<td colspan=2 style='text-align:right;'>".number_format($kuantitas[1],2)."</td>";
			}else{
				$tab2[$no2].="<td colspan=2 style='text-align:right;'>".number_format(($kuantitas[1]+$kuantitas[2]),2)."</td>";
			}
		$no2+=1;
		$tab2[$no2].="
		...
		$sqlkirim="select a.*,if(b.koderekanan='' or ISNULL(b.koderekanan),substr(a.nosipb,9,3),b.koderekanan) as koderekanan from ".$dbname.".pabrik_timbangan a
		...
		$tab2[$no2].="
			...
			<td colspan=2 style='text-align:right;'>".count($jmlrekanan['40000001'])."</td>
			<td colspan=2 style='text-align:right;'>".count($jmlrekanan['40000005'])."</td>
			<td colspan=2 style='text-align:right;'>".count($jmlrekanan['40000002'])."</td>";
		$no2+=1;
		$tab2[$no2].="
		...
		$no2+=1;
		$tab2[$no2].="
			<td colspan=12 style='text-align:center;font-weight:bold;'>O. STOCK PENAMPUNGAN CPO</td>";
		$no2+=1;
		$tab2[$no2].="
			<td colspan=8 style='text-align:center;'>Uraian</td>
			<td colspan=2 style='text-align:center;'>Hari Ini</td>
		...
		for($z = 1; $z <= $mikobagi; $z++) {
			$no2+=1;
			$tab2[$no2].="
				<td colspan=1 style='text-align:center;'>".(70+$z)."</td>
