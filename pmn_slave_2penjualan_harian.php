...
$sql="select tanggal,notransaksi,nokontrak,beratbersih,nokendaraan,supir,kodebarang from ".$dbname.".pabrik_timbangan where millcode = '".$kodeorg1."' and kodebarang like '%".$kodebarang1."%' and tanggal between '".$tgl1_1." 00:00:00' and '".$tgl2_1." 23:59:59' order by tanggal asc";
