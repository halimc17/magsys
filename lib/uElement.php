...
class uElement {
    ...
    #== Constructor
    function uElement($cId,$cName,$cCont=null,$cType=null,$cAlign=null,$cLength=null,
					  $cRefer=null,$cCont2=null,$cTSatuan=null,$cTHarga=null,$idGudang=null,
					  $tSaldo=null) {
...
//	echo"warning";
    ...
    #== Generator
    function genEls() {
	return makeElement($this->_id,$this->_type,$this->_content,$this->_attr,
					   $this->_refer,$this->_content2,$this->_targetSatuan,
					   $this->_targetHarga,$this->_idGudang,$this->_tSaldo);
    }
}
?>