...
if($lapke==3){
	$stream.="<td rowspan=2 align=center>".$_SESSION['lang']['tahun']."</td>";
}else if($lapke==2){
	$stream.="<td rowspan=2 align=center>".$_SESSION['lang']['bulan']."</td>";
}else{
	$stream.="<td rowspan=2 align=center>".$_SESSION['lang']['tanggal']."</td>";
}
if($lapke==0){
	$stream.="<td rowspan=2 align=center>".$_SESSION['lang']['waktu']."</td>";
}
...
$iList="SELECT a.kodeorg,a.tanggal
	...
	FROM (".$sdata.") a where kodeorg='".$kodeorg."' and tanggal between '".$tgl1."' and '".$tgl2."'";
...
while($dList=mysql_fetch_assoc($nList)){
	...
	$stream.="	<td align='right'>".$dList['temp_out']."</td>
				<td align='right'>".$dList['in_temp']."</td>
				<td align='right'>".$dList['low_temp']."</td>
				<td align='right'>".$dList['out_hum']."</td>
				<td align='right'>".$dList['dew_pt']."</td>
				<td align='right'>".$dList['wind_speed']."</td>
				<td align='left'>".$dList['wind_dir']."</td>
				<td align='right'>".$dList['wind_run']."</td>
				<td align='right'>".$dList['hi_speed']."</td>
				<td align='left'>".$dList['hi_dir']."</td>
				<td align='right'>".$dList['wind_chill']."</td>
				<td align='right'>".$dList['heat_index']."</td>
				<td align='right'>".$dList['thw_index']."</td>
				<td align='right'>".$dList['thsw_index']."</td>
				<td align='right'>".$dList['bar']."</td>
				<td align='right'>".$dList['rain']."</td>
				<td align='right'>".$dList['rain_rate']."</td>
				<td align='right'>".$dList['solar_rad']."</td>
				<td align='right'>".$dList['solar_energy']."</td>
				<td align='right'>".$dList['hi_solar_rad']."</td>
				<td align='right'>".$dList['uv_index']."</td>
				<td align='right'>".$dList['uv_dose']."</td>
				<td align='right'>".$dList['hi_uv']."</td>
				<td align='right'>".$dList['heat_dd']."</td>
				<td align='right'>".$dList['cool_dd']."</td>
				<td align='right'>".$dList['in_temp']."</td>
				<td align='right'>".$dList['in_hum']."</td>
				<td align='right'>".$dList['in_dew']."</td>
				<td align='right'>".$dList['in_heat']."</td>
				<td align='right'>".$dList['in_emc']."</td>
				<td align='right'>".$dList['in_air_density']."</td>
				<td align='right'>".$dList['et']."</td>
				<td align='right'>".$dList['wind_samp']."</td>
				<td align='right'>".$dList['wind_tx']."</td>
				<td align='right'>".$dList['iss_recept']."</td>
				<td align='right'>".$dList['arc_int']."</td>
			</tr>";
}
if($lapke>0){
	$stream.="<tr class=rowcontent><td colspan=2 align='center'>Total Satuan</td>";
	for($x=1;$x<=36;$x++){
		$stream.="<td align='right'>".$ttaws[$x]."</td>";
	}
	$stream.="</tr>";
	$stream.="<tr class=rowcontent><td colspan=2 align='center'>Total Hari</td>";
	for($x=1;$x<=36;$x++){
		$stream.="<td align='right'>".$hhaws[$x]."</td>";
	}
	$stream.="</tr>";
	$stream.="<tr class=rowcontent><td colspan=2 align='center'>Rata-rata</td>";
	for($x=1;$x<=36;$x++){
