<?php
/**
 * Simple PABRIK Menu File Existence Test
 */
...
echo "PABRIK MODULE TEST REPORT\n";
echo "=========================\n\n";
...
echo "SUMMARY\n";
echo "=======\n";
echo "Total menu items tested: " . $totalTested . "\n";
echo "Total successful: " . $totalSuccess . "\n";
echo "Total failed: " . $totalFailed . "\n";
echo "Success rate: " . round(($totalSuccess / $totalTested) * 100, 2) . "%\n";

if (count($failedItems) > 0) {
    echo "\n\nFAILED ITEMS DETAILS\n";
    echo "====================\n";
    foreach ($failedItems as $failed) {
        echo sprintf("\n- [%s] %s (ID: %d)\n", $failed['category'], $failed['name'], $failed['id']);
        echo "  URL: " . $failed['url'] . "\n";
