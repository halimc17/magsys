...
$els[] = array(
  makeElement('periode2','label',$_SESSION['lang']['periode']),
  makeElement('periode2','select','',array('style'=>'width:200px'),$optPeriod)
);
$els[] = array(
  makeElement('periode','label',""),
  makeElement('periode','hidden','',array('style'=>'width:200px'),$optPeriod)
);

# Button
$els['btn'] = array(
  makeElement('btnList','button',$_SESSION['lang']['tutupbuku'],
    array('onclick'=>'tutupBuku2()'))
);
