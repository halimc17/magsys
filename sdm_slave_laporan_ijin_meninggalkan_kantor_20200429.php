        ...
        switch($proses)
        {
			case'getKary':
				if($_SESSION['empl']['tipelokasitugas'] == 'HOLDING' and ($_SESSION['empl']['bagian'] == 'HHRD' || $_SESSION['empl']['bagian'] == 'HHRS')){
					...
					$sKary="select distinct karyawanid,namakaryawan from ".$dbname.".datakaryawan where tipekaryawan in(0,1,2,6,7,8,9) and lokasitugas='$unit' order by namakaryawan asc";
