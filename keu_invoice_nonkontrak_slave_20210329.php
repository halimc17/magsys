...
switch($param['proses']){
	case'insert':
		...
		if($param['noinvoice']!=''){
			$sinser="update ".$dbname.".keu_penagihanht set kodeorg='".$param['kodeorganisasi']."',kodept='".$optKdpt[$param['kodeorganisasi']]."',bayarke='".$param['bayarke']."'
						...
						,debet='".$param['debet']."',kredit='".$param['kredit']."' where noinvoice='".$param['noinvoice']."'";
			//exit('Warning: '.$sinser);
			...
			,matauang,kurs,ttd,jenis,debet,kredit,rupiah1,rupiah2,rupiah3,rupiah4,rupiah5,rupiah6,rupiah7,rupiah8,tipeinvoice,nokontrak) values ('".generateNoInvoice($optKdpt[$param['kodeorganisasi']],$param['tanggal'])."','".$param['kodeorganisasi']."','".$optKdpt[$param['kodeorganisasi']]."','".$param['bayarke']."','".tanggalsystem($param['tanggal'])."','".tanggalsystem($param['jatuhtempo'])."','".$param['kodebarang']."','".$param['kuantitas']."','".$param['nofakturpajak']."','".$param['kodecustomer']."','".$param['nilaiinvoice']."','".$param['stsppn']."','".$param['nilaippn']."','".$param['stspph']."','".$param['nilaipph']."','".$param['matauang']."','".$param['kurs']."','".$param['ttd']."','".$param['jenis']."','".$param['debet']."','".$param['kredit']."','0','0','0','0','0','0','0','0','1','')";
			//exit('Warning: '.$sinser);
			if(!mysql_query($sinser)){
	...
	case'loadData':
	   // print_r($param);
        ...
        $offset=$page*$limit;
        $sql="select count(*) jmlhrow from ".$dbname.".keu_penagihanht where nokontrak!='' and tipeinvoice='1' ".$where." order by tanggal desc";
    ...
    case'postingData':
		...
		$dataD[] = array(
			...
			'keterangan' => 'PIUTANG '.$optnmcust[$rdata['kodecustomer']].
				...
				' sebanyak '.$rdata['kuantitas'].' '.$optsatbrg[$rdata['kodebarang']].' '.$optnmbrg[$rdata['kodebarang']],
