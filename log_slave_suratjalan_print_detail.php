...
switch($proses) {
    case 'pdf':
		...
		$pdf->Cell(50/100*$width,$height,$franco['namaorganisasi'],0,0,'L');
		...
		$pdf->Cell(10/100*$width,$height,'',0,0,'L');
		$pdf->Cell(50/100*$width,$height,'Phone : '.$franco['telepon'],0,0,'L');
		...
		$pdf->Cell(25/100*$width,$height,$dataH['penerima'],0,0,'C');
                ...
                $pdf->Ln($height*2);
                $pdf->Cell($width,$height,'AGAR DIPERHATIKAN ASPEK - ASPEK K3 (KESELAMATAN KESEHATAN KERJA) DALAM PENANGANAN BARANG',0,0,'L');
