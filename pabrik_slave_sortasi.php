...
if($_SESSION['language']=='EN'){
    ...
    $zz='keterangan';
        ...
        //echo "warning:".$sTim;exit();
                ...
                echo"<td>".$_SESSION['lang']['sortasi']."(JJG)</td><td>% ".$_SESSION['lang']['brondolan']."</td><td> ".$_SESSION['lang']['potongankg']."</td>
                <td>Action</td>
                </tr>
                </thead>
                <tbody>";
...
//                    echo"</pre><br />";
        ...
        //echo "warning:".$sTim;exit();
               ...
               // $brs=count($rHead);
                ...
                $table .= "<td>% ".$_SESSION['lang']['brondolan']."</td><td>".$_SESSION['lang']['potongankg']."</td><td>Action</td></tr>";
