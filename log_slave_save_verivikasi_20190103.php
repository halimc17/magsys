...
switch ($method)
{
 ...
 case'balikin':
    ...
    $iData="select * from ".$dbname.".log_prapoht where nopp='".$nopp."' ";
    $nData=  mysql_query($iData) or die (mysql_error($conn));
    $dData=  mysql_fetch_assoc($nData);
        $pTiga=$dData['persetujuan3'];
    ...
    $iPur="update ".$dbname.".log_prapodt set purchaser='0000000000' "
            . " where nopp='".$nopp."' and kodebarang='".$_POST['kdbrgbalik']."' ";
    if(mysql_query($iPur))//'".$_SESSION['standard']['userid']."'
    {}
    else
    {
    ...
    $iUpdate="update ".$dbname.".log_prapoht set close=1,persetujuan4=NULL,persetujuan5=NULL,hasilpersetujuan3=0,"
            . "komentar3=NULL,hasilpersetujuan4=0,komentar4=NULL,hasilpersetujuan5=0,komentar5=NULL,"
            . "tglp3=NULL,tglp4=NULL,tglp5=NULL where nopp='".$nopp."' ";
    if(mysql_query($iUpdate))//'".$_SESSION['standard']['userid']."'
    {
        ...
        $body="<html>
                 ...
                 <body>
                   ...
                   <br>
                        Sehubungan dengan tidak adanya barang dinopp : ".$nopp." untuk :
    ...
    {   $row=mysql_num_rows($res);
        ...
        { 
            ...
            {			
              ...
              <td id=kd_brg_".$no.">".$bar->kodebarang."</td>
                              ...
                              //<img src=images/application/application_go.png class=resicon title='Submission-re verify' onclick=\"balikin('".$bar->nopp."','".$bar->kodebarang."','".$bas2->namabarang."')\" /></td>
                              echo"
                              <button class=mybutton $disab  id=balikinbutton_".$no." onclick=\"balikin('".$bar->nopp."','".$bar->kodebarang."','".$rDtBrg[$bar->kodebarang]."')\">Return</button>
                              ...
                              //<img src=images/application/application_go.png class=resicon title='Submission-re verify' onclick=\"ajukanForm('".$bar->nopp."')\" />
                              else
                              {
                              ...
                              //Satuan dari table master barang
                                ...
                                $qrySat2=mysql_query($strSat2) or die(mysql_error());
                                while($resSat2=mysql_fetch_object($qrySat2))
                                {
                                      if(($bar->satuanpp)!=''){
                              ...
                              <td align=center><select id=satuan_".$no." id=satuan_".$no." ".$read_only2." onchange='getSatuanKonversi(this.value,".$bar->kodebarang.",".$no.")'>$optSat</select></td>
                                <td><select id=purchase_name_".$no." id=purchase_name_".$no." ".$read_only2." onchange='getlokalpusat(this.value,".$no.")'>$optPur</select></td>";
                             if($stat==1)
                              {
                                  if($_SESSION['empl']['kodejabatan']=='5') 
                                  {
       ...
       <button class=mybutton onclick=cariBast(".($page-1).");>".$_SESSION['lang']['pref']."</button>
        ...
        $sql="select count(*) as jmlhrow FROM ".$dbname.".log_prapodt b LEFT JOIN ".$dbname.".log_prapoht a ON a.nopp = b.nopp 
               WHERE a.close = '2' and b.status='0' and b.create_po='0' and substr(tanggal,1,4)='".$thnSkrng."'ORDER BY purchaser asc,a.tglp5,a.tglp4,a.tglp3,a.tglp2,a.tglp1 desc";
        //echo $sql;
        $query=mysql_query($sql) or die(mysql_error());
        ...
        $str="SELECT  a.`tanggal`, b.keteranganubah, a.`persetujuan1`, a.`persetujuan2`, a.`persetujuan3`, a.`persetujuan4`, a.`persetujuan5`, a.`close`, a.`hasilpersetujuan1`, a.`hasilpersetujuan2`, a.`hasilpersetujuan3`, a.`hasilpersetujuan4`, a.`hasilpersetujuan5`, a.`tglp1`, a.`tglp2`, a.`tglp3`, a.`tglp4`, a.`tglp5`,b.*  
              FROM ".$dbname.".log_prapodt b  LEFT JOIN  ".$dbname.".log_prapoht a ON a.nopp = b.nopp 
              WHERE a.close = '2' and b.status='0' and b.create_po='0' and substr(tanggal,1,4)='".$thnSkrng."'  ORDER BY purchaser asc,a.tglp5,a.tglp4,a.tglp3,a.tglp2,a.tglp1 desc limit ".$offset.",".$limit."";
        if(mysql_query($str))
        {
            $res=mysql_query($str);
            ...
            while($bar=mysql_fetch_object($res))
            {
                    ...
                    echo"<tr class=rowcontent id='tr_".$no."' title='".$_SESSION['lang']['tgldibutuhkan'].":".tanggalnormal($bar->tgl_sdt)."' ".$trStyle.">
                              ...
                              <img src=images/application/application_add.png class=resicon title='Additional material' onclick=\"getDataPP5('".$bar->nopp."')\" />&nbsp;";
                               ...
                               //<img src=images/application/application_go.png $dis class=resicon title='Submission - re Verify' onclick=\"balikin('".$bar->nopp."','".$bar->kodebarang."','".$rDtBrg[$bar->kodebarang]."')\" />    
                              echo"
                              <button class=mybutton $disab   id=balikinbutton_".$no." onclick=\"balikin('".$bar->nopp."','".$bar->kodebarang."','".$rDtBrg[$bar->kodebarang]."')\">Return</button>
                              </td>";
 ...
 $jam=date("Hms");
  ...
  $gztralala = gzopen("tempExcel/".$nop_.".xls.gz", "w9");
		...
		case 'getValueKonversi':
			...
			if($numrows>0){
				$hasilAkhir = $jmlh_realisai * $res['jumlah'];
				echo $hasilAkhir;
			}else{
				echo $hjmlh_realisai;
			}
		break;
         ...
         <tr class=rowcontent><td colspan=2>".$_SESSION['lang']['purchaser']."</td><td><select id=purId2 name=purId2 style=width:150px; onchange='getlokId(this.value,".$nourut.")'>".$optPur."</select></td></tr>
