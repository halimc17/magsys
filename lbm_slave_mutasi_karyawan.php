...
##### Staff #####
//staff ... awal tahun
$sStaff="select distinct count(karyawanid) as jumKary from ".$dbname.".datakaryawan where (tanggalkeluar = '0000-00-00' or tanggalkeluar > '".date("Y-m-d")."') and tipekaryawan in ('0','7','8') and ".$addTmb." ".$whereAwal."";
$qStaff=mysql_query($sStaff) or die(mysql_error());
$rStaff=  mysql_fetch_assoc($qStaff);
$jumKaryStaff[$kdUnit]=$rStaff['jumKary'];

//staff ... bulan lalu 
$sStaffBln="select distinct count(karyawanid) as jumKary from ".$dbname.".datakaryawan where (tanggalkeluar = '0000-00-00' or tanggalkeluar > '".date("Y-m-d")."') and tipekaryawan in ('0','7','8') and ".$addTmb." ".$whereBlnKmrn."";
//echo $sStaffBln;
...
$sStaffBln="select distinct count(karyawanid) as jumKary from ".$dbname.".datakaryawan where (tanggalkeluar = '0000-00-00' or tanggalkeluar > '".date("Y-m-d")."') and tipekaryawan in ('0','7','8') and ".$addTmb." ".$whereBlnIniPnmbah."";
//echo $sStaffBln;
$qStaffBln=mysql_query($sStaffBln) or die(mysql_error());
$rStaffBln=  mysql_fetch_assoc($qStaffBln);
$jumKaryBlnIni[$kdUnit]=$rStaffBln['jumKary'];

$sStaffBln="select distinct count(karyawanid) as jumKary from ".$dbname.".datakaryawan where (tanggalkeluar = '0000-00-00' or tanggalkeluar > '".date("Y-m-d")."') and tipekaryawan in ('0','7','8') and ".$addTmb." ".$whereBlnIniPnmbahSi."";
//echo $sStaffBln;
$qStaffBln=mysql_query($sStaffBln) or die(mysql_error());
$rStaffBln=  mysql_fetch_assoc($qStaffBln);
...
$sStaffBln="select distinct count(karyawanid) as jumKary from ".$dbname.".datakaryawan where (tanggalkeluar = '0000-00-00' or tanggalkeluar > '".date("Y-m-d")."') and tipekaryawan in ('0','7','8') and ".$addTmb." ".$whereBlnIniPeng."";
//echo $sStaffBln;
$qStaffBln=mysql_query($sStaffBln) or die(mysql_error());
$rStaffBln=  mysql_fetch_assoc($qStaffBln);
$jumKaryPengBlnini[$kdUnit]=$rStaffBln['jumKary'];

$sStaffBln="select distinct count(karyawanid) as jumKary from ".$dbname.".datakaryawan where (tanggalkeluar = '0000-00-00' or tanggalkeluar > '".date("Y-m-d")."') and tipekaryawan in ('0','7','8') and ".$addTmb." ".$whereBlnIniPengSi."";
//echo $sStaffBln;
$qStaffBln=mysql_query($sStaffBln) or die(mysql_error());
$rStaffBln=  mysql_fetch_assoc($qStaffBln);
