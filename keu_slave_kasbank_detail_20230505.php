    ...
    case'getInvoice':
       ...
       // print_r($str);exit;
        ...
        $sPo="select distinct a.kodesupplier,noinvoice,a.nopo,a.tipeinvoice,a.nilaiinvoice+a.uangmuka as nilaiinvoice,a.nilaippn,a.keterangan,a.posting
			,b.namakaryawan,if(a.nilaiinvoice=0 and a.uangmuka>0,'1180100',if(a.tipeinvoice='t','2111101',d.noakun)) as noakun
	...
	case 'addFromInvoice'://indra
        ...
        foreach($resHead as $row) {
			...
			if($param['hutangunit']==1) {
				...
				if($row['nilaiinvoice']==0 and $row['uangmuka']>0){
					$akunHead='1180100';
					$nomordok='';
				}else if($row['tipeinvoice']=='t'){
					//$akunHead='2111101';
					$akunHead='1180100';
            ...
            $data[] = array(
                ...
                'tanggal' => $row['tanggal'],
                'jumlah' => ($row['tipeinvoice']=='t' ? $sisa[$row['noinvoice']]*0.89 : $sisa[$row['noinvoice']]),
			...
			if($row['tipeinvoice']=='t'){
                ...
                'tipetransaksi' => $param['tipetransaksi'],
                'tanggal' => $row['tanggal'],
                'jumlah' => $sisa[$row['noinvoice']]*0.11,
                'noakun2a' => $param['noakun'],
                'kode' => $param['kode'],
                'keterangan1' => $row['noinvoice'],
