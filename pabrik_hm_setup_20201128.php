			...
			<tr>
				<td valign=top>  
					<table>
						...
						<tr>
							<td>Intermediate/Top Overhaul</td>
		...
		<table class=sortable cellspacing=1 border=0 width=100%>
			<thead>
				<tr class=rowheader>
					...
					<td width='7%' align=center>Pergantian Sparepart</td>
					<td width='7%' align=center>Intermediate/ Top.Overhaul</td>
					<td width='7%' align=center>Major/ Gen.Overhaul</td>
