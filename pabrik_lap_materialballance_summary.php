<?php
		...
		foreach($xkodeblok as $xkddiv => $xkdblok){
			if($xdiv==$xkddiv){
				foreach($xkdblok as $xblok){
			        ...
			        for ($xbln=1; $xbln<=12; $xbln++){
						$ttoer_tt0=($ttoer_tt[$xbln][$xblok]==0 ? 0 : $ttoer_tt[$xbln][$xblok]);
				    ...
				    for ($xbln=1; $xbln<=12; $xbln++){
						$ttker_tt0=($ttker_tt[$xbln][$xblok]==0 ? 0 : $ttker_tt[$xbln][$xblok]);
	...
	for ($xbln=1; $xbln<=12; $xbln++){
		$tt_oer=($ttbln_hasil_tt[$xbln]==0 ? 0 : $ttbln_oil_tt[$xbln]/$ttbln_hasil_tt[$xbln]*100);
		$fontcolor0=($tt_oer==0 ? " style='color:$ttbgcolor' " : "");
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format($tt_oer,2)."</td>";
	}
	for ($xbln=1; $xbln<=12; $xbln++){
		$tt_ker=($ttbln_hasil_tt[$xbln]==0 ? 0 : $ttbln_kernel_tt[$xbln]/$ttbln_hasil_tt[$xbln]*100);
	...
	for ($xbln=1; $xbln<=12; $xbln++){
		$stinti_oer=($stinti_hasil_tt[$xbln]==0 ? 0 : $stinti_oil_tt[$xbln]/$stinti_hasil_tt[$xbln]*100);
	...
	for ($xbln=1; $xbln<=12; $xbln++){
		$stinti_ker=($stinti_hasil_tt[$xbln]==0 ? 0 : $stinti_kernel_tt[$xbln]/$stinti_hasil_tt[$xbln]*100);
	...
	foreach($unit as $xorg){
        ...
        for ($xbln=1; $xbln<=12; $xbln++){
			$ttunit_oer=($ttunit_hasil_tt[$xorg][$xbln]==0 ? 0 : $ttunit_oil_tt[$xorg][$xbln]/$ttunit_hasil_tt[$xorg][$xbln]*100);
        ...
        for ($xbln=1; $xbln<=12; $xbln++){
			$ttunit_ker=($ttunit_hasil_tt[$xorg][$xbln]==0 ? 0 : $ttunit_kernel_tt[$xorg][$xbln]/$ttunit_hasil_tt[$xorg][$xbln]*100);
		...
		foreach($xkodeblok as $xkddiv => $xkdblok){
			if($xdiv==$xkddiv){
				foreach($xkdblok as $xblok){
					...
					$stream.="<td align='left'>".($xblok=='TBSEXT' ? 'TBS Luar' : $optNm[$xblok])."</td>";
			        for ($xbln=1; $xbln<=12; $xbln++){
						$ttoer_ur0=($ttoer_ur[$xbln][$xblok]==0 ? 0 : $ttoer_ur[$xbln][$xblok]);
				    ...
				    for ($xbln=1; $xbln<=12; $xbln++){
						$ttker_ur0=($ttker_ur[$xbln][$xblok]==0 ? 0 : $ttker_ur[$xbln][$xblok]);
	...
	$stream.="<tr class=rowcontent>
				...
				<td bgcolor=".$ttbgcolor." colspan=2 align='center'>TOTAL</td>";
	for ($xbln=1; $xbln<=12; $xbln++){
		$tt_oer=($ttbln_hasil_ur[$xbln]==0 ? 0 : $ttbln_oil_ur[$xbln]/$ttbln_hasil_ur[$xbln]*100);
		$fontcolor0=($tt_oer==0 ? " style='color:$ttbgcolor' " : "");
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format($tt_oer,2)."</td>";
	}
	for ($xbln=1; $xbln<=12; $xbln++){
		$tt_ker=($ttbln_hasil_ur[$xbln]==0 ? 0 : $ttbln_kernel_ur[$xbln]/$ttbln_hasil_ur[$xbln]*100);
		$fontcolor0=($tt_ker==0 ? " style='color:$ttbgcolor' " : "");
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format($tt_ker,2)."</td>";
	}
	$stream.="</tr>";
	...
	$stream.="<tr class=rowcontent>
				...
				<td bgcolor=".$ttbgcolor." colspan=2 align='center'>TOTAL INTI</td>";
	for ($xbln=1; $xbln<=12; $xbln++){
		$stinti_oer=($stinti_hasil_ur[$xbln]==0 ? 0 : $stinti_oil_ur[$xbln]/$stinti_hasil_ur[$xbln]*100);
		$fontcolor0=($stinti_oer==0 ? " style='color:$ttbgcolor' " : "");
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format($stinti_oer,2)."</td>";
	}
	for ($xbln=1; $xbln<=12; $xbln++){
		$stinti_ker=($stinti_hasil_ur[$xbln]==0 ? 0 : $stinti_kernel_ur[$xbln]/$stinti_hasil_ur[$xbln]*100);
		$fontcolor0=($stinti_ker==0 ? " style='color:$ttbgcolor' " : "");
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format($stinti_ker,2)."</td>";
	}
	$stream.="</tr>";
	...
	foreach($unit as $xorg){
		...
		$stream.="<tr class=rowcontent>
					...
					<td bgcolor=".$ttbgcolor." colspan=2 align='center'>TOTAL ".($xorg=='TBSE' ? 'LUAR' : $xorg)."</td>";
        for ($xbln=1; $xbln<=12; $xbln++){
			$ttunit_oer=($ttunit_hasil_ur[$xorg][$xbln]==0 ? 0 : $ttunit_oil_ur[$xorg][$xbln]/$ttunit_hasil_ur[$xorg][$xbln]*100);
			$fontcolor0=($ttunit_oer==0 ? " style='color:$ttbgcolor' " : "");
			$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format($ttunit_oer,2)."</td>";
		}
        for ($xbln=1; $xbln<=12; $xbln++){
			$ttunit_ker=($ttunit_hasil_ur[$xorg][$xbln]==0 ? 0 : $ttunit_kernel_ur[$xorg][$xbln]/$ttunit_hasil_ur[$xorg][$xbln]*100);
			$fontcolor0=($ttunit_ker==0 ? " style='color:$ttbgcolor' " : "");
			$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format($ttunit_ker,2)."</td>";
		}
		$stream.="</tr>";
		...
		foreach($xkodeblok as $xkddiv => $xkdblok){
			if($xdiv==$xkddiv){
				foreach($xkdblok as $xblok){
					...
					$stream.="<td align='left'>".($xblok=='TBSEXT' ? 'TBS Luar' : $optNm[$xblok])."</td>";
			        for ($xbln=1; $xbln<=12; $xbln++){
						$ttoer_nr0=($ttoer_nr[$xbln][$xblok]==0 ? 0 : $ttoer_nr[$xbln][$xblok]);
				    ...
				    for ($xbln=1; $xbln<=12; $xbln++){
						$ttker_nr0=($ttker_nr[$xbln][$xblok]==0 ? 0 : $ttker_nr[$xbln][$xblok]);
	...
	$stream.="<tr class=rowcontent>
				...
				<td bgcolor=".$ttbgcolor." colspan=2 align='center'>TOTAL</td>";
	for ($xbln=1; $xbln<=12; $xbln++){
		$tt_oer=($ttbln_hasil_nr[$xbln]==0 ? 0 : $ttbln_oil_nr[$xbln]/$ttbln_hasil_nr[$xbln]*100);
		$fontcolor0=($tt_oer==0 ? " style='color:$ttbgcolor' " : "");
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format($tt_oer,2)."</td>";
	}
	for ($xbln=1; $xbln<=12; $xbln++){
		$tt_ker=($ttbln_hasil_nr[$xbln]==0 ? 0 : $ttbln_kernel_nr[$xbln]/$ttbln_hasil_nr[$xbln]*100);
		$fontcolor0=($tt_ker==0 ? " style='color:$ttbgcolor' " : "");
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format($tt_ker,2)."</td>";
	}
	$stream.="</tr>";
	...
	$stream.="<tr class=rowcontent>
				...
				<td bgcolor=".$ttbgcolor." colspan=2 align='center'>TOTAL INTI</td>";
	for ($xbln=1; $xbln<=12; $xbln++){
		$stinti_oer=($stinti_hasil_nr[$xbln]==0 ? 0 : $stinti_oil_nr[$xbln]/$stinti_hasil_nr[$xbln]*100);
		$fontcolor0=($stinti_oer==0 ? " style='color:$ttbgcolor' " : "");
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format($stinti_oer,2)."</td>";
	}
	for ($xbln=1; $xbln<=12; $xbln++){
		$stinti_ker=($stinti_hasil_nr[$xbln]==0 ? 0 : $stinti_kernel_nr[$xbln]/$stinti_hasil_nr[$xbln]*100);
		$fontcolor0=($stinti_ker==0 ? " style='color:$ttbgcolor' " : "");
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format($stinti_ker,2)."</td>";
	}
	$stream.="</tr>";
	...
	foreach($unit as $xorg){
		...
		$stream.="<tr class=rowcontent>
					...
					<td bgcolor=".$ttbgcolor." colspan=2 align='center'>TOTAL ".($xorg=='TBSE' ? 'LUAR' : $xorg)."</td>";
        for ($xbln=1; $xbln<=12; $xbln++){
			$ttunit_oer=($ttunit_hasil_nr[$xorg][$xbln]==0 ? 0 : $ttunit_oil_nr[$xorg][$xbln]/$ttunit_hasil_nr[$xorg][$xbln]*100);
			$fontcolor0=($ttunit_oer==0 ? " style='color:$ttbgcolor' " : "");
			$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format($ttunit_oer,2)."</td>";
		}
        for ($xbln=1; $xbln<=12; $xbln++){
			$ttunit_ker=($ttunit_hasil_nr[$xorg][$xbln]==0 ? 0 : $ttunit_kernel_nr[$xorg][$xbln]/$ttunit_hasil_nr[$xorg][$xbln]*100);
			$fontcolor0=($ttunit_ker==0 ? " style='color:$ttbgcolor' " : "");
			$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format($ttunit_ker,2)."</td>";
		}
		$stream.="</tr>";
		...
		foreach($xkodeblok as $xkddiv => $xkdblok){
			if($xdiv==$xkddiv){
				foreach($xkdblok as $xblok){
					...
					$stream.="<td align='left'>".($xblok=='TBSEXT' ? 'TBS Luar' : $optNm[$xblok])."</td>";
			        for ($xbln=1; $xbln<=12; $xbln++){
						$ttoer_or0=($ttoer_or[$xbln][$xblok]==0 ? 0 : $ttoer_or[$xbln][$xblok]);
				    ...
				    for ($xbln=1; $xbln<=12; $xbln++){
						$ttker_or0=($ttker_or[$xbln][$xblok]==0 ? 0 : $ttker_or[$xbln][$xblok]);
	...
	$stream.="<tr class=rowcontent>
				...
				<td bgcolor=".$ttbgcolor." colspan=2 align='center'>TOTAL</td>";
	for ($xbln=1; $xbln<=12; $xbln++){
		$tt_oer=($ttbln_hasil_or[$xbln]==0 ? 0 : $ttbln_oil_or[$xbln]/$ttbln_hasil_or[$xbln]*100);
		$fontcolor0=($tt_oer==0 ? " style='color:$ttbgcolor' " : "");
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format($tt_oer,2)."</td>";
	}
	for ($xbln=1; $xbln<=12; $xbln++){
		$tt_ker=($ttbln_hasil_or[$xbln]==0 ? 0 : $ttbln_kernel_or[$xbln]/$ttbln_hasil_or[$xbln]*100);
		$fontcolor0=($tt_ker==0 ? " style='color:$ttbgcolor' " : "");
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format($tt_ker,2)."</td>";
	}
	$stream.="</tr>";
	...
	$stream.="<tr class=rowcontent>
				...
				<td bgcolor=".$ttbgcolor." colspan=2 align='center'>TOTAL INTI</td>";
	for ($xbln=1; $xbln<=12; $xbln++){
		$stinti_oer=($stinti_hasil_or[$xbln]==0 ? 0 : $stinti_oil_or[$xbln]/$stinti_hasil_or[$xbln]*100);
		$fontcolor0=($stinti_oer==0 ? " style='color:$ttbgcolor' " : "");
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format($stinti_oer,2)."</td>";
	}
	for ($xbln=1; $xbln<=12; $xbln++){
		$stinti_ker=($stinti_hasil_or[$xbln]==0 ? 0 : $stinti_kernel_or[$xbln]/$stinti_hasil_or[$xbln]*100);
		$fontcolor0=($stinti_ker==0 ? " style='color:$ttbgcolor' " : "");
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format($stinti_ker,2)."</td>";
	}
	$stream.="</tr>";
	...
	foreach($unit as $xorg){
		...
		$stream.="<tr class=rowcontent>
					...
					<td bgcolor=".$ttbgcolor." colspan=2 align='center'>TOTAL ".($xorg=='TBSE' ? 'LUAR' : $xorg)."</td>";
        for ($xbln=1; $xbln<=12; $xbln++){
			$ttunit_oer=($ttunit_hasil_or[$xorg][$xbln]==0 ? 0 : $ttunit_oil_or[$xorg][$xbln]/$ttunit_hasil_or[$xorg][$xbln]*100);
			$fontcolor0=($ttunit_oer==0 ? " style='color:$ttbgcolor' " : "");
			$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format($ttunit_oer,2)."</td>";
		}
        for ($xbln=1; $xbln<=12; $xbln++){
			$ttunit_ker=($ttunit_hasil_or[$xorg][$xbln]==0 ? 0 : $ttunit_kernel_or[$xorg][$xbln]/$ttunit_hasil_or[$xorg][$xbln]*100);
			$fontcolor0=($ttunit_ker==0 ? " style='color:$ttbgcolor' " : "");
			$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format($ttunit_ker,2)."</td>";
		}
		$stream.="</tr>";
