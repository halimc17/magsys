...
echo"<table>
     <tr valign=moiddle>
	 <td align=center style='width:100px;cursor:pointer;' onclick=loadData_batal()>
	 ...
	 <td><fieldset><legend>".$_SESSION['lang']['carinopo']."</legend>"; 
			...
			echo"<button class=mybutton onclick=cariPo_batal()>".$_SESSION['lang']['find']."</button>";
echo"</fieldset></td>
     </tr>
	 </table> "; 
?>
