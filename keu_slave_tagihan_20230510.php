    ...
    case'getPo':
        ...
        while($rPo=mysql_fetch_assoc($qPo)){
	        ...
	        elseif($jenisInvoice=='trading') {
				...
				if($rCek['jmlhinvoice']!='')
				{
					$rPo['nilaikontrakext']=$rPo['nilaikontrakext']-$rCek['jmlhinvoice'];
				}
				$whbrg="kodebarang='".$rPo['kodebarang']."'";
				$nmBrg=makeOption($dbname,'log_5masterbarang','kodebarang,namabarang',$whbrg);
				...
				if($rPo['nilaikontrakext']>0)
				{
					...
					$dat.=isset($rPo['nilaikontrakext'])? $rPo['nilaikontrakext']+$rPo['nilaippnext']: 0;
					$dat.="','".$param['jnsInvoice']."','";
					...
					$dat.="<td>".number_format($rPo['nilaikontrakext']+$rPo['nilaippnext'])."</td></tr>";
				}
            }                
