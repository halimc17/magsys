...
$stream.="<thead><tr class=rowheader>
			...
			<td rowspan=4 align=center width='40px'>Selisih Janjang</td>
...
while($dList=mysql_fetch_assoc($nList)){
	...
	*/
	...
	$stream.="<tr class=rowcontent>
				...
				<td align='right'>".number_format(($dList['jjgsortasi']-$dList['janjang']),0)."</td>
...
$stream.="<tr bgcolor='#FEDEFE'>
			...
			<td align='right'>".number_format(($gtjjgsortasi-$gtjanjang),0)."</td>
