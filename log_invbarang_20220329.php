...
if($_SESSION['empl']['tipelokasitugas']=='HOLDING'){
	...
	$sKry="select nik,namakaryawan,lokasitugas from ".$dbname.".datakaryawan where (tanggalkeluar='0000-00-00' or tanggalkeluar>CURDATE()) and lokasitugas not like '%HO' and lokasitugas in (select kodeorganisasi from ".$dbname.".organisasi where detail=1 and induk='".$_SESSION['empl']['induk']."') and tipekaryawan not in ('4','5') order by namakaryawan";
}else{
	...
	$sKry="select nik,namakaryawan,lokasitugas from ".$dbname.".datakaryawan where (tanggalkeluar='0000-00-00' or tanggalkeluar>CURDATE()) and lokasitugas='".$_SESSION['empl']['lokasitugas']."' and tipekaryawan not in ('4','5') order by namakaryawan";
}
//exit('Warning: '.$str);
$res=mysql_query($str);
...
or left(kodebarang,1)='9') order by kodebarang";
