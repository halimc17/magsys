...
if($gudang=='' and $pt=='')
{
    $str="select a.kodesupplier,a.nojurnal,a.jumlah,a.keterangan,a.tanggal,a.noreferensi,a.kodevhc,a.nik,a.kodeblok,b.namapenerima,c.namakaryawan,a.kodeasset 
        ...
        where a.periode>='".$periode."' and a.periode<='".$periode1."' and a.noakun='".$noakun."' and a.revisi <= '".$revisi."' ".$whrRegional."";
}
else if($gudang=='' and $pt!='')
{
    $str="select a.kodesupplier,a.nojurnal,a.jumlah,a.keterangan,a.tanggal,a.noreferensi,a.kodevhc,a.nik,a.kodeblok,b.namapenerima,c.namakaryawan,a.kodeasset
        ...
        and a.noakun='".$noakun."' and a.revisi <= '".$revisi."' ".$whrRegional."";
}
else
{
    $str="select a.kodesupplier,a.nojurnal,a.jumlah,a.keterangan,a.tanggal,a.noreferensi,a.kodevhc,a.nik,a.kodeblok,b.namapenerima,c.namakaryawan,a.kodeasset
