...
if(isTransactionPeriod())//check if transaction period is normal
{
 ...
 //============================================   
  $gudang	=$_POST['gudang'];
  $num=1;//default value 
  $str="select max(notransaksi) notransaksi from ".$dbname.".log_transaksiht where tipetransaksi>4 ".
	//"and tanggal>=".$_SESSION['gudang'][$gudang]['start']." and tanggal<=".$_SESSION['gudang'][$gudang]['end'].
