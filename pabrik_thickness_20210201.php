					...
					<table>
						...
						<tr>
							...
							<td><select id=tipeservice name=tipeservice>
									...
									<option value='1'>Ganti Plat</option>
								</select>
							</td>
						...
						<tr>
							<td> 
								<table>
									<tr>
										<td>Ukur Tebal 1</td>
										<td><input type=text id=tebal1 value=0 class=myinputtextnumber maxlength=8 size=12 onblur=cektebal() onkeypress=\"return angka_doang(event);\"></td>
									</tr>
									<tr>
										<td>Ukur Tebal 2</td>
										<td><input type=text id=tebal2 value=0 class=myinputtextnumber maxlength=8 size=12 onblur=cektebal() onkeypress=\"return angka_doang(event);\"></td>
									</tr>
									<tr>
										<td>Ukur Tebal 3</td>
										<td><input type=text id=tebal3 value=0 class=myinputtextnumber maxlength=8 size=12 onblur=cektebal() onkeypress=\"return angka_doang(event);\"></td>
									</tr>
									<tr>
										<td>Keterangan</td>
		...
		<table class=sortable cellspacing=1 border=0 width=100%>
			<thead>
				<tr class=rowheader>
					...
					<td width='7%' width='3%' align=center>".$_SESSION['lang']['service']."</td>
