...
if($intiplasma!=''){
    $whreblok.=" and intiplasma='".$intiplasma."'";
    $whre.=" and intiplasma='".$intiplasma."'";
    $whrakt.=" and intiplasma='".$intiplasma."'";
}
if($proses!='getData')
{
...
foreach($amThnTnm as $lstAfdeling){
    ...
    if($lstAfdeling!=$agdDt)
    {
        ...
        @$subTotBi[$lstAfdeling]=$subTotBrtAkt[$lstAfdeling]/$subTotLuas[$lstAfdeling];
        @$subTotSbi[$lstAfdeling]=$subTotBrtSmp[$lstAfdeling]/$subTotLuas[$lstAfdeling];
...
@$grTotTotBi=$grTotBrtAkt/$grLuas;
@$grTotTotSbi=$grTotBrtSmp/$grLuas;
@$grTotTotThnAngr=$grTotBrtBgtSmp/$grLuasBgt;
