...
while($dList=mysql_fetch_assoc($nList)){
	...
	if($lapke==1){
		$stream.="<td align='right'>".number_format($dList['jam_solar_rad'],2,".","")."</td>
				<td align='right'>".number_format($dList['sum_solar_rad'],2,".","")."</td>
...
if($lapke==0){
	...
	$stream.="<td align='right'>Radiasi: ".number_format(array_sum($solar_rad),2,".","")."</td>";
	...
	$stream.="<tr bgcolor='#DEFEDE'>
				...
				<td align='right'>".number_format($sum_solar_rad,2,".","")."</td>
