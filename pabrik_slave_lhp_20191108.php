...
if($tanggal==''){
	...
	if($proses=='preview' or $proses=='excel'){
		if($proses=='excel'){
			...
			$tab[0]="<table class=sortable cellspacing=1 border=0 style='width:1200px;'>";
		}
		$tab[0].="
				<thead>
					<tr class=rowheader>
				...
				<tbody>";
		$sql="select if(substr(a.nospb,9,6)='','zzzzzz',substr(a.nospb,9,6)) as unit
				,d.namaorganisasi as namaunit,if(substr(a.nospb,9,6)<>'',e.namaorganisasi,c.namasupplier) as namadivisi,a.kodecustomer
		...
		$no2+=1;
		$tab2[$no2].="
			<td colspan=1 style='text-align:center;'>37</td>
