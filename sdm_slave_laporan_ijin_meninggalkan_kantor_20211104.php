	...
	if($rKet['jenisijin']=='CUTI' or $rKet['jenisijin']=='ALASANPENTING' or $rKet['jenisijin']=='MELAHIRKAN' or $rKet['jenisijin']=='SKRIPSI_TESIS'){
		...
		foreach($rangeTgl as $val){
			...
			if($Ada==1){
				...
				$strAbs = "insert into ".$dbname.".sdm_absensidt (kodeorg,tanggal,karyawanid,shift,absensi,jam,jamPlg,penjelasan,catu,penaltykehadiran,premi,insentif,fingerprint) values ('".$kodeorg."','".$val."','".$krywnId."','','C','00:00:00','00:00:00','".$keterangan."','0','0','0','0','0')";
			}
			mysql_query($strAbs);
		}
	}
