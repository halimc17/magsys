...
<tr><td><label><?php echo $_SESSION['lang']['kebun']?></label></td><td><select id="kebun" name="kebun" style="width:150px" onchange =mandor()><option value=""></option><?php echo $optOrg?></select></td></tr>
<tr><td><label><?php echo $_SESSION['lang']['divisi']?></label></td><td><select id="divisi" name="kebun" style="width:150px" onchange =getMandor()><option value=""></option></select></td></tr>
<tr><td><label><?php echo $_SESSION['lang']['mandor']?></label></td><td><select id="mandor" name="mandor" style="width:150px"><option value=""></option></select></td></tr>
<tr><td><label><?php echo $_SESSION['lang']['tanggal']?></label></td><td>
<input type="text" class="myinputtext" id="tanggal" name="tanggal" onmousemove="setCalendar(this.id);" onkeypress="return false;"  maxlength="10" style="width:60px;" /> s.d 
<input type="text" class="myinputtext" id="tanggal2" name="tanggal2" onmousemove="setCalendar(this.id);" onkeypress="return false;"  maxlength="10" style="width:60px;" />
</td></tr>
