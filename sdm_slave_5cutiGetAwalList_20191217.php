...
if($_SESSION['empl']['tipelokasitugas']!='HOLDING'){
	$str1="select a.karyawanid,a.namakaryawan,a.tanggalmasuk,if(a.karyawanid=c.promosi,a.tanggalpengangkatan,a.tanggalmasuk) as tanggalhitung ,a.lokasitugas,a.tipekaryawan,a.nik,a.kodegolongan
		   ...
		   LEFT JOIN (select DISTINCT(b.karyawanid) as promosi from ".$dbname.".sdm_riwayatjabatan b where b.ketipekaryawan='0') c on a.karyawanid=c.promosi
	       where a.lokasitugas='".$lokasitugas."' 
		   and a.tanggalmasuk<>'0000-00-00' and (a.tanggalkeluar>'".date('Y-m-d')."' or a.tanggalkeluar='0000-00-00')
...
//exit("error: ".$str1);
	...
	while($bar1=mysql_fetch_object($res1))
	{
		...
		$dari  =mktime(0,0,0,$blnhitug,'01',$periode);
		$dari=date('Ymd',$dari);
