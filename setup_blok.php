...
$strKlsPhn = "select * from ".$dbname.".kebun_5kelaspohon";
...
$els[] = array(
  ...
  makeElement('tahuntanam','textnumber','',array('style'=>'width:70px','maxlength'=>'6')).
  makeElement('tahuntanamCurr','hidden','')
);
$els[] = array(
  makeElement('kelaspohon','label',$_SESSION['lang']['kelaspohon']),
  makeElement('kelaspohon','select','',array('style'=>'width:200px'),$optKlsPohon)
);
$els[] = array(
  ...
  makeElement('luasareaproduktif','textnumber','0',array('style'=>'width:80px','maxlength'=>'10',
    'onkeypress'=>'return angka_doang(event)','onblur'=>'this.value=_formatted(this)'))." Ha"
);
$els[] = array(
...
$els[] = array(
  ...
  makeElement('jumlahpokok','textnumber','0',array('style'=>'width:70px','maxlength'=>'10','onkeypress'=>'return angka_doang(event)'))
);
$els[] = array(
