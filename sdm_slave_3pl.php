...
switch($method)
{
    case'loadKar':
        ...
        $iKar="select namakaryawan,karyawanid,nik,subbagian,lokasitugas from ".$dbname.".datakaryawan"
            . " where lokasitugas='".$org."' and (tanggalkeluar = '0000-00-00' or tanggalkeluar > ".$_SESSION['org']['period']['start'].") "
            . " and alokasi=0 and tipekaryawan not in ('0','7','8') order by namakaryawan";
    ...
    case'loadData':
            ...
            $orgSort=" kodeorg in (select kodeorganisasi from ".$dbname.".organisasi where"
