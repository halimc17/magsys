...
<script language=javascript1.2 src='js/sdm_5kl_prasarana.js'></script>
<?
include('master_mainMenu.php');
OPEN_BOX('',$_SESSION['lang']['klSarana']);

echo"<fieldset style='width:500px;'><table>
     <tr><td>".$_SESSION['lang']['kodekelompok']."</td><td><input type=text id=kodejabatan size=3 onkeypress=\"return tanpa_kutip(event);\" class=myinputtext></td></tr>
	 <tr><td>".$_SESSION['lang']['namakelompok']."</td><td><input type=text id=namajabatan size=40 onkeypress=\"return tanpa_kutip(event);\" class=myinputtext></td></tr>
     </table>
...
echo open_theme($_SESSION['lang']['list']." ".$_SESSION['lang']['klSarana']);
