...
$tgl=$_POST['tgl'];
	...
	switch($proses)
	{
		...
		if($kdBrg=='0')
		{
			...
			echo"<tr class=rowcontent><td colspan=5>Total</td><td>".number_format($totBeratMsk,2)."</td><td>".number_format($totBeratKlr,2)."</td><td>".number_format($totBeratBrs,2)."</td><td colspan=5></td><td>".number_format($totBrondolan,2)."</td></tr>";
			echo"</tbody></table>";
		...
		elseif($kdBrg!='0')
		{
			...
			echo"<tr class=rowcontent><td colspan=4>Total</td><td  align=\"right\">".number_format($totBeratMsk,2)."</td><td  align=\"right\">".number_format($totBeratKlr,2)."</td><td  align=\"right\">".number_format($totBeratBrs,2)."</td><td colspan=5></td><td  align=\"right\">".number_format($totBrondolan,2)."</td></tr>";
			echo"</tbody></table>";
