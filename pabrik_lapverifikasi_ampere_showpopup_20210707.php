...
<?
	...
	$strtb="select a.kodemesin,a.ukur1,a.tipeservice from ".$dbname.".pabrik_verifikasi_ampere a where a.kodemesin like '".$kodemesin."%' and a.tipeservice<>0
			".$where."
	...
	$stream2.="
		<thead>
			<tr class=rowcontent>
				...
				<td width='4%' align=center>Ukur R</td>
				<td width='4%' align=center>Ukur S</td>
				<td width='4%' align=center>Ukur T</td>
