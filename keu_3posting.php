...
if($_SESSION['language']=='EN'){
    $optJenisData=array(
		'gaji'=>'Salaries From General Cost',
		'gajiharilibur'=>'UnAllocated Salaries of Plant Labour',
		'potongan'=>'Deduction Journal',
		'depresiasi'=>'Depreciation',
                                        'fixtrans'=>'Warehouse Integrity Check',        
		'alokasi'=>'Vehicle Running Allocation - (Traksi)',
		'kurs'=>'Kurs Differentiation',
		'mutasi'=>'Promotion / Mutation / Demotion',
	);
}  else  {
    $optJenisData=array(
		'gaji'=>'Gaji Karyawan Tidak Langsung - (RO,Traksi,Kebun,PKS)',
		'gajiharilibur'=>'Gaji Karyawan Langsung - (Kebun)',
		'potongan'=>'Penarikan Potongan Gaji Karyawan',
		'depresiasi'=>'Depresiasi',
                                        'fixtrans'=>'Integrity Check Gudang',          
		'alokasi'=>'Alokasi Traksi - (Traksi)',
		'kurs'=>'Selisih Kurs',
