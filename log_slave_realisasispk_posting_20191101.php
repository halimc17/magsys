...
$dataRes['detail'][] = array(
    ...
    'keterangan'=>$optKeg2[$param['kodekegiatan']].' Realisasi SPK '.$param['kodeorg'].'/'.$param['notransaksi'],
...
foreach($optPajak as $noakun=>$nilai) {
	...
	$dataRes['detail'][] = array(
		...
		'nourut'=>$noUrut,
		'noakun'=>$noakun,
		'keterangan'=>$strPajak.' '.$optKeg2[$param['kodekegiatan']].' BASPK '.$param['kodeorg'].'/'.$param['notransaksi'],
		'jumlah'=>$nilai,
		'matauang'=>'IDR',
		'kurs'=>'1',
		'kodeorg'=>$param['kodeorg'],
