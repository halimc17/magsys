...
//	echo"warning:".$sCekHt;
        ...
        $sPeriode="select DISTINCT periode from ".$dbname.".sdm_5periodegaji where kodeorg='".substr($rKode['kodeorg'],0,4)."' and periode='".substr($tglTrans,0,4)."-".substr($tglTrans,4,2)."' and sudahproses=0 and tanggalmulai<='".$tglTrans."' and tanggalsampai>='".$tglTrans."'";
        //echo $sPeriode;
        //exit("Error:");
