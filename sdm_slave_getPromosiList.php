...
//==================
  ...
  while($bar=mysql_fetch_object($res))
  {
	...
	if($bar->posting==0) {
		echo "&nbsp<img src=images/application/application_edit.png class=resicon  title='Edit' onclick=\"editSK('".$bar->nomorsk."','".$bar->karyawanid."');\">
		...
		&nbsp<img src=images/hot.png class=resicon  title='posting' onclick=\"postSK('".$bar->nomorsk."','".$bar->karyawanid."');\">";
	} else {
		echo "&nbsp<img src=images/buttongreen.png title='posting'>";
	}
	echo "</td>
	  </tr>";
  }
