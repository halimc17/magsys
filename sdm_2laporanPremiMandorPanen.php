...
{
    $arr="##kdOrg##periode##afdId##pengawas";
...
<tr>
	<td><label><?php echo $_SESSION['lang']['pengawasan'];?></label></td>
	<td><select id="pengawas" name="pengawas" style="width:150px">
		<option value="M"><?php echo $_SESSION['lang']['mandorpanen'];?></option>
		<option value="K"><?php echo $_SESSION['lang']['keranimuat'];?></option>
	</select></td>
</tr>
