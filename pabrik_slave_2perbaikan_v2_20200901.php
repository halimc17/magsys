...
if(is_array($listmesin)){
	...
	foreach ($listmesin as $stasiun=>$row)
	{
		if(in_array($stasiun, $liststasiun)) 
		{
			$ttjmlharga=0;
			$stream.="<thead>";
			$stream.="<tr class=rowheader><td align=left colspan=10><b>Station : ".$stasiun." - ".$nmOrg[$stasiun]."</td></tr>";
			$stream.="<tr class=rowheader><td align=left colspan=10><b>Pabrik : ".$pabrik." - ".$nmOrg[$pabrik]."</td></tr>";
			$stream.="</thead>";
			/*
			...
			foreach($row as $mesin=>$row2)
			{
				...
				$stream.="<td align=center colspan=10><b>".$mesin." - ".$nmOrg[$mesin]."</td>";
				$stream.="</tr>";
