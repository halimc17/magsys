					...
					<fieldset><legend>Buah Unripe</legend>
						<table>
							...
							<tr>
								...
								<td><input type=text id=lossestbs_ur5 value=0.38 onchange=hitung_ur() class=myinputtextnumber maxlength=8 size=8 onkeypress=\"return angka_doang(event);\"></td>
							</tr>
							<tr>
								<td>Total</td>
							...
							<tr>
								...
								<td><input type=text id=lossesoil_ur5 value=1.50 onchange=hitung_ur() class=myinputtextnumber maxlength=8 size=8 onkeypress=\"return angka_doang(event);\"></td>
							</tr>
							<tr>
								<td>Total</td>
					...
					<fieldset><legend>Buah Normal Ripe</legend>
						<table>
							...
							<tr>
								...
								<td><input type=text id=lossestbs_nr5 value=0.38 onchange=hitung_nr() class=myinputtextnumber maxlength=8 size=8 onkeypress=\"return angka_doang(event);\"></td>
							</tr>
							<tr>
								<td>Total</td>
							...
							<tr>
								...
								<td><input type=text id=lossesoil_nr5 value=1.50 onchange=hitung_nr() class=myinputtextnumber maxlength=8 size=8 onkeypress=\"return angka_doang(event);\"></td>
							</tr>
							<tr>
								<td>Total</td>
					...
					<fieldset><legend>Buah Over Ripe</legend>
						<table>
							...
							<tr>
								...
								<td><input type=text id=lossestbs_or5 value=0.38 onchange=hitung_or() class=myinputtextnumber maxlength=8 size=8 onkeypress=\"return angka_doang(event);\"></td>
							</tr>
							<tr>
								<td>Total</td>
							...
							<tr>
								...
								<td><input type=text id=lossesoil_or5 value=1.50 onchange=hitung_or() class=myinputtextnumber maxlength=8 size=8 onkeypress=\"return angka_doang(event);\"></td>
							</tr>
							<tr>
								<td>Total</td>
