        ...
        echo"<tr>
             ...
             <tr class=rowcontent>
                ...
                <td align=right>".$_SESSION['lang']['sistemgaji']."</td><td align=left bgcolor=#EDEDED><b>".$bar->sistemgaji."</b></td>
                        <td align=right>".$_SESSION['lang']['passport']."</td><td align=left bgcolor=#EDEDED><b>".$bar->no_keluarga."</b></td>
                 </tr>	
                 <tr class=rowcontent>
				...
				<td align=right>".$_SESSION['lang']['tanggalpengangkatan']."</td><td align=left bgcolor=#EDEDED><b>".tanggalnormal($bar->tanggalpengangkatan)."</b></td>
                 </tr>	
				 <tr class=rowcontent>
                ...
                <tr class=rowcontent>
                    <td align=right>".$_SESSION['lang']['statusakad']."</td>
                    <td align=left bgcolor=#EDEDED><b>".$txtAkad."</b></td>    
                    <td align=right>Masa Kerja</td><td align=left bgcolor=#EDEDED>".$lamaKerja."</td>
                 </tr>
";
         ...
         ";
                 ...
                 echo"	  <tr class=rowcontent>
                                  ...
                                  if($bar->tipesk=='Mutasi'){
                                      echo"<td>".$bar->darikodeorg." (".$kamusjabatan[$bar->darikodejabatan].")</td>
