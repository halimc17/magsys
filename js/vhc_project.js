...
//    nilai=trim(document.getElementById('nilai').value);
    ...
    if(unit=='')            { alert('Please fill UNIT'); return; }
    if(aset=='')            { alert('Please fill ASSET'); return; }
    if(nama=='')            { alert('Please fill NAMA'); return; }
	if(sub=='')            	{ alert('Please fill SUB ASSET'); return; }
    if(tanggalmulai=='')    { alert('Please fill TANGGAL MULAI'); return; }
    if(tanggalselesai=='')  { alert('Please fill TANGGAL SELESAI'); return; }
