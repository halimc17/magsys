...
function simpanheader()
{
    ...
    param='proses=simpan_header'+'&id='+id+'&jenis='+jenis+'&mesin='+mesin+'&satuan='+satuan+'&atas='+atas+'&peringatan='+peringatan+
        '&tanggal='+tanggal+'&tugas='+tugas+'&keterangan='+keterangan+'&email='+email+'&sekali='+sekali;
//        post_response_text(tujuan, param, respon);
...
function isiheader(id,jenis,mesin,satuan,atas,peringatan,tanggal,tugas,keterangan,email)
{
    resetheader();
...
function lihatdetail(id,jenis,mesin,satuan,atas,peringatan,tanggal,tugas,keterangan,email)
{
    resetheader();
    document.getElementById('id').value=id;
    document.getElementById('jenis').value=jenis;
