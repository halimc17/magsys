...
function simpanData(){
	...
	if(kodeorg=='' ||  stasiun=='' ||  mesin=='' ||  tanggal==''){
		...
		param+='&tebal1='+tebal1+'&tebal2='+tebal2+'&tebal3='+tebal3+'&tipeservice='+tipeservice+'&tipesrvlama='+tipesrvlama;
...
function fillfield(kodeorg,mesin,tanggal,tipeservice,tebal1,tebal2,tebal3,keterangan){
