...
function simpanData(){
	...
	niklama		=document.getElementById('niklama').value;
	namakaryawan=document.getElementById('namakaryawan').value;
	namakaryawanlama=document.getElementById('namakaryawanlama').value;
	tgldiuser  	=document.getElementById('tgldiuser').value;
	jumlahinv  	=document.getElementById('jumlahinv').value;
	satuaninv  	=document.getElementById('satuaninv').value;
	...
	if(kodeorg=='' ||  kodeinv=='' ||  namainv=='' ||  kondisi==''){
		...
		param+='&namakaryawan='+namakaryawan+'&jumlahinv='+jumlahinv+'&satuaninv='+satuaninv;
		param+='&kodeorglama='+kodeorglama+'&kodebrglama='+kodebrglama+'&kodeinvlama='+kodeinvlama+'&niklama='+niklama+'&namakaryawanlama='+namakaryawanlama;
...
function fillfield(kodeorg,kodebarang,kodeinv,namainv,merkinv,tipeinv,ketinv,ukuraninv,warnainv,bahaninv,tglbeli,hrgbeli,nopo,kodesupplier,nik,namakaryawan,tgldiuser,jumlahinv,satuaninv,kondisi,divisi,lokasi,ruangan){
	...
	document.getElementById('niklama').value=nik;
	document.getElementById('namakaryawan').value=namakaryawan;
	document.getElementById('namakaryawanlama').value=namakaryawan;
	document.getElementById('tgldiuser').value=tgldiuser;
	document.getElementById('jumlahinv').value=jumlahinv;
	document.getElementById('satuaninv').value=satuaninv;
...
function bersihkanForm(){
	...
	document.getElementById('niklama').value='';
	document.getElementById('namakaryawan').value='';
	document.getElementById('namakaryawanlama').value='';
	document.getElementById('tgldiuser').value='';
	document.getElementById('jumlahinv').value=0;
	document.getElementById('satuaninv').value='';
...
function deldata(kodeorg,kodebarang,kodeinv){
	param='kodeorg='+kodeorg+'&kodebarang='+kodebarang+'&kodeinv='+kodeinv+'&nik='+nik+'&namakaryawan='+namakaryawan;
            ...
            if (con.status == 200){
                ...
                if (!isSaveResponse(con.responseText)){
					...
					if(con.responseText!=''){
						...
						document.getElementById('namainv').value=ar[0];
						document.getElementById('satuaninv').value=ar[1];
					}
                }
            }else{
                busy_off();
...
function showpopup(kodeorg,kodebarang,kodeinv,namainv,type,ev){
	...
	tujuan='log_invpanen_showpopup.php'+"?"+param;
	width='1200';
	height='470';
...
function previewQRCode(kodeorg,kodebarang,kodeinv,namainv,nik,ruangan,type,ev){
	...
	tujuan='log_invpanen_pdfqrcode.php?'+param;
...
function cariinventaris(type,ev){
	...
	if(type=='pdf'){
		...
		tujuan='log_invpanen_excelqrcode.php?'+param;
		...
		tujuan='log_invpanen_showpopup.php?'+param;
		title='Inventaris Peralatan Kebun'+carikaryawan+' '+carinamainv+' '+carikodeorg+' '+cariruangan;
		width='1180';
		height='400';
		content="<iframe frameborder=0 width=100% height=100% src='"+tujuan+"'></iframe>"
		showDialog1(title,content,width,height,ev);
