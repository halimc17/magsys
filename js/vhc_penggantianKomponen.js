...
function fillField(kodeorg,notrans,tanggal,kd_vhc,stat,dwntTime,Desc,kdtraksi) 
{
        if(stat>0)
        {
        ...
        else
        {
				...
				jk=document.getElementById('kdTraksi');
				for(x=0;x<jk.length;x++){
						if(jk.options[x].value==kdtraksi)
						{
