...
function getPajak(){
	subtotalinv=parseFloat(remove_comma_var(document.getElementById('subtotalinv').value));
	...
	if(stsppn=='2'){//Excl PPN
		document.getElementById('nilaippn').value=(subtotalinv*0.11).toFixed(2);
	...
	if(stspph=='1160200'){//PPh Pasal 22
		document.getElementById('nilaipph').value=(subtotalinv*0.0025).toFixed(2);
	}else if(stspph=='1160400'){//PPh Pasal 23
		document.getElementById('nilaipph').value=(subtotalinv*0.02).toFixed(2);
	}else if(stspph=='1160500'){//PPh Pasal 4 Ayat 2
		document.getElementById('nilaipph').value=(subtotalinv*0.05).toFixed(2);
	}else{//Non PPh
		document.getElementById('nilaipph').value=pajak.toFixed(2);
	}
	document.getElementById('nilaiinvoice').value=(subtotalinv+parseFloat(document.getElementById('nilaippn').value)-parseFloat(document.getElementById('nilaipph').value)+ongkoskirim).toFixed(2);
