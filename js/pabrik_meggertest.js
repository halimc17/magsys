...
function loadData(){
	...
	tujuan='pabrik_meggertest_slave.php';
...
function simpanData(){
	...
	suhulama	=document.getElementById('suhulama').value;
	...
	if(kodeorg=='' ||  stasiun=='' ||  mesin=='' ||  tanggal==''){
		...
		param+='&suhu='+suhu+'&suhulama='+suhulama+'&tgllama='+tgllama+'&ketlama='+ketlama;
...
function fillfield(kodeorg,mesin,tanggal,suhu,ukur1,ukur2,ukur3,keterangan){
	...
	document.getElementById('suhulama').value=suhu;
...
function bersihkanForm(){
	...
	document.getElementById('suhulama').value=0;
...
function deldata(kodeorg,mesin,tanggal,suhu,keterangan){
	param='kodeorg='+kodeorg+'&mesin='+mesin+'&tanggal='+tanggal+'&suhu='+suhu+'&keterangan='+keterangan;
...
function showpopup(kodemesin,tanggal,kdorg,stasiun,type,ev){
   ...
   tujuan='pabrik_lap_meggertest_showpopup.php'+"?"+param;
   width='1200';
   height='470';
   content="<iframe frameborder=0 width=100% height=100% src='"+tujuan+"'></iframe>"
   showDialog1('Laporan Megger Test '+kdorg+' '+stasiun+' '+kodemesin+' '+tanggal,content,width,height,ev); 
}
