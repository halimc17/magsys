...
function bersihkanForm(){
	...
	document.getElementById('kdStatus').value='';
...
function loadData(page){
	...
	ThnTanam 	=document.getElementById('ThnTanam').options[document.getElementById('ThnTanam').selectedIndex].value;
	Tahun  		=document.getElementById('Tahun').value;
	param='kdPT='+kdPT+'&kdUnit='+kdUnit+'&kdDivisi='+kdDivisi+'&ThnTanam='+ThnTanam+'&Tahun='+Tahun+'&page='+page;
...
function simpanData(){
	...
	kdStatus 	=document.getElementById('kdStatus').options[document.getElementById('kdStatus').selectedIndex].value;
	...
	if(kdPT=='' || kdUnit=='' || kdDivisi=='' || Tahun=='' || kdBudget=='' || kdKegiatan=='' || ThnTanam==''){
		alert('All fields are required');
	}else{
		param='kdPT='+kdPT+'&kdUnit='+kdUnit+'&kdDivisi='+kdDivisi+'&Tahun='+Tahun+'&ThnTanam='+ThnTanam;
...
function salinData(){
	...
	kdStatus 	=document.getElementById('kdStatus').options[document.getElementById('kdStatus').selectedIndex].value;
	kdBudget	=document.getElementById('kdBudget').value;
	if(kdPT=='' || kdUnit=='' || Tahun=='' || kdBudget=='' || kdStatus==''){
		alert('All fields are required');
	}else{
		param='kdPT='+kdPT+'&kdUnit='+kdUnit+'&kdDivisi='+kdDivisi+'&Tahun='+Tahun;
		param+='&kdBudget='+kdBudget+'&kdStatus='+kdStatus;
		param+='&proses=salinData';
		tujuan='bgt_unit_slave.php';
		post_response_text(tujuan, param, respog);
	}
	function respog(){
...
function getKegiatan(){
    kdStatus=document.getElementById('kdStatus').options[document.getElementById('kdStatus').selectedIndex].value;
    param='kdStatus='+kdStatus+'&proses=getKegiatan';
    tujuan='bgt_unit_slave.php';
    post_response_text(tujuan, param, respog);
    function respog(){
		if(con.readyState==4){
