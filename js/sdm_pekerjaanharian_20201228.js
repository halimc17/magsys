...
function simpanData(){
	...
	if(tanggal=='' ||  pekerjaan=='' ||  target=='' ||  aktual==''){
		alert('All fields are required');
	}else{
		param='tanggal='+tanggal+'&pekerjaan='+pekerjaan+'&target='+target+'&aktual='+aktual+'&correction='+correction;
...
function fillfield(tanggal,pekerjaan,target,aktual,correction,rencanakerja,catatan,atasan,stspekerjaan){
