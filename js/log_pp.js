...
function searchVhc(title,content,nmr,ev){
    kdbrg=document.getElementById('kd_brg_'+nmr).value;
    if(kdbrg.substr(0,1)=='8'){
        width='500';
        height='400';
        showDialog1(title,content,width,height,ev);
    }else{
...
function setVhc(no_vhc)
{
         var nomor=document.getElementById('nomor').value;
        //alert(nomor);
         document.getElementById('kd_vhc_'+nomor).value=no_vhc;
         //document.getElementById('nm_angrn_'+nomor).value=no_angrn;
         closeDialog();
}
...
function addNewRow(body,onDetail) {
    ...
    if(!detail) {
        ...
        "<input id='nm_brg_"+numRow+"' type='text' class='myinputtext' style='width:120px' disabled='disabled' value='' /><img src=images/search.png class=dellicon title='"+jdl_ats_0+"' onclick=\"searchBrg('"+jdl_ats_1+"','"+content_0+"<input id=nomor type=hidden value="+numRow+" />',event)\";></td><td><input id='sat_"+numRow+"' type='text' class='myinputtext' style='width:70px'disabled='disabled' value='' /></td>"+
        "<td><input id='kd_angrn_"+numRow+"' type='text' class='myinputtext' style='width:70px' disabled='disabled' value='' /><input type=hidden id=oldKdbrg_"+numRow+" name=oldKdbrg_"+numRow+">"+
        "<img src=images/search.png class=dellicon title='"+jdl_bwh_0+"' onclick=\"searchAngrn('"+jdl_bwh_1+"','"+content_1+"<input id=nomor type=hidden value="+numRow+" />',event)\";>"+"<td><input id='kd_vhc_"+numRow+
        "' type='text' class='myinputtext' style='width:70px' disabled='disabled' value='' /><img src=images/search.png class=dellicon title='"+jdl_bwh_0+"' onclick=\"searchVhc('"+jdl_bwhv_1+"','"+contentv_1+"<input id=nomor type=hidden value="+numRow+" />','"+numRow+"',event)\";></td><td><input id='jmlhDiminta_"+numRow+"' type='text' class='myinputtextnumber' style='width:70px' value='' onkeypress='return angka_doang(event)' /></td>"+"<td><input type='text' style='width:70px' id='tgl_sdt_"+numRow+"' class='myinputtext' name='tgl_sdt_"+numRow+"' maxlength=\"10\" onmousemove=\"setCalendar(this.id)\" onkeypress=\"return false;\" ></td><td><input id='ket_"+numRow+"' type='text' class='myinputtext' style='width:130px' onkeypress='return tanpa_kutip(event)' value='' /></td>"+"<td><img id='detail_add_"+numRow+
...
function frm_ajun(nopp,stat)
 {//alert(nopp);
	...
	param='method=formPersetujuan'+'&rnopp='+nopp;
	//alert(param);
