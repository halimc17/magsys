...
function calculate(id,row,totRow)
{
    ...
    jmlh_brg=document.getElementById('qty_'+id+'_'+row).value;
                    ...
                    try{
                            if(strUrl != '')
                            {
								//	alert('test');
                                    ...
                                    +'&qty[]='+document.getElementById('qty_'+i+'_'+brs).value
...
{
    param='nomor='+nomor+'&nourut='+nourut+'&method=get_alasan_batal';
//    alert(param);
        ...
        if(con.readyState==4)
        {
            if (con.status == 200) {
                ...
                if (!isSaveResponse(con.responseText)) {
                    ...
                    ev='event';
                    title="Form Alasan Menang Tender";
                    showDialog1(title,content,width,height,ev);
//                    alert(con.responseText);
