                  ...
                  if(con.readyState==4)
                  {
                                if (con.status == 200) 
                                {
                                        ...
                                        else 
                                        {
												...
												document.getElementById('luas').value = dta[3];
...
{	
	...
	d = d/b;
	document.getElementById('total').value=d.toFixed(0);
...
function saveHead() {
	...
	param='thnbudget='+thnbudget+'&kdblok='+kdblok+'&bjr='+bjr+'&method=cek';
	//alert(param);
    tujuan='bgt_slave_prosuksi_kebun.php';
    post_response_text(tujuan, param, respog);
...
function fillField(tahunbudget,kodeblok,pokokproduktif,bjr,jjgperpkk,kgsetahun,jjg,luas)
{	
        document.getElementById('printContainer').style.display='block';
		...
		document.getElementById('totalKg').value= luas * jjgperpkk *1000;
