...
function simpanData(){
	...
	if(kodeorg=='' ||  kodeinv=='' ||  namainv=='' ||  kondisi==''){
		...
		param+='&addedit='+addedit+'&proses=saveData'+'&kodebrglama='+kodebrglama;
		tujuan='log_invbarang_slave.php';
		post_response_text(tujuan, param, respog);
	}
	function respog(){
...
function fillfield(kodeorg,kodebarang,kodeinv,namainv,merkinv,tipeinv,ketinv,ukuraninv,warnainv,bahaninv,tglbeli,hrgbeli,nopo,kodesupplier,nik,tgldiuser,kondisi,divisi,lokasi,ruangan){
...
function cariinventaris(type,ev){
	...
	if(type=='pdf'){
		...
		param='&carikodeorg='+carikodeorg+'&carinamainv='+carinamainv+'&carikaryawan='+carikaryawan+'&cariruangan='+cariruangan+'&type=excel';
