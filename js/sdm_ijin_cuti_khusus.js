...
function saveForm()
{
        ...
        param += "&darijam="+tglAwal.substr(6,4)+"-"+tglAwal.substr(3,2)+"-"+tglAwal.substr(0,2)+" "+jamDr+":00";
		//alert(tglAwal+'  '+"&darijam="+tglAwal.substr(6,4)+' '+jamDr+':00');
        if((jnsIjin=='CUTI' || jnsIjin=='MELAHIRKAN' || jnsIjin=='ALASANPENTING') && (hk=='0' || hk=='')){
            alert('Number of day(s) required');
        }else{
            tujuan='sdm_slave_ijin_cuti_khusus.php';
            //alert(param);
    //	return;
...
function jumlahhari(){
	...
	var jnsIjin=document.getElementById('jnsIjin').options[document.getElementById('jnsIjin').selectedIndex].value;
    var tglAwal=document.getElementById('tglAwal').value;
    var periodec=document.getElementById('periodec').value;
	var param="periodec="+periodec+"&tglAwal="+tglAwal+"&jnsIjin="+jnsIjin;
    post_response_text('sdm_slave_ijin_cuti_khusus.php?proses=jumlahhari', param, respon);     
    function respon() {
        if (con.readyState == 4) {
            if (con.status == 200) {
                busy_off();
                if (!isSaveResponse(con.responseText)) {
                    ...
                    //=== Success Response
					document.getElementById("tglEnd").value = con.responseText;
					if(jnsIjin=='MELAHIRKAN'){
						document.getElementById("jumlahhk").value = 90;
					}else if(jnsIjin=='MENIKAH'){
						document.getElementById("jumlahhk").value = 3;
					}else if(jnsIjin=='ANAKNIKAH'){
						document.getElementById("jumlahhk").value = 2;
					}else if(jnsIjin=='KAKAKNIKAH'){
						document.getElementById("jumlahhk").value = 1;
					}else if(jnsIjin=='ISTRILAHIR'){
						document.getElementById("jumlahhk").value = 2;
					}else if(jnsIjin=='KLGUTMMATI'){
						document.getElementById("jumlahhk").value = 2;
					}else if(jnsIjin=='SDRUTMMATI'){
						document.getElementById("jumlahhk").value = 2;
					}else if(jnsIjin=='1RMH_MATI'){
						document.getElementById("jumlahhk").value = 1;
					}else if(jnsIjin=='ANAKHITAN'){
						document.getElementById("jumlahhk").value = 2;
					}else if(jnsIjin=='BAPTIS'){
						document.getElementById("jumlahhk").value = 2;
					}else{
						document.getElementById("jumlahhk").value = 0;
					}
