...
function add_detail()
{
	...
	//alert(notran);
	param='noSpb='+nospb+'&kdDiv='+kdDiv+'&periode='+periode+'&tgl='+tgl+'&intex='+intex+'&pks='+pks;
...
function detailSpb()
{
	...
	NoUrut=document.getElementById('nourut').value;
	if((tgl=='')||(kdOrg=='')||(NoUrut=='')||(NoUrut==0000000)||(intex=='')||(pks==''))
	{
...
function fillField(nospb,tanggal,stat,period,statDt,intex,pks) 
{
