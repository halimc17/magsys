...
function getJmlBA(){
	...
	document.getElementById('ppnba').value=(jumlahkg*hargakg*0.1).toFixed(2);
	document.getElementById('pphba').value=(jumlahkg*hargakg*0.02).toFixed(2);
	document.getElementById('ttlharga').value=((jumlahkg*hargakg)+(jumlahkg*hargakg*0.1)-(jumlahkg*hargakg*0.02)).toFixed(2);
	getNo();
}
