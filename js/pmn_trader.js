...
function fillField(kdUnit,kdCust,nokontrakext,tanggalext,kdBrg,jmlExt,hrgExt,nilaiExt,ppnExt,catatan,nokontrakpembanding,uangmuka,franco,ffa,dobi,mdani,moist,dirt){
    ...
    document.getElementById('franco').value=franco;
    document.getElementById('ffa').value=ffa;
    document.getElementById('dobi').value=dobi;
    document.getElementById('mdani').value=mdani;
    document.getElementById('moist').value=moist;
