...
function batal(){
	document.getElementById("jenissp").selectedIndex = "0";
	document.getElementById("jenissp").disabled = false;
	memotypeChange();
	document.getElementById("lokasitugas").selectedIndex = "0";
                ...
                if (con.readyState == 4) {
                        if (con.status == 200) {
                                ...
                                if (!isSaveResponse(con.responseText)) {
										...
										if(typeof cancel!='undefined' && cancel) batal();
                                }
                        }
                        else {
                                busy_off();
...
{
		jenis_sp=document.getElementById('jenissp');
		for(ard=0;ard<jenis_sp.length;ard++)
		{
			if(jenis_sp.options[ard].value==jenissp)
				{
					jenis_sp.options[ard].selected=true;
				}
		}
		memotypeChange();
...
function memotypeChange(){
	...
	if(jenissp=='BAPP'){
		document.getElementById('tdDistujui').style.display='';
		document.getElementById('tdDistujui2').style.display='';
		document.getElementById('tdDistujui3').style.display='';
		document.getElementById('tdDistujui4').style.display='';
		document.getElementById('tdDiketahui').style.display='';
		document.getElementById('tdDiketahui2').style.display='';
		document.getElementById('tdDiketahui3').style.display='';
		document.getElementById('tdDiketahui4').style.display='';
		document.getElementById('tdDibuat').style.display='none';
		document.getElementById('tdDibuat2').style.display='none';
		document.getElementById('tdDibuat3').style.display='none';
		document.getElementById('tdDibuat4').style.display='none';
	}else if(jenissp=='PHK'){
		document.getElementById('tdDistujui').style.display='';
		document.getElementById('tdDistujui2').style.display='';
		document.getElementById('tdDistujui3').style.display='';
		document.getElementById('tdDistujui4').style.display='';
		document.getElementById('tdDiketahui').style.display='none';
		document.getElementById('tdDiketahui2').style.display='none';
		document.getElementById('tdDiketahui3').style.display='none';
		document.getElementById('tdDiketahui4').style.display='none';
		document.getElementById('tdDibuat').style.display='none';
		document.getElementById('tdDibuat2').style.display='none';
		document.getElementById('tdDibuat3').style.display='none';
		document.getElementById('tdDibuat4').style.display='none';
		...
		document.getElementById('tdDibuat3').style.display='none';
		document.getElementById('tdDibuat4').style.display='none';
	}else if(jenissp=='SP1' || jenissp=='SP2' || jenissp=='SP3'){
		document.getElementById('tdDistujui').style.display='';
		document.getElementById('tdDistujui2').style.display='';
		document.getElementById('tdDistujui3').style.display='';
		document.getElementById('tdDistujui4').style.display='';
		...
		document.getElementById('tdDiketahui3').style.display='';
		document.getElementById('tdDiketahui4').style.display='';
		document.getElementById('tdDibuat').style.display='';
		document.getElementById('tdDibuat2').style.display='';
		document.getElementById('tdDibuat3').style.display='';
		document.getElementById('tdDibuat4').style.display='';
	}
		...
		if (con.readyState == 4) {
			if (con.status == 200) {
				...
				if (!isSaveResponse(con.responseText)) {
					...
					document.getElementById('pelanggaran').value=isis[0];
					document.getElementById('paragraf1').value=isis[1];
					document.getElementById('paragraf3').value=isis[2];
					document.getElementById('paragraf4').value=isis[3];
					document.getElementById('labelPersetujuan1').innerHTML=isis[4];
					document.getElementById('labelPersetujuan2').innerHTML=isis[5];
					document.getElementById('labelPersetujuan3').innerHTML=isis[6];
					document.getElementById('txt1').innerHTML=isis[7];
					document.getElementById('txt2').innerHTML=isis[8];
					document.getElementById('txt3').innerHTML=isis[9];
					document.getElementById('txt4').innerHTML=isis[10];
				}
			}
			else {
				busy_off();
