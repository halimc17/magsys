...
function cancelSave()
{
	...
	if(prose=='insert')
	{
		...
		thntnm=document.getElementById('thnTnm').options[document.getElementById('thnTnm').selectedIndex].value;
...
function saveData()
{
	...
	if(prose=='update')
	{
		...
		param='periode='+prode+'&idKbn='+idkbn+'&thnTnm='+thntnm+'&jnsPpk='+jndppk+'&dosis='+dsis+'&jnsBibit='+jnsbibit;
