...
function getPajak(){
	...
	if(stsppn=='0'){
		...
		document.getElementById('harga').value=(harga/1.11).toFixed(2);
		document.getElementById('nilaiinvoice').value=(nilaiinvoice/1.11).toFixed(2);
		document.getElementById('nilaippn').value=((nilaiinvoice/1.11)*0.11).toFixed(2);
	}else{
		document.getElementById('harga').value=harga.toFixed(2);
		document.getElementById('nilaiinvoice').value=nilaiinvoice.toFixed(2);
		document.getElementById('nilaippn').value=(nilaiinvoice*0.11).toFixed(2);
