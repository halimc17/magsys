...
function balikin(nopp,kdbrgbalik,nmbrgbalik)
{
     
        tujuan='log_slave_save_verivikasi.php';
        param="nopp="+nopp+'&kdbrgbalik='+kdbrgbalik+'&nmbrgbalik='+nmbrgbalik+"&method=balikin";
        if(confirm("Anda yakin akan mengembalikan kepada persetujuan ke-3 ??"))
...
function getSatuanKonversi(satuan,kdBrgSatuan,nourut)
{
	...
	param='method=getValueKonversi'+'&satuan='+satuan+'&kdBrgSatuan='+kdBrgSatuan+'&jmlh_realisai='+jmlh_realisai+'&nourut='+nourut+'&hjmlh_realisai='+hjmlh_realisai;
    tujuan='log_slave_save_verivikasi.php';
    post_response_text(tujuan, param, respog);
    function respog()
    {
