...
function simpanData(){
	...
	if(kodeorg=='' || stasiun=='' || mesin=='' || jamganti1=='' || jamganti1==0 || jamganti1==null || jamganti2=='' || jamganti2==0 || jamganti2==null){
		alert('All fields are required');
	}else{
		param='kodeorg='+kodeorg+'&stasiun='+stasiun+'&mesin='+mesin+'&jamganti1='+jamganti1+'&jamganti2='+jamganti2+'&hmakhir='+hmakhir;
...
function fillfield(mesin,jamganti1,jamganti2,hmakhir,keterangan){
