...
{	
        ...
        for(i=1;i<=12;i++)
        {
                ...
                document.getElementById('brt_x'+i).value=d;
        }
}

function hitung() {
	var brt_x1=document.getElementById('brt_x1').value,
		...
		kgtbs = getById('kgtbs');
	kgtbs.value = parseFloat(brt_x1) + parseFloat(brt_x2) + parseFloat(brt_x3) + parseFloat(brt_x4) +
		parseFloat(brt_x5) + parseFloat(brt_x6) + parseFloat(brt_x7) + parseFloat(brt_x8) +
		parseFloat(brt_x9) + parseFloat(brt_x10) + parseFloat(brt_x11) + parseFloat(brt_x12);
}
