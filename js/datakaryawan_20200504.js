...
function simpanKeluarga()
{
 ...
 else
 {
        ...
        param+='&keluargapendidikan='+keluargapendidikan+'&keluargatanggungan='+keluargatanggungan+'&keluargaemplasment='+keluargaemplasment;
...
function fillField(nama,jeniskelamin,tempatlahir,tanggallahir,hubungankeluarga,status,levelpendidikan,pekerjaan,telp,email,tanggungan,emplasment,nomor)
{
