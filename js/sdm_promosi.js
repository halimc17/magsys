...
function parseDong(tex)
{
	...
	// Gaji
	gaji1=xmlobject.getElementsByTagName('gaji1')[0].firstChild.nodeValue;
     	gaji1=gaji1.replace("*","");
	gaji2=xmlobject.getElementsByTagName('gaji2')[0].firstChild.nodeValue;
     	gaji2=gaji2.replace("*","");
	...
	setValue('oldgaji',gaji1);
	setValue('tjjabatan',gaji2);
}
 ...
 */
	...
	if (tipetransaksi == '' || karyawanid == '' || tanggalsk == '' || tanggalberlaku == '' || penandatangan == '') {
			...
			param += '&oldgolongan=' + oldgolongan + '&newlokasitugas=' + newlokasitugas;
			...
			param += '&tembusan5=' + tembusan5+'&atasanbaru='+atasanbaru;
                        param += '&paragraf1='+paragraf1+'&paragraf2='+paragraf2;
