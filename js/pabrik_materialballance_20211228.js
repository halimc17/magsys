...
function hitung_ur(){
	...
	if(berattbs_ur2<tbsrebus_ur2){
		alert('TBS Rebus tidak boleh lebih besar dari Berat TBS...!');
		exit;
	}
	if(berattbs_ur2>0 && berattbs_ur2>tbsrebus_ur2){
		...
		totaltbs_ur2=document.getElementById('condensate_ur2').value+document.getElementById('brondolluar_ur2').value+document.getElementById('brondoldalam_ur2').value+document.getElementById('abn_ur2').value+document.getElementById('calix_ur2').value+document.getElementById('jangkos_ur2').value;
		document.getElementById('totaltbs_ur5').value=(totaltbs_ur2/berattbs_ur2*100).toFixed(2);
		document.getElementById('sampel_ur2').value=document.getElementById('brondolluar_ur2').value+document.getElementById('brondoldalam_ur2').value;
		document.getElementById('sampel_ur5').value=(document.getElementById('sampel_ur2').value/berattbs_ur2*100).toFixed(2);

		document.getElementById('evaporation_ur2').value=document.getElementById('brondolan_ur2').value-document.getElementById('brondoldry_ur2').value;
		...
		document.getElementById('evaporation_ur5').value=(document.getElementById('sampel_ur5').value*document.getElementById('evaporation_ur4').value/100).toFixed(2);
		document.getElementById('fiber_ur2').value=document.getElementById('brondoldry_ur2').value-document.getElementById('nut_ur2').value;
		...
		document.getElementById('fiber_ur5').value=(document.getElementById('sampel_ur5').value*document.getElementById('fiber_ur4').value/100).toFixed(2);
		...
		document.getElementById('nut_ur5').value=(document.getElementById('sampel_ur5').value*document.getElementById('nut_ur4').value/100).toFixed(2);
		...
		document.getElementById('shell_ur5').value=(document.getElementById('sampel_ur5').value*document.getElementById('shell_ur4').value/100).toFixed(2);
		...
		document.getElementById('kernel_ur5').value=(document.getElementById('sampel_ur5').value*document.getElementById('kernel_ur4').value/100).toFixed(2);
		...
		document.getElementById('kerneldry_ur5').value=(document.getElementById('sampel_ur5').value*document.getElementById('kerneldry_ur4').value/100).toFixed(2);
		...
		document.getElementById('oilinfiber_ur5').value=(document.getElementById('sampel_ur5').value*document.getElementById('oilinfiber_ur4').value/100).toFixed(2);
		...
		document.getElementById('oilinshell_ur5').value=(document.getElementById('sampel_ur5').value*document.getElementById('oilinshell_ur4').value/100).toFixed(2);
		document.getElementById('totaloil_ur2').value=document.getElementById('oilinfiber_ur2').value+document.getElementById('oilinshell_ur2').value;
		...
		document.getElementById('totaloil_ur5').value=(document.getElementById('sampel_ur5').value*document.getElementById('totaloil_ur4').value/100).toFixed(2);
		...
		document.getElementById('hasil_ur2').value=(document.getElementById('brondolan_ur2').value/document.getElementById('sampel_ur5').value*100).toFixed(4);
	}
}
...
function hitung_nr(){
	...
	if(berattbs_nr2>0 && berattbs_nr2>tbsrebus_nr2){
		...
		totaltbs_nr2=document.getElementById('condensate_nr2').value+document.getElementById('brondolluar_nr2').value+document.getElementById('brondoldalam_nr2').value+document.getElementById('abn_nr2').value+document.getElementById('calix_nr2').value+document.getElementById('jangkos_nr2').value;
		document.getElementById('totaltbs_nr5').value=(totaltbs_nr2/berattbs_nr2*100).toFixed(2);
		document.getElementById('sampel_nr2').value=document.getElementById('brondolluar_nr2').value+document.getElementById('brondoldalam_nr2').value;
		document.getElementById('sampel_nr5').value=(document.getElementById('sampel_nr2').value/berattbs_nr2*100).toFixed(2);

		document.getElementById('evaporation_nr2').value=document.getElementById('brondolan_nr2').value-document.getElementById('brondoldry_nr2').value;
		...
		document.getElementById('evaporation_nr5').value=(document.getElementById('sampel_nr5').value*document.getElementById('evaporation_nr4').value/100).toFixed(2);
		document.getElementById('fiber_nr2').value=document.getElementById('brondoldry_nr2').value-document.getElementById('nut_nr2').value;
		...
		document.getElementById('fiber_nr5').value=(document.getElementById('sampel_nr5').value*document.getElementById('fiber_nr4').value/100).toFixed(2);
		...
		document.getElementById('nut_nr5').value=(document.getElementById('sampel_nr5').value*document.getElementById('nut_nr4').value/100).toFixed(2);
		...
		document.getElementById('shell_nr5').value=(document.getElementById('sampel_nr5').value*document.getElementById('shell_nr4').value/100).toFixed(2);
		...
		document.getElementById('kernel_nr5').value=(document.getElementById('sampel_nr5').value*document.getElementById('kernel_nr4').value/100).toFixed(2);
		...
		document.getElementById('kerneldry_nr5').value=(document.getElementById('sampel_nr5').value*document.getElementById('kerneldry_nr4').value/100).toFixed(2);
		...
		document.getElementById('oilinfiber_nr5').value=(document.getElementById('sampel_nr5').value*document.getElementById('oilinfiber_nr4').value/100).toFixed(2);
		...
		document.getElementById('oilinshell_nr5').value=(document.getElementById('sampel_nr5').value*document.getElementById('oilinshell_nr4').value/100).toFixed(2);
		document.getElementById('totaloil_nr2').value=document.getElementById('oilinfiber_nr2').value+document.getElementById('oilinshell_nr2').value;
		...
		document.getElementById('totaloil_nr5').value=(document.getElementById('sampel_nr5').value*document.getElementById('totaloil_nr4').value/100).toFixed(2);
		...
		document.getElementById('hasil_nr2').value=(document.getElementById('brondolan_nr2').value/document.getElementById('sampel_nr5').value*100).toFixed(4);
	}
}
...
function hitung_or(){
	...
	if(berattbs_or2>0 && berattbs_or2>tbsrebus_or2){
		...
		totaltbs_or2=document.getElementById('condensate_or2').value+document.getElementById('brondolluar_or2').value+document.getElementById('brondoldalam_or2').value+document.getElementById('abn_or2').value+document.getElementById('calix_or2').value+document.getElementById('jangkos_or2').value;
		document.getElementById('totaltbs_or5').value=(totaltbs_or2/berattbs_or2*100).toFixed(2);
		document.getElementById('sampel_or2').value=document.getElementById('brondolluar_or2').value+document.getElementById('brondoldalam_or2').value;
		document.getElementById('sampel_or5').value=(document.getElementById('sampel_or2').value/berattbs_or2*100).toFixed(2);

		document.getElementById('evaporation_or2').value=document.getElementById('brondolan_or2').value-document.getElementById('brondoldry_or2').value;
		...
		document.getElementById('evaporation_or5').value=(document.getElementById('sampel_or5').value*document.getElementById('evaporation_or4').value/100).toFixed(2);
		document.getElementById('fiber_or2').value=document.getElementById('brondoldry_or2').value-document.getElementById('nut_or2').value;
		...
		document.getElementById('fiber_or5').value=(document.getElementById('sampel_or5').value*document.getElementById('fiber_or4').value/100).toFixed(2);
		...
		document.getElementById('nut_or5').value=(document.getElementById('sampel_or5').value*document.getElementById('nut_or4').value/100).toFixed(2);
		...
		document.getElementById('shell_or5').value=(document.getElementById('sampel_or5').value*document.getElementById('shell_or4').value/100).toFixed(2);
		...
		document.getElementById('kernel_or5').value=(document.getElementById('sampel_or5').value*document.getElementById('kernel_or4').value/100).toFixed(2);
		...
		document.getElementById('kerneldry_or5').value=(document.getElementById('sampel_or5').value*document.getElementById('kerneldry_or4').value/100).toFixed(2);
		...
		document.getElementById('oilinfiber_or5').value=(document.getElementById('sampel_or5').value*document.getElementById('oilinfiber_or4').value/100).toFixed(2);
		...
		document.getElementById('oilinshell_or5').value=(document.getElementById('sampel_or5').value*document.getElementById('oilinshell_or4').value/100).toFixed(2);
		document.getElementById('totaloil_or2').value=document.getElementById('oilinfiber_or2').value+document.getElementById('oilinshell_or2').value;
		...
		document.getElementById('totaloil_or5').value=(document.getElementById('sampel_or5').value*document.getElementById('totaloil_or4').value/100).toFixed(2);
		...
		document.getElementById('hasil_or2').value=(document.getElementById('brondolan_or2').value/document.getElementById('sampel_or5').value*100).toFixed(4);
	}
}

function showDetail(kodeorg,kodeblok,tanggal,ev){
	title="Data Detail";
	content="<fieldset><legend>Unit : "+kodeorg+", Blok : "+kodeblok+", Date : "+tanggal+"</legend><div id=contDetail style='overflow:auto; width:890px; height:320px;' ></div></fieldset>";
	width='920';
	height='370';
	showDialog1(title,content,width,height,ev);	
}

function previewDetail(kodeorg,kodeblok,tanggal,ev){
	//showDetail(kodeorg,kodeblok,tanggal,ev);
	param='kodeorg='+kodeorg+'&kodeblok='+kodeblok+'&tanggal='+tanggal+'&method=previewDetail';
	tujuan='pabrik_materialballance_slave.php';
	post_response_text(tujuan, param, respog);
