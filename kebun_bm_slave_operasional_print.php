		...
		class PDF extends FPDF
				{
					function Header() {
						...
						{
						    $this->Cell((20/100*$width)-5,$height,$_SESSION['lang']['kegiatan'].' '.$_SESSION['lang']['bongkarmuat'],'',0,'L');	
						}
						...
						{
						   $this->Cell($width,$height,strtoupper($_SESSION['lang']['kegiatan'].' '.$_SESSION['lang']['bongkarmuat']),'',0,'C');
						}
						$this->Ln();
