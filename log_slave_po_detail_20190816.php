...
if($_POST['proses']=='listPp')
{
	...
	$sql2="select * from  ".$dbname.".log_sudahpo_vsrealisasi_vw  where (kodept='".$_POST['kodept']."' and 
        lokalpusat='0' and status!='3') and (selisih>0 or selisih is null) order by tgl_sdt";
    }
    else
    {
        $sql2="select * from  ".$dbname.".log_sudahpo_vsrealisasi_vw  where (kodept='".$_POST['kodept']."' and 
               purchaser='".$user_id."' and lokalpusat='0' and status!='3') and (selisih>0 or selisih is null)
               order by tgl_sdt";
    }
