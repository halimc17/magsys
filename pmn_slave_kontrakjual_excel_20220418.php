...
switch($proses)
{
    ...
    case'excel':
        ...
        <tr>
            ...
            <td>:</td>
            <td  colspan=5>".$optMtSim[$bar['matauang']]." ".number_format($bar['hargasatuan'],2)." (".$arrStatPPn[$bar['ppn']]." PPn 11%)</td>
        </tr>
        <tr>
            <td colspan=3></td>
        ...
        <tr>
            ...
            <td>:</td>
            <td colspan=5>".$optMtSim[$bar['matauang']]." ".number_format($nilKontrak,0)." (".$arrStatPPn[$bar['ppn']]." PPn 11%)</td>
        </tr>
        <tr>
            <td  colspan=3></td>
