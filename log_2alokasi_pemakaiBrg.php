...
<tr><td><label><?php echo $_SESSION['lang']['periode']?></label></td><td><select id="periode" name="periode" style="width:150px"><option value=''><?php echo $_SESSION['lang']['pilihdata']?></option></select></td></tr>
