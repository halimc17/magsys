			...
			if($tutupbuku==0){
				...
				if(mysql_query($str)){
					if($d['tanggalext']>='2023-01-01'){
						...
						$strjrnd2="insert into ".$dbname.".keu_jurnaldt (nojurnal,tanggal,nourut,noakun,keterangan,jumlah,matauang,kurs,kodeorg,kodebarang,kodecustomer,noreferensi,nodok,revisi,kodesegment) values ('".$nojurnal."','".$d['tanggal']."','2','1180101','Pembelian ".$d['namabarang']." ".$d['beratbersih']." ".$d['satuan']."'
						,'".($d['jmlharga']*-1)."','IDR','1','".$kdorg."','".$d['kodebarang']."','".$d['kodecustomer']."','".$d['nokontrakext']."','".$d['nokontrakext']."','0','1')";
