...
echo"  <fieldset><legend>Form</legend>
                     <div id=uForm>
                     	<span id=sample><b>Upload Data Karyawan</b> <a href=tool_slave_getExample.php?form=DATAKARYAWAN target=frame>Click here for template</a></span><br><br>
                                        ...
                                        <input type=hidden name=jenisdata id=jenisdata value='DATAKARYAWAN'>
                                        ...
                                        <input type=button class=mybutton name=simpan  value=".$_SESSION['lang']['save']." title='Submit this File' onclick=submitFile()>
                                    </form>
