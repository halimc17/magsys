				...
				<td valign=top>  
					<table>
						...
						<tr>
							...
							<td><select id=mesin onchange=getHM()>".$optMesin."</select></td>
						</tr>
						<tr> 
							...
							<td> 
								<table>
									<tr>
										...
										<td><select id=tipeservice name=tipeservice onchange=getEnable()>
												<option value='0'>Tidak Service</option>
												<option value='1'>Pergantian Sparepart1 (Worm/Chain/Oli)</option>
												<option value='2'>Intermediate/Top Overhaul/Sparepart2 (Bearing Depan/Press Cake)</option>
												<option value='3'>Major/General Overhaul/Sparepart3 (Bearing Belakang)</option>
											</select>
										</td>
									</tr>
									<tr>
		...
		<table class=sortable cellspacing=1 border=0 width=100%>
			<thead>
				<tr class=rowheader>
					...
					<td width='5%' align=center>Intermed/ Top.OH/ Sparepart2</td>
					<td width='5%' align=center>Major/ Gen.OH/ Sparepart3</td>
