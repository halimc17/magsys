...
<div id="form_po" style="display:none;">
    ...
    {
        $sql="select namasupplier,supplierid,kota,kodekelompok from ".$dbname.".log_5supplier  where kodekelompok in ('S001','S002','S005') and status=1 order by namasupplier asc";    
    }
    else
    {
        $sql="select namasupplier,supplierid,kota,kodekelompok from ".$dbname.".log_5supplier  where kodekelompok in ('S001') and status=1 order by namasupplier asc";    
    ...
    {
       $optSupplier.="<option value='".$res['supplierid']."'>".$res['namasupplier']." - ".$res['kota']."</option>";
    }
		...
		$klq="select namakaryawan,karyawanid,bagian,lokasitugas,kodejabatan from ".$dbname.".`datakaryawan` where
            ...
            karyawanid!='".$user_id."' and lokasitugas!='' and (kodejabatan=5 or kodejabatan=173 or kodejabatan=174 or kodejabatan=175 or kodejabatan=176 or kodejabatan=261 or kodejabatan=309)
