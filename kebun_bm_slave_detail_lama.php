...
switch($proses) {
    case 'showDetail':
		...
		if($libur==false){
			...
			if($regional!='KALTIM')$theForm2->_elements[6]->_attr['disabled'] = 'disabled';
		} else {
		...
		}else $theForm2->_elements[7]->_attr['disabled'] = 'disabled';
		...
		}else $theForm2->_elements[8]->_attr['disabled'] = 'disabled';
