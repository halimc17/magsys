...
$sAkun="select  id,name from ".$dbname.".sdm_ho_component where plus=0 and id not in ('34','37','41') order by name";
...
<fieldset style='width:320px;float:left'>
	<table>
		<tr>
			<td>Component ".$_SESSION['lang']['potongan']."</td>
			<td><select id=potongan style=width:150px>".$optKomponen."</select></td>
		</tr>
		<tr>
			<td>".$_SESSION['lang']['debet']."</td>
			<td><select id=debet style=width:150px>".$optAkun."</select></td>
		</tr>
		<tr>
			<td>".$_SESSION['lang']['kredit']."</td>
			<td><select id=kredit style=width:150px>".$optAkun."</select></td>
		</tr>        
	</table>
        ...
        <table class=sortable cellspacing=1 border=0>
             <thead>
                 <tr class=rowheader>
                    ...
                    <td>".$_SESSION['lang']['debet']."</td>
                    <td>".$_SESSION['lang']['kredit']."</td>                     
                    <td style='width:30px;' colspan=2>".$_SESSION['lang']['action']."</td></tr>
                 </thead>
                 <tbody id=container>"; 
