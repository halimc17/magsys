...
$frm[2].="<table class=sortable border=0 cellspacing=1><thead></thead>
                        <tbody>
                         ...
                         <tr class=rowcontent><td>".$_SESSION['lang']['nilaipremi']." ".$_SESSION['lang']['keraniafdeling']."</td><td align=right><input type=text id=premiKerani class=myinputtextnumber maxlength=10 onkyepress=\"return angka_doang(event)\"></td></tr>    
              </tbody></table>
...
$frm[3].="<table class=sortable border=0 cellspacing=1><thead></thead>
                        <tbody>                         
                         ...
                         <tr class=rowcontent><td>".$_SESSION['lang']['nilaipremi']." ".$_SESSION['lang']['keraniproduksi']."</td><td align=right><input type=text id=premiKeraniPanen class=myinputtextnumber maxlength=10 onkyepress=\"return angka_doang(event)\"></td></tr>    
              </tbody></table>
