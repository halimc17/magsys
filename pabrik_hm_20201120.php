								...
								<table>
									<tr>
										...
										<td><select id=tipeservice name=tipeservice onchange=getEnable()>
												...
												<option value='1'>Pergantian Sparepart</option>
												<option value='2'>Intermediate/Top Overhaul</option>
												<option value='3'>Major/General Overhaul</option>
											</select>
										</td>
									</tr>
									<tr>
		...
		<table class=sortable cellspacing=1 border=0 width=100%>
			<thead>
				<tr class=rowheader>
					...
					<td width='5%' align=center>Pergantian Sparepart</td>
					<td width='5%' align=center>Intermed/ Top.OH</td>
