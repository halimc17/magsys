    ...
    while($res=mysql_fetch_assoc($query))
    {
       $optSupplier.="<option value='".$res['supplierid']."'>".$res['namasupplier']."</option>";
		...
		$klq="select namakaryawan,karyawanid,bagian,lokasitugas,kodejabatan from ".$dbname.".`datakaryawan` 
			...
			and (kodejabatan<6 or kodejabatan=29 or kodejabatan=117 or kodejabatan=119 or kodejabatan=146 or kodejabatan=150 or kodejabatan=156 or kodejabatan=160 or kodejabatan=177 or kodejabatan=200 or kodejabatan=207 or kodejabatan=280 or kodejabatan=343 or kodejabatan=348  or kodejabatan=125) 
