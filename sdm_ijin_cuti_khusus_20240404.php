...
OPEN_BOX('',"<b>".$_SESSION['lang']['izinkntor']."/".$_SESSION['lang']['cuti'].($_SESSION['language']=='ENG' ? " Special" : " Khusus")."</b>");
?>
...
<script type="application/javascript" src="js/sdm_ijin_cuti_khusus.js"></script>
...
<td>:</td>
<td><select id="jnsIjin" name="jnsIjin" onchange='jumlahhari()' style="width:150px"><?php echo $optJenis;?></select></td>
</tr>
...
<td>:</td>
<td><input type='text' class='myinputtext' id='tglEnd' onmousemove='setCalendar(this.id)' onkeypress='return false;'  size='10' maxlength='10' disabled style="width:150px;" /><select id="jam2" disabled><?php echo $jm;?></select>:<select id="mnt2" disabled><?php echo $mnt;?></select></td>
</tr>
<tr>
