...
#        }        
        ...
        if($_POST['afdeling']=='')
        {
            $whereOrg="where kodeorg like '".$_POST['kodeorg']."%'";
        }
        else
        {
		...
		### ambil luas perdiv
		$aLuas="select sum(luasareaproduktif) as luasdivisi from ".$dbname.".setup_blok ".$whereOrg." ";
        ...
        $str="select luasareaproduktif,kodeorg,statusblok from ".$dbname.".setup_blok ".$whereOrg." ";
        //exit("Error:$str");
        $res=mysql_query($str);
    ...
    case 'simpanIDC':
        ...
        $iCek="select count(*) as jumlah,noreferensi from ".$dbname.".keu_jurnalht where noreferensi='".$_POST['nokas']."' ";
		...
		#ambil blok TBM,TB,LC
        $str="select kodeorg,statusblok,luasareaproduktif from ".$dbname.".setup_blok ".$whereOrg." ";
        $res=mysql_query($str);
        $jumblok=mysql_num_rows($res);
        if($jumblok<1)
        {
