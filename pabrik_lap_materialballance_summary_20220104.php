<?php
			...
			if($xdiv==$xkddiv){
				foreach($xkdblok as $xblok){
			        ...
			        for ($xbln=1; $xbln<=12; $xbln++){
						...
						$stream.="<td ".$fontcolor0." align='right'>".number_format($ttoer_tt[$xbln][$xblok],2)."</td>";
					}
				    for ($xbln=1; $xbln<=12; $xbln++){
						$fontcolor0=($ttker_tt[$xbln][$xblok]==0 ? " style='color:#e0ecfc' " : "");
						$stream.="<td ".$fontcolor0." align='right'>".number_format($ttker_tt[$xbln][$xblok],2)."</td>";
					}
					$stream.="</tr>";
				}
			}
	...
	for ($xbln=1; $xbln<=12; $xbln++){
		...
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format(array_sum($ttoil_tt[$xbln])/array_sum($tthasil_tt[$xbln])*100,2)."</td>";
	}
	for ($xbln=1; $xbln<=12; $xbln++){
		$fontcolor0=(array_sum($ttkernel_tt[$xbln])/array_sum($tthasil_tt[$xbln])*100==0 ? " style='color:$ttbgcolor' " : "");
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format(array_sum($ttkernel_tt[$xbln])/array_sum($tthasil_tt[$xbln])*100,2)."</td>";
	}
	$stream.="</tr>";
	$ttbgcolor="#ffbb99";
	$stream.="<tr class=rowcontent>
	...
	for ($xbln=1; $xbln<=12; $xbln++){
		...
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format(array_sum($stoil_tt[$xbln]['I'])/array_sum($sthasil_tt[$xbln]['I'])*100,2)."</td>";
	}
	for ($xbln=1; $xbln<=12; $xbln++){
		$fontcolor0=(array_sum($stkernel_tt[$xbln]['I'])/array_sum($sthasil_tt[$xbln]['I'])*100==0 ? " style='color:$ttbgcolor' " : "");
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format(array_sum($stkernel_tt[$xbln]['I'])/array_sum($sthasil_tt[$xbln]['I'])*100,2)."</td>";
	}
	$stream.="</tr>";
	...
	foreach($unit as $xorg){
        ...
        for ($xbln=1; $xbln<=12; $xbln++){
			...
			$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format(array_sum($gtoil_tt[$xbln][$xorg])/array_sum($gthasil_tt[$xbln][$xorg])*100,2)."</td>";
		}
        for ($xbln=1; $xbln<=12; $xbln++){
			$fontcolor0=(array_sum($gtkernel_tt[$xbln][$xorg])/array_sum($gthasil_tt[$xbln][$xorg])*100==0 ? " style='color:$ttbgcolor' " : "");
			$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format(array_sum($gtkernel_tt[$xbln][$xorg])/array_sum($gthasil_tt[$xbln][$xorg])*100,2)."</td>";
		}
		$stream.="</tr>";
	}
	$ttbgcolor="#ffbb99";
	...
	foreach($divisi as $xdiv){
		...
		foreach($xkodeblok[$xdiv] as $xblok){
	        ...
	        for ($xbln=1; $xbln<=12; $xbln++){
				...
				$stream.="<td ".$fontcolor0." align='right'>".number_format($ttoer_ur[$xbln][$xblok],2)."</td>";
			}
		    for ($xbln=1; $xbln<=12; $xbln++){
				$fontcolor0=($ttker_tt[$xbln][$xblok]==0 ? " style='color:#e0ecfc' " : "");
				$stream.="<td ".$fontcolor0." align='right'>".number_format($ttker_ur[$xbln][$xblok],2)."</td>";
			}
			$stream.="</tr>";
		}
		if($ada==0){
	...
	for ($xbln=1; $xbln<=12; $xbln++){
		...
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format(array_sum($ttoil_ur[$xbln])/array_sum($tthasil_ur[$xbln])*100,2)."</td>";
	}
	for ($xbln=1; $xbln<=12; $xbln++){
		$fontcolor0=(array_sum($ttkernel_ur[$xbln])/array_sum($tthasil_ur[$xbln])*100==0 ? " style='color:$ttbgcolor' " : "");
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format(array_sum($ttkernel_ur[$xbln])/array_sum($tthasil_ur[$xbln])*100,2)."</td>";
	}
	$stream.="</tr>";
	$ttbgcolor="#ffbb99";
	$stream.="<tr class=rowcontent>
	...
	for ($xbln=1; $xbln<=12; $xbln++){
		...
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format(array_sum($stoil_ur[$xbln]['I'])/array_sum($sthasil_ur[$xbln]['I'])*100,2)."</td>";
	}
	for ($xbln=1; $xbln<=12; $xbln++){
		$fontcolor0=(array_sum($stkernel_ur[$xbln]['I'])/array_sum($sthasil_ur[$xbln]['I'])*100==0 ? " style='color:$ttbgcolor' " : "");
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format(array_sum($stkernel_ur[$xbln]['I'])/array_sum($sthasil_ur[$xbln]['I'])*100,2)."</td>";
	}
	$stream.="</tr>";
	$wrn = array("bb", "cc", "dd", "ee", "ff", "ff", "ff", "ff", "ff", "ff", "ff", "ff", "ff"); 
	$no=0;
	foreach($unit as $xorg){
        ...
        for ($xbln=1; $xbln<=12; $xbln++){
			...
			$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format(array_sum($gtoil_ur[$xbln][$xorg])/array_sum($gthasil_ur[$xbln][$xorg])*100,2)."</td>";
		}
        for ($xbln=1; $xbln<=12; $xbln++){
			$fontcolor0=(array_sum($gtkernel_ur[$xbln][$xorg])/array_sum($gthasil_ur[$xbln][$xorg])*100==0 ? " style='color:$ttbgcolor' " : "");
			$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format(array_sum($gtkernel_ur[$xbln][$xorg])/array_sum($gthasil_ur[$xbln][$xorg])*100,2)."</td>";
		}
		$stream.="</tr>";
	}
	$ttbgcolor="#ffbb99";
	...
	foreach($divisi as $xdiv){
		...
		foreach($xkodeblok[$xdiv] as $xblok){
	        ...
	        for ($xbln=1; $xbln<=12; $xbln++){
				...
				$stream.="<td ".$fontcolor0." align='right'>".number_format($ttoer_nr[$xbln][$xblok],2)."</td>";
			}
		    for ($xbln=1; $xbln<=12; $xbln++){
				$fontcolor0=($ttker_tt[$xbln][$xblok]==0 ? " style='color:#e0ecfc' " : "");
				$stream.="<td ".$fontcolor0." align='right'>".number_format($ttker_nr[$xbln][$xblok],2)."</td>";
			}
			$stream.="</tr>";
		}
		if($ada==0){
	...
	for ($xbln=1; $xbln<=12; $xbln++){
		...
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format(array_sum($ttoil_nr[$xbln])/array_sum($tthasil_nr[$xbln])*100,2)."</td>";
	}
	for ($xbln=1; $xbln<=12; $xbln++){
		$fontcolor0=(array_sum($ttkernel_nr[$xbln])/array_sum($tthasil_nr[$xbln])*100==0 ? " style='color:$ttbgcolor' " : "");
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format(array_sum($ttkernel_nr[$xbln])/array_sum($tthasil_nr[$xbln])*100,2)."</td>";
	}
	$stream.="</tr>";
	$ttbgcolor="#ffbb99";
	$stream.="<tr class=rowcontent>
	...
	for ($xbln=1; $xbln<=12; $xbln++){
		...
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format(array_sum($stoil_nr[$xbln]['I'])/array_sum($sthasil_nr[$xbln]['I'])*100,2)."</td>";
	}
	for ($xbln=1; $xbln<=12; $xbln++){
		$fontcolor0=(array_sum($stkernel_nr[$xbln]['I'])/array_sum($sthasil_nr[$xbln]['I'])*100==0 ? " style='color:$ttbgcolor' " : "");
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format(array_sum($stkernel_nr[$xbln]['I'])/array_sum($sthasil_nr[$xbln]['I'])*100,2)."</td>";
	}
	$stream.="</tr>";
	$wrn = array("bb", "cc", "dd", "ee", "ff", "ff", "ff", "ff", "ff", "ff", "ff", "ff", "ff"); 
	$no=0;
	foreach($unit as $xorg){
        ...
        for ($xbln=1; $xbln<=12; $xbln++){
			...
			$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format(array_sum($gtoil_nr[$xbln][$xorg])/array_sum($gthasil_nr[$xbln][$xorg])*100,2)."</td>";
		}
        for ($xbln=1; $xbln<=12; $xbln++){
			$fontcolor0=(array_sum($gtkernel_nr[$xbln][$xorg])/array_sum($gthasil_nr[$xbln][$xorg])*100==0 ? " style='color:$ttbgcolor' " : "");
			$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format(array_sum($gtkernel_nr[$xbln][$xorg])/array_sum($gthasil_nr[$xbln][$xorg])*100,2)."</td>";
		}
		$stream.="</tr>";
	}
	$ttbgcolor="#ffbb99";
	...
	foreach($divisi as $xdiv){
		...
		foreach($xkodeblok[$xdiv] as $xblok){
	        ...
	        for ($xbln=1; $xbln<=12; $xbln++){
				...
				$stream.="<td ".$fontcolor0." align='right'>".number_format($ttoer_or[$xbln][$xblok],2)."</td>";
			}
		    for ($xbln=1; $xbln<=12; $xbln++){
				$fontcolor0=($ttker_tt[$xbln][$xblok]==0 ? " style='color:#e0ecfc' " : "");
				$stream.="<td ".$fontcolor0." align='right'>".number_format($ttker_or[$xbln][$xblok],2)."</td>";
			}
			$stream.="</tr>";
		}
		if($ada==0){
	...
	for ($xbln=1; $xbln<=12; $xbln++){
		...
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format(array_sum($ttoil_or[$xbln])/array_sum($tthasil_or[$xbln])*100,2)."</td>";
	}
	for ($xbln=1; $xbln<=12; $xbln++){
		$fontcolor0=(array_sum($ttkernel_or[$xbln])/array_sum($tthasil_or[$xbln])*100==0 ? " style='color:$ttbgcolor' " : "");
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format(array_sum($ttkernel_or[$xbln])/array_sum($tthasil_or[$xbln])*100,2)."</td>";
	}
	$stream.="</tr>";
	$ttbgcolor="#ffbb99";
	$stream.="<tr class=rowcontent>
	...
	for ($xbln=1; $xbln<=12; $xbln++){
		...
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format(array_sum($stoil_or[$xbln]['I'])/array_sum($sthasil_or[$xbln]['I'])*100,2)."</td>";
	}
	for ($xbln=1; $xbln<=12; $xbln++){
		$fontcolor0=(array_sum($stkernel_or[$xbln]['I'])/array_sum($sthasil_or[$xbln]['I'])*100==0 ? " style='color:$ttbgcolor' " : "");
		$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format(array_sum($stkernel_or[$xbln]['I'])/array_sum($sthasil_or[$xbln]['I'])*100,2)."</td>";
	}
	$stream.="</tr>";
	$wrn = array("bb", "cc", "dd", "ee", "ff", "ff", "ff", "ff", "ff", "ff", "ff", "ff", "ff"); 
	$no=0;
	foreach($unit as $xorg){
        ...
        for ($xbln=1; $xbln<=12; $xbln++){
			...
			$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format(array_sum($gtoil_or[$xbln][$xorg])/array_sum($gthasil_or[$xbln][$xorg])*100,2)."</td>";
		}
        for ($xbln=1; $xbln<=12; $xbln++){
			$fontcolor0=(array_sum($gtkernel_or[$xbln][$xorg])/array_sum($gthasil_or[$xbln][$xorg])*100==0 ? " style='color:$ttbgcolor' " : "");
			$stream.="<td bgcolor=".$ttbgcolor." ".$fontcolor0." align='right'>".number_format(array_sum($gtkernel_or[$xbln][$xorg])/array_sum($gthasil_or[$xbln][$xorg])*100,2)."</td>";
		}
		$stream.="</tr>";
	}
	$ttbgcolor="#ffbb99";
