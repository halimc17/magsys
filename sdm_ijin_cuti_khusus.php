...
<td>:</td>
<td><select id="jnsIjin" name="jnsIjin" onchange='jumlahhari()' style="width:150px"><? echo $optJenis;?></select></td>
</tr>
...
<td>:</td>
<td><input type='text' class='myinputtext' id='tglEnd' onmousemove='setCalendar(this.id)' onkeypress='return false;'  size='10' maxlength='10' disabled style="width:150px;" /><select id="jam2" disabled><? echo $jm;?></select>:<select id="mnt2" disabled><? echo $mnt;?></select></td>
</tr>
<tr>
