...
switch($proses){
	case'loadData':
        ...
        $offset=$page*$limit;
		$sql="select count(a.tahunbudget) as jmlhrow from ".$dbname.".bgt_unit a where ".$where."";
		//exit('Warning: '.$sql);
		...
		while($bar=mysql_fetch_object($res)){
			...
			echo"<tr class=rowcontent >
					...
					<td ".$drcl." align=center>".$bar->tahuntanam."</td>
					<td ".$drcl." align=left>".$bar->kodebudget."</td>
					<td ".$drcl." align=left>".$bar->noakun."</td>
