...
<tr><td><label><?php echo $_SESSION['lang']['sistemgaji']?></label></td><td><select id="pilihan2" name="pilihan2" style="width:150px" onchange="getTgl()"><option value=""><?php echo $_SESSION['lang']['all'];?></option><option value="bulanan"><?php echo $_SESSION['lang']['bulanan'];?></option><option value="harian"><?php echo $_SESSION['lang']['harian'];?></option></select></td></tr>
...
<tr><td><label><?php echo $_SESSION['lang']['bagian']?></label></td><td><select id="pilihan3" name="pilihan3" style="width:150px"><option value=""><?php echo $_SESSION['lang']['all'];?></option><?php echo $optBagian?></select></td></tr>

<tr><td><label><?php echo $_SESSION['lang']['beban']?></label></td><td><select id="beban1" name="beban1" style="width:200px"><option value=""><?php echo $_SESSION['lang']['all'];?></option><?php echo $optbeban?></select></td></tr>
...
<tr><td><label><?php echo $_SESSION['lang']['sistemgaji']?></label></td><td><select id="pilihan_2" name="pilihan_2" style="width:150px" onchange="getTgl2()"><option value=""><?php echo $_SESSION['lang']['all'];?></option><option value="bulanan"><?php echo $_SESSION['lang']['bulanan'];?></option><option value="harian"><?php echo $_SESSION['lang']['harian'];?></option></select></td></tr>
...
<tr><td><label><?php echo $_SESSION['lang']['bagian']?></label></td><td><select id="pilihan_3" name="pilihan_3" style="width:150px"><option value=""><?php echo $_SESSION['lang']['all'];?></option><?php echo $optBagian?></select></td></tr>

<tr><td><label><?php echo $_SESSION['lang']['beban']?></label></td><td><select id="beban2" name="beban2" style="width:200px"><option value=""><?php echo $_SESSION['lang']['all'];?></option><?php echo $optbeban?></select></td></tr>
