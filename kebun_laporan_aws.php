...
<script>
	function batalLaporan(num){
		...
		if(num==1){
			document.getElementById('tgl11').value='';
...
<?php
	...
	$frm[0].="<fieldset style='float:left;'><legend><b>Form Detail</b></legend>
			<table>
				...
				<tr>
					<td colspan=100>
						<button onclick=zPreview('kebun_laporan_aws_slave','".$arr0."','printContainer0') class=mybutton name=preview0 id=preview0>".$_SESSION['lang']['preview']."</button>
						<button onclick=zExcel(event,'kebun_laporan_aws_slave.php','".$arr0."') class=mybutton name=preview0 id=preview0>".$_SESSION['lang']['excel']."</button>
	...
	$frm[1].="<fieldset style='float:left;'><legend><b>Form Harian</b></legend>
			<table>
				...
				<tr>
					<td colspan=100>
						<button onclick=zPreview('kebun_laporan_aws_slave','".$arr1."','printContainer1') class=mybutton name=preview1 id=preview1>".$_SESSION['lang']['preview']."</button>
						<button onclick=zExcel(event,'kebun_laporan_aws_slave.php','".$arr1."') class=mybutton name=preview1 id=preview1>".$_SESSION['lang']['excel']."</button>
	...
	$frm[2].="<fieldset style='float:left;'><legend><b>Form Bulanan</b></legend>
			<table>
				...
				<tr>
					<td colspan=100>
						<button onclick=zPreview('kebun_laporan_aws_slave','".$arr2."','printContainer2') class=mybutton name=preview2 id=preview2>".$_SESSION['lang']['preview']."</button>
						<button onclick=zExcel(event,'kebun_laporan_aws_slave.php','".$arr2."') class=mybutton name=preview2 id=preview2>".$_SESSION['lang']['excel']."</button>
	...
	$frm[3].="<fieldset style='float:left;'><legend><b>Form Tahunan</b></legend>
			<table>
				...
				<tr>
					<td colspan=100>
						<button onclick=zPreview('kebun_laporan_aws_slave','".$arr3."','printContainer3') class=mybutton name=preview3 id=preview3>".$_SESSION['lang']['preview']."</button>
						<button onclick=zExcel(event,'kebun_laporan_aws_slave.php','".$arr3."') class=mybutton name=preview3 id=preview3>".$_SESSION['lang']['excel']."</button>
