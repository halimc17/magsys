...
//        if(($jenis=='0')or($jenis=='1')or($jenis=='2')or($jenis=='3'))echo"<td align=center>".$_SESSION['lang']['supplier']."</td>";
        if(($jenis=='0')or($jenis=='1')or($jenis=='2'))echo"<td align=center>".$_SESSION['lang']['nopo']."</td>";
        if(($jenis=='0')or($jenis=='1')or($jenis=='2'))echo"<td align=center>".$_SESSION['lang']['supplier']."</td>";
    ...
    echo"</tr></thead><tbody>";  
        ...
        while($bar=mysql_fetch_object($res))
        {
			...
			$bgColor = "";
			if($bar->statusjurnal!=1) $bgColor = "style='background-color:#E07C1A'";
            ...
            if($jenis==''){
                $masuk=0;
                $keluar=0;
                if($bar->tipetransaksi<5)$masuk=$bar->jumlah;
...
//            if(($jenis=='0')or($jenis=='1')or($jenis=='2')or($jenis=='3'))echo"<td nowrap>".$bar->namasupplier."</td>";
            if(($jenis=='0')or($jenis=='1')or($jenis=='2'))echo"<td nowrap>".$bar->nopo."</td>";
