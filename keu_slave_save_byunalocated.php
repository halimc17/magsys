...
$bylistrik  = isset($_POST['bylistrik'])? $_POST['bylistrik']: 0;
$byair      = isset($_POST['byair'])? $_POST['byair']: 0;
$byklinik   = isset($_POST['byklinik'])? $_POST['byklinik']: 0;
$bysosial   = isset($_POST['bysosial'])? $_POST['bysosial']: 0;
$perumahan  = isset($_POST['perumahan'])? $_POST['perumahan']: 0;
$natura     = isset($_POST['natura'])? $_POST['natura']: 0;
$jms        = isset($_POST['jms'])? $_POST['jms']: 0;

$karyawanid = isset($_POST['karyawanid'])? $_POST['karyawanid']: 0;
$subbagian  = isset($_POST['subbagian'])? $_POST['subbagian']: '';
$periode    = isset($_POST['periode'])? $_POST['periode']: '';
$kodeorg    = $_SESSION['empl']['lokasitugas'];
$method     = isset($_POST['method'])? $_POST['method']: '';

$namakaryawan= isset($_POST['namakaryawan'])? $_POST['namakaryawan']: '';
$tanggal=$periode."-28";
...
case 'post':
         ...
         while($bar=mysql_fetch_object($res))
         {
            ...
            $airlistrik =$bylistrik+$byair;#digabung dalam akun
        ...
        while($baru=mysql_fetch_object($resu))
        {
            #cari akun debet pengawasan
                    if(str_replace(" ","",$baru->tipetransaksi)=='BBT')
                       $group='KBNL0';
                    else if(str_replace(" ","",$baru->tipetransaksi)=='TB')
                       $group='KBNL1';
...
#============================================
      #proses data JMS
        ...
        if(empty($headErr) and empty($detailErr))
        {
