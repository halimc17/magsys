...
{ 
	...
	if(!isset($arey[$bar->kodeorg]['prodcpo']))
		$arey[$bar->kodeorg]['prodcpo'] = array('hi'=>0,'maren'=>0,'bi'=>0,'sdbi'=>0);
...
{ 
    $unit[$bar->kodeorg]=$bar->kodeorg;
	if(!isset($arey[$bar->kodeorg]['prodpk']))
		$arey[$bar->kodeorg]['prodpk'] = array('hi'=>0,'maren'=>0,'bi'=>0,'sdbi'=>0);
...
{ 
    $unit[$bar->kodeorg]=$bar->kodeorg;
	if(!isset($arey[$bar->kodeorg]['tbsdiolah']))
		$arey[$bar->kodeorg]['tbsdiolah'] = array('hi'=>0,'maren'=>0,'bi'=>0,'sdbi'=>0);
...
{ 
    $unit[$bar->kodeorg]=$bar->kodeorg;
	if(!isset($arey[$bar->kodeorg]['oercpo']))
		$arey[$bar->kodeorg]['oercpo'] = array('hi'=>0,'maren'=>0,'bi'=>0,'sdbi'=>0);
	if(!isset($arey[$bar->kodeorg]['oerasd']))
		$arey[$bar->kodeorg]['oerasd'] = array('hi'=>0,'maren'=>0,'bi'=>0,'sdbi'=>0);
    ...
    if((substr($bar->tanggal,0,7)==($tahun."-".$bulan))and(substr($bar->tanggal,0,10)<=$hariini)){ // bi
        @$arey[$bar->kodeorg]['oerasd']['bi']+=$bar->oer;
        @$arey[$bar->kodeorg]['tbsdiolahasd']['bi']+=$bar->tbsdiolah;
    }
    if((substr($bar->tanggal,0,4)==($tahun))and(substr($bar->tanggal,0,10)<=$hariini)){ // sdbi
        @$arey[$bar->kodeorg]['oerasd']['sdbi']+=$bar->oer;
        @$arey[$bar->kodeorg]['tbsdiolahasd']['sdbi']+=$bar->tbsdiolah;
    }
    @$arey[$bar->kodeorg]['oercpo']['bi']=$arey[$bar->kodeorg]['oerasd']['bi']/$arey[$bar->kodeorg]['tbsdiolahasd']['bi']*100;
    @$arey[$bar->kodeorg]['oercpo']['sdbi']=$arey[$bar->kodeorg]['oerasd']['sdbi']/$arey[$bar->kodeorg]['tbsdiolahasd']['sdbi']*100;
...
$res=mysql_query($str);
//echo mysql_error($conn);
$counthi = $countmaren = $countbi = $countsdbi = 0;
while($bar=mysql_fetch_object($res))
{ 
    $unit[$bar->kodeorg]=$bar->kodeorg;
	if(!isset($arey[$bar->kodeorg]['loscpo']))
		$arey[$bar->kodeorg]['loscpo'] = array('hi'=>0,'maren'=>0,'bi'=>0,'sdbi'=>0);
	if(!isset($arey[$bar->kodeorg]['lospk']))
		$arey[$bar->kodeorg]['lospk'] = array('hi'=>0,'maren'=>0,'bi'=>0,'sdbi'=>0);
...
if(!empty($unit))foreach($unit as $un =>$kdun){
...
$res=mysql_query($str);
//echo mysql_error($conn);
$kali=array('bi'=>0,'sdbi'=>0);
while($bar=mysql_fetch_object($res))
{ 
    $unit[$bar->kodeorg]=$bar->kodeorg;
	if(!isset($arey[$bar->kodeorg]['ffacpo']))
		$arey[$bar->kodeorg]['ffacpo'] = array('hi'=>0,'maren'=>0,'bi'=>0,'sdbi'=>0);
	if(!isset($arey[$bar->kodeorg]['ffacpoqwe']))
		$arey[$bar->kodeorg]['ffacpoqwe'] = array('hi'=>0,'maren'=>0,'bi'=>0,'sdbi'=>0);
...
{ 
    $unit[$bar->kodeorg]=$bar->kodeorg;
	if(!isset($arey[$bar->kodeorg]['oerpk']))
		$arey[$bar->kodeorg]['oerpk'] = array('hi'=>0,'maren'=>0,'bi'=>0,'sdbi'=>0);
	if(!isset($arey[$bar->kodeorg]['oerpk1']))
		$arey[$bar->kodeorg]['oerpk1'] = array('hi'=>0,'maren'=>0,'bi'=>0,'sdbi'=>0);
	if(!isset($arey[$bar->kodeorg]['oerpk2']))
		$arey[$bar->kodeorg]['oerpk2'] = array('hi'=>0,'maren'=>0,'bi'=>0,'sdbi'=>0);
...
{ 
    $unit[$bar->kodeorg]=$bar->kodeorg;
	if(!isset($arey[$bar->kodeorg]['jamolah']))
		$arey[$bar->kodeorg]['jamolah'] = array('hi'=>0,'maren'=>0,'bi'=>0,'sdbi'=>0);
...
{ 
    $unit[$bar->kodeorg]=$bar->kodeorg;
	if(!isset($arey[$bar->kodeorg]['kapolah']))
		$arey[$bar->kodeorg]['kapolah'] = array('hi'=>0,'maren'=>0,'bi'=>0,'sdbi'=>0);
...
{ 
    $unit[$bar->kodeorg]=$bar->kodeorg;
	if(!isset($arey[$bar->kodeorg]['stokcpo']))
		$arey[$bar->kodeorg]['stokcpo'] = array('hi'=>0,'maren'=>0,'bi'=>0,'sdbi'=>0);
...
{ 
    $unit[$bar->kodeorg]=$bar->kodeorg;
	if(!isset($arey[$bar->kodeorg]['stokpk']))
		$arey[$bar->kodeorg]['stokpk'] = array('hi'=>0,'maren'=>0,'bi'=>0,'sdbi'=>0);
...
{ 
	...
	if(!isset($arey[$bar->millcode]['internal']))
		$arey[$bar->millcode]['internal'] = array('hi'=>0,'maren'=>0,'bi'=>0,'sdbi'=>0);
...
{ 
    $unit[$bar->millcode]=$bar->millcode;
	if(!isset($arey[$bar->millcode]['eksternal']))
		$arey[$bar->millcode]['eksternal'] = array('hi'=>0,'maren'=>0,'bi'=>0,'sdbi'=>0);
...
{ 
	...
	if(!isset($arey[$bar->millcode][$barangnya]))
		$arey[$bar->millcode][$barangnya] = array('hi'=>0,'maren'=>0,'bi'=>0,'sdbi'=>0);
...
echo"<marquee height=92 onmouseout=\"this.setAttribute('scrollamount', 1, 0);\" onmouseover=\"this.setAttribute('scrollamount', 0, 0);\" scrolldelay=20 scrollamount=1 behavior=scroll direction=up>
