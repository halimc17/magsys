...
{
case 'update':	
	$str="update ".$dbname.".vhc_kegiatan set namakegiatan='".$namakegiatan."', satuan='".$satuan."',
              noakun='".$noakun."'
	...
	break;
case 'insert':
	$str="insert into ".$dbname.".vhc_kegiatan (kodekegiatan,namakegiatan,satuan,noakun)
	      values('".$kodekegiatan ."','".$namakegiatan."','".$satuan."','".$noakun."')";
	if(mysql_query($str))
	{}
	else
	{echo " Gagal,".addslashes(mysql_error($conn));}	
