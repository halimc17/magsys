...
while($rPo=mysql_fetch_assoc($qPo))
{
	...
	if(!isset($datakirim[$kunci]['jumlah'])) $datakirim[$kunci]['jumlah'] = 0;
...
{
    $kunci=strtoupper($rPo['nopo']).$rPo['kodebarang'];
	if(!isset($dataterima[$kunci]['jumlah'])) $dataterima[$kunci]['jumlah'] = 0;
...
if(!empty($data))foreach($data as $d){
    $tab.="<tr class=rowcontent>";
		...
		if(!isset($datatagih[$d['nopo']]['noinvoice'])) $datatagih[$d['nopo']]['noinvoice']='';
		if(!isset($datatagih[$d['nopo']]['tanggal'])) $datatagih[$d['nopo']]['tanggal']='';
		if(!isset($datatagih[$d['nopo']]['jatuhtempo'])) $datatagih[$d['nopo']]['jatuhtempo']='';
		...
		if(!isset($datakirim[$kunci]['lokasi'])) $datakirim[$kunci]['lokasi']='';
		if(!isset($datakirim[$kunci]['tanggal'])) $datakirim[$kunci]['tanggal']='';
		if(!isset($datakirim[$kunci]['notransaksi'])) $datakirim[$kunci]['notransaksi']='';
		if(!isset($datakirim[$kunci]['jumlah'])) $datakirim[$kunci]['jumlah']=0;
		if(!isset($datakirim[$kunci]['satuan'])) $datakirim[$kunci]['satuan']='';
		...
		if(!isset($dataterima[$kunci]['tanggal'])) $dataterima[$kunci]['tanggal']='';
		if(!isset($dataterima[$kunci]['notransaksi'])) $dataterima[$kunci]['notransaksi']='';
		if(!isset($dataterima[$kunci]['jumlah'])) $dataterima[$kunci]['jumlah']=0;
		if(!isset($dataterima[$kunci]['satuan'])) $dataterima[$kunci]['satuan']='';
