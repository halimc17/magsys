...
//                         <tfoot></tfoot></table>";
	...
	$table.="<td><input type=text class=myinputtextnumber style='width:65px;' id=jmlhJJg  onkeypress=\"return angka_doang(event)\" size=\"10\" maxlength=\"4\" value='".$rJjg['jjgsortasi']."'  onblur=hitungPotongan(this.value,'BRD',".mysql_num_rows($zd).")></td>";
	...
	$table.="<td><input type=text class=myinputtextnumber style='width:65px;' id=kgPtngan  onkeypress=\"return angka_doang(event)\" size=\"10\" maxlength=\"8\" value='".$rJjg['kgpotsortasi']."' readonly /></td>";
	$table .="<td><img id='detail_add' title='".$_SESSION['lang']['save']."' class=zImgBtn onclick=\"addDetail('".$a."')\" src='images/save.png'/></td>";
	$table.="</tr></tbody></table><input type=hidden id=jmlhBaris value=".$a." />";
	echo $table;
	break;
