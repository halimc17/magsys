                    ...
                    while($res2=mysql_fetch_assoc($query))
                    {
                            ...
                            "<tr class=rowcontent>
                                    ...
                                    if($res2['purchaser']==$_SESSION['standard']['userid'])
                                    {
                                        ...
                                        echo"<img src=images/pdf.jpg class=resicon  title='Print RPH' onclick=\"masterPDF('log_perintaanhargaht','".$res2['nomor'].",".$res2['nourut']."','','log_slave_print_permintaan_penawaran',event);\">
    ...
    case 'deleted':
     ...
     break;
				...
				$no=0;
                        foreach($listBarang as $brsKdBrg){
                            ...
                            foreach ($dtNomor as $brs){
                                ...
                                {
                                    $tab.="<td align=justify colspan=4><textarea id='ketUraian_".$ard."' name='ketUraian_".$ard."' onkeypress='return tanpa_kutip(event);' cols=18 rows=3>".(isset($dtCttn[$ard])? $dtCttn[$ard]: '')."</textarea></td>";
                                }
                            }
                            $tab.="</tr>";
                            $tab.="<tr class=rowcontent><td colspan=2></td>";
		...
		echo "<div id=form_batal><fieldset><legend>".$nopo."</legend>
				...
				<tr><td><textarea rows=5 cols=34 id='alasan'></textarea></td>
