...
# Button
$opt = array('mandor'=>$optKary,'asisten'=>$optKary);
$els['btn'] = array(
  genFormBtn($fieldStr,'pabrik_5shift',"##kodeorg##shift",null,
			 'kodeorg##shift',null,null,'##','##',json_encode($opt))
);
...
foreach($result as $row) {
  ...
  foreach($row as $b=>$c) {
    ...
    if(($fForm[$j]=='mandor')||($fForm[$j]=='asisten'))
