          ...
          <td align=center style='width:100px;cursor:pointer;' onclick=displayList()>
           <img class=delliconBig src=images/orgicon.png title='".$_SESSION['lang']['list']."'><br>".$_SESSION['lang']['list']."</td>
                 <td><fieldset><legend>".$_SESSION['lang']['pilihdata']."</legend>"; 
                    ...
                    echo"<tr><td>".$_SESSION['lang']['namabarang']."</td><td>:</td><td><input type='text' id='txtNmBrg' name='txtNmBrg' onkeypress='return tanpa_kutip(event)' style='width:150px' class=myinputtext /></td></tr></table>";
	...
	<table class="sortable" cellspacing="1" border="0" width="2000px">
        <thead>
            <tr class=rowheader>
				...
				<td><?php echo $_SESSION['lang']['status']." ". $_SESSION['lang']['persetujuan']; ?></td>
