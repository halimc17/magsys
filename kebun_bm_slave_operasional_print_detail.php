...
$col1 = 'tanggal,nik,a.kodeorg,tahuntanam,norma,hasilkerja,hasilkerjakg,jumlahhk,upahkerja,upahpenalty,upahpremi,premibasis,rupiahpenalty,luaspanen';
$cols[] = explode(',',$col1);
//$query = selectQuery($dbname,'kebun_prestasi',$col1,
//    "notransaksi='".$param['notransaksi']."'");
$query="select a.*,d.namaorganisasi from (select ".$col1." from ".$dbname.".kebun_prestasi a 
...
switch($tipe) {
	...
	break;
	case "BM":
	$title = $_SESSION['lang']['bongkarmuat'];
	break;
    default:
...
switch($proses) {
    case 'pdf':
        ...
        $pdf->Cell(15/100*$width,$height,$_SESSION['lang']['namakaryawan'],1,0,'C',1);
        $pdf->Cell(10/100*$width,$height,$_SESSION['lang']['blok'],1,0,'C',1);
        $pdf->Cell(5/100*$width,$height,$_SESSION['lang']['tahun'],1,0,'C',1);
        $pdf->Cell(8/100*$width,$height,$_SESSION['lang']['basiskg'],1,0,'C',1);
        $pdf->Cell(12/100*$width,$height,$_SESSION['lang']['hasilkerjakg'],1,0,'C',1);
        $pdf->Cell(10/100*$width,$height,$_SESSION['lang']['upahkerja'],1,0,'C',1);
        $pdf->Cell(10/100*$width,$height,$_SESSION['lang']['upahpremi'],1,0,'C',1);
        $pdf->Cell(10/100*$width,$height,$_SESSION['lang']['upahpenalty'],1,0,'C',1);
		...
		while($rData=mysql_fetch_assoc($qData))
        {
            ...
            $pdf->Cell(10/100*$width,$height,$rData['namaorganisasi'],1,0,'C',1);
            $pdf->Cell(5/100*$width,$height,$rData['tahuntanam'],1,0,'R',1);
            $pdf->Cell(8/100*$width,$height,number_format($rData['norma'],2),1,0,'R',1);
            $pdf->Cell(12/100*$width,$height,number_format($rData['hasilkerjakg'],0),1,0,'R',1);
            $pdf->Cell(10/100*$width,$height,number_format($rData['upahkerja'],0),1,0,'R',1);
            $pdf->Cell(10/100*$width,$height,number_format($rData['upahpremi'],0),1,0,'R',1);
            $pdf->Cell(10/100*$width,$height,number_format($rData['upahpenalty'],0),1,0,'R',1);
            ...
            $tothasilkerjakg+=$rData['hasilkerjakg'];
        ...
        $pdf->Cell(48/100*$width,$height,$_SESSION['lang']['total'],1,0,'C',1);
        $pdf->Cell(12/100*$width,$height,number_format($tothasilkerjakg,0),1,0,'R',1);
        ...
        $pdf->Cell(10/100*$width,$height,number_format($totUpahKerjapenalty,0),1,0,'R',1);
    ...
    default:
		...
		if($proses=='html'){
			...
			$bgclr='bgcolor=#CCCCCC';
			$brd=1;
		}
        $tab.="<fieldset><legend>".$title."</legend>";
        $tab.="<table ".$brd." cellpadding=1 cellspacing=1 class=sortable><tbody class=rowcontent>";
        $tab.="<tr><td ".$bgclr.">".$_SESSION['lang']['kodeorganisasi']."</td><td> :</td><td> ".$_SESSION['empl']['lokasitugas']."</td></tr>";
        $tab.="<tr><td ".$bgclr.">".$_SESSION['lang']['notransaksi']."</td><td> :</td><td> ".$param['notransaksi']."</td></tr>";
        $tab.="</tbody></table>";
        $tab.="<br />".$titleDetail[0]."<br />";
        $tab.="<table cellpadding=1 cellspacing=1 ".$brd." class=sortable><thead>";
        $tab.="<tr class=rowheader>";
        $tab.="<td ".$bgclr." align=center>".$_SESSION['lang']['tanggal']."</td>";
        $tab.="<td ".$bgclr." align=center>".$_SESSION['lang']['nik']."</td>";
        $tab.="<td ".$bgclr." align=center>".$_SESSION['lang']['blok']."</td>";
        $tab.="<td ".$bgclr." align=center>".$_SESSION['lang']['tahun']."</td>";
        $tab.="<td ".$bgclr." align=center>".$_SESSION['lang']['basiskg']."</td>";
        $tab.="<td ".$bgclr." align=center>".$_SESSION['lang']['hasilkerjakg']."</td>";
        $tab.="<td ".$bgclr." align=center>".$_SESSION['lang']['upahkerja']."</td>";
        $tab.="<td ".$bgclr." align=center>".$_SESSION['lang']['upahpremi']."</td>";
        $tab.="<td ".$bgclr." align=center>".$_SESSION['lang']['upahpenalty']."</td>";
        $tab.="<td ".$bgclr." align=center>".$_SESSION['lang']['total']."</td>";
        $tab.="</tr></thead><tbody>";
        ...
        while($rData=mysql_fetch_assoc($qData)){
                ...
                $tab.="<td align=right>".number_format($rData['norma'],0)."</td>";
                $tab.="<td align=right>".number_format($rData['hasilkerjakg'],0)."</td>";
        ...
        $tab.="<tr class=rowcontent>";
        $tab.="<td colspan=5><b>".$_SESSION['lang']['total']."</td>";
        $tab.="<td align=right><b>".number_format($tothasilkerjakg,0)."</td>";
