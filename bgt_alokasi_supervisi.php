...
<tr><td>".$_SESSION['lang']['totalUpahSpr']."</td><td>:</td><td><input type=text disabled class=myinputtextnumber  id=totUpah name=totUpah  onkeypress=\"return angka_doang(event);\" style=width:150px; /></td></tr>
