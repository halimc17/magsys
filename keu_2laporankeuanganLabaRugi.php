...
OPEN_BOX('','<b>'.strtoupper($_SESSION['lang']['laporankeuangan']).' - LABA RUGI</b>');
...
echo"<fieldset>
    <legend></legend>
        ...
        <button class=mybutton onclick=getLaporanKeuanganLabaRugi()>".$_SESSION['lang']['proses']."</button>
    </fieldset>";
CLOSE_BOX();
OPEN_BOX('','Result:');
echo"<span id=printPanel style='display:none;'>
        <img onclick=fisikKeExcel(event,'keu_laporankeuanganLabaRugi_Excel.php') src=images/excel.jpg class=resicon title='MS.Excel'> 
