...
while($res=mysql_fetch_assoc($query))
{
    ...
    @$dzArr[$res['noakun']]['112']=$res['setahun']/$luasbudg;//$luasreal
}
...
while($res=mysql_fetch_assoc($query))
{
    ...
    @$dzArr[$res['noakun']]['122']=$res['bi']/$luasbudg;//$luasreal
}
...
while($res=mysql_fetch_assoc($query))
{
    ...
    @$dzArr[$res['noakun']]['132']=$res['jumlah']/$luasbudg;//$luasreal
}
...
while($res=mysql_fetch_assoc($query))
{
    ...
    @$dzArr[$res['noakun']]['212']=$res['jumlah']/$luasbudg;//$luasreal
}
...
while($res=mysql_fetch_assoc($query))
{
    ...
    @$dzArr[$res['noakun']]['222']=$res['jumlah']/$luasbudg;//$luasreal
}
...
$iptarpthn="select sum(rupiah) as rupiah,noakun from ".$dbname.".pta_dt_blok_vw where "
        . " tahun='".$tahun."' and unit = '".$unit."' and noakun like '71%' group by noakun";
...
while($dptarpthn=  mysql_fetch_assoc($nptarpthn))
{
    ...
    @$dzArr[$dptarpthn['noakun']][812]=$dptarpthn['rupiah']/$luasbudg;//$luasreal
}


##bln ini 
$iptarpbln="select sum(rupiah) as rupiah,noakun from ".$dbname.".pta_dt_blok_vw where "
        . " bulan='".$periode."' and unit = '".$unit."' and noakun like '71%' group by noakun";
...
while($dptarpbln=  mysql_fetch_assoc($nptarpbln))
{
    ...
    @$dzArr[$dptarpbln['noakun']][822]=$dptarpbln['rupiah']/$luasbudg;//$luasreal
}
...
$iptarpsdbln="select sum(rupiah) as rupiah,noakun from ".$dbname.".pta_dt_blok_vw where "
        . " (tanggal between '".$tahun."-01-01' and LAST_DAY('".$periode."-15')) "
        . " and unit = '".$unit."' and noakun like '71%' group by noakun";
...
while($dptarpsdbln=  mysql_fetch_assoc($nptarpsdbln))
{
    ...
    @$dzArr[$dptarpsdbln['noakun']][832]=$dptarpsdbln['rupiah']/$luasbudg;//$luasreal
}
...
// excel array content =========================================================================
    if(empty($dzArr)){
        ...
        if(!empty($list71101))foreach($list71101 as $keg){
            ...
            $total1['811']+=$dzArr[$keg]['811'];
            $total1['821']+=$dzArr[$keg]['821'];
            $total1['831']+=$dzArr[$keg]['831'];
            ...
            $tab.= "<td align=right>".numberformat($dzArr[$keg]['811']/1000,0)."</td>";
            $tab.= "<td align=right>".numberformat($dzArr[$keg]['821']/1000,0)."</td>";
            $tab.= "<td align=right>".numberformat($dzArr[$keg]['831']/1000,0)."</td>";
        ...
        $tab.= "<td align=right>".numberformat($total1['811']/1000,0)."</td>";
        $tab.= "<td align=right>".numberformat($total1['821']/1000,0)."</td>";
        $tab.= "<td align=right>".numberformat($total1['831']/1000,0)."</td>";
        ...
        if(!empty($list71301))foreach($list71301 as $keg){
            ...
            $total2['811']+=$dzArr[$keg]['811'];
            $total2['821']+=$dzArr[$keg]['821'];
            $total2['831']+=$dzArr[$keg]['831'];
        ...
        $tab.= "<td align=right>".numberformat($total2['811']/1000,0)."</td>";
        $tab.= "<td align=right>".numberformat($total2['821']/1000,0)."</td>";
        $tab.= "<td align=right>".numberformat($total2['831']/1000,0)."</td>";
        ...
        if(!empty($list71409))foreach($list71409 as $keg){
            ...
            $total3['811']+=$dzArr[$keg]['811'];
            $total3['821']+=$dzArr[$keg]['821'];
            $total3['831']+=$dzArr[$keg]['831'];
        ...
        $tab.= "<td align=right>".numberformat($total3['811']/1000,0)."</td>";
        $tab.= "<td align=right>".numberformat($total3['821']/1000,0)."</td>";
        $tab.= "<td align=right>".numberformat($total3['831']/1000,0)."</td>";
        ...
        if(!empty($list71501))foreach($list71501 as $keg){
            ...
            $total4['811']+=$dzArr[$keg]['811'];
            $total4['821']+=$dzArr[$keg]['821'];
            $total4['831']+=$dzArr[$keg]['831'];
        ...
        $tab.= "<td align=right>".numberformat($total4['811']/1000,0)."</td>";
        $tab.= "<td align=right>".numberformat($total4['821']/1000,0)."</td>";
        $tab.= "<td align=right>".numberformat($total4['831']/1000,0)."</td>";
        ...
        $total9['811']=$total1['811']+$total2['811']+$total3['811']+$total4['811'];
        $total9['821']=$total1['821']+$total2['821']+$total3['821']+$total4['821'];
        $total9['831']=$total1['831']+$total2['831']+$total3['831']+$total4['831'];
        ...
        $tab.= "<td align=right>".numberformat($total9['811']/1000,0)."</td>";
        $tab.= "<td align=right>".numberformat($total9['821']/1000,0)."</td>";
        $tab.= "<td align=right>".numberformat($total9['831']/1000,0)."</td>";
