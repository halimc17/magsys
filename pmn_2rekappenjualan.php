...
<ul class="nav nav-tabs" id="rekappenjualanTab" role="tablist">
    <li class="nav-item" role="presentation">
        <button class="nav-link active" id="rekappenjualan-tab" data-bs-toggle="tab" data-bs-target="#rekappenjualan" type="button" role="tab" aria-controls="rekappenjualan" aria-selected="true">
            Rekap Penjualan
        </button>
    </li>
</ul>
...
<div class="tab-content" id="rekappenjualanTabContent">
    <div class="tab-pane fade show active" id="rekappenjualan" role="tabpanel" aria-labelledby="rekappenjualan-tab">
        <div class="p-3">
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label class="form-label"><?php echo $_SESSION['lang']['nmcust'];?></label>
                                <select id="idCustomer" name="idCustomer" class="form-select form-select-sm"><?php echo $optCustomer;?></select>
                            </div>
                            <div class="d-grid gap-2">
                                <button onclick="zPreview('pmn_slave_2rekappenjualan','<?php echo $arr;?>','printContainer')" class="btn btn-primary btn-sm">Preview</button>
                                <button onclick="zExcel(event,'pmn_slave_2rekappenjualan.php','<?php echo $arr;?>')" class="btn btn-success btn-sm">Excel</button>
                            </div>
                        </div>
                    </div>
                </div>
