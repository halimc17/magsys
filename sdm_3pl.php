...
$aPt="select id,name from ".$dbname.".sdm_ho_component where id in ('14','58','21') ";
$bPt=mysql_query($aPt) or die (mysql_error($conn));
while($cPt=mysql_fetch_assoc($bPt))
{
...
$i="select kodeorganisasi,namaorganisasi  from ".$dbname.". organisasi where "
        . " induk='".$_SESSION['empl']['kodeorganisasi']."' and kodeorganisasi not like '%HO%'";
...
$iO="select distinct periode from ".$dbname.". sdm_5periodegaji where sudahproses=0";
