	...
	case'saveData':
		...
		if($addedit=='update'){
			...
			$strx="update ".$dbname.".bgt_unit set tahunbudget='".$Tahun."',divisi='".$kdDivisi."',kodebudget='".$kdBudget."',kegiatan='".$kdKegiatan."'
				,noakun='".substr($kdKegiatan,0,7)."',satuanv='".$optSatKeg[$kdKegiatan]."',volume='".$luasdivisi."',kodevhc='".$kdVhc."',kodebarang='".$kdBarang."'
				,satuanj='".$satuanj."',keterangan='".$_SESSION['standard']['username']."',updateby='".$_SESSION['standard']['userid']."',lastupdate=now() 
				where idbgtunit='".$idbgtunit."'";
		}else{
			$strx="insert into ".$dbname.".bgt_unit
				(tahunbudget,divisi,tipebudget,kodebudget,kegiatan,noakun,satuanv,volume,kodevhc,kodebarang
				,regional,rotasi,jumlah,satuanj,keterangan,updateby,lastupdate) values ('".$Tahun."','".$kdDivisi."','".$tipeBudget."','".$kdBudget."','".$kdKegiatan."','".substr($kdKegiatan,0,7)."','".$optSatKeg[$kdKegiatan]."'
				,'".$luasdivisi."','".$kdVhc."','".$kdBarang."','".$_SESSION['empl']['regional']."',0,0,'".$satuanj."'
		...
		if(substr($kegiatan,0,1)=='1' or substr($kegiatan,0,2)=='61' or substr($kegiatan,0,2)=='62'){
			if(substr($kegiatan,0,1)=='1'){
				$sBlok1="select sum(a.luasareaproduktif) as luasdivisi from ".$dbname.".setup_blok a
						left join ".$dbname.".organisasi b on b.kodeorganisasi=a.kodeorg
						where a.kodeorg like '".$divisi."%' and a.statusblok like 'TB%' and b.detail='1'";
				...
				$sBlok1="select sum(a.luasareaproduktif) as luasdivisi from ".$dbname.".setup_blok a
						left join ".$dbname.".organisasi b on b.kodeorganisasi=a.kodeorg
						where a.kodeorg like '".$divisi."%' and a.statusblok = 'TM' and b.detail='1'";
				$sBlok2="select a.kodeorg,a.luasareaproduktif from ".$dbname.".setup_blok a
						left join ".$dbname.".organisasi b on b.kodeorganisasi=a.kodeorg
						where a.kodeorg like '".$divisi."%' and a.statusblok = 'TM' and b.detail='1'";
			}
