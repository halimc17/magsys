...
if($beban!=''){
	if($beban=='Normal'){
        $where4.=" and (b.beban = '".$beban."' or b.beban = '')";
	}else{
...
// ambil data lembur ================================================================================
if($pilihan=='rupiah'){
	$sPeople="SELECT a.subbagian,b.karyawanid as karyawanid, b.tanggal as tanggal, b.uangkelebihanjam as uangkelebihanjam, b.tipelembur, a.namakaryawan, a.bagian, a.kodejabatan
