...
//assseettt
$optAset='';
$saset="select kodeasset,namasset from ".$dbname.".sdm_daftarasset where tipeasset='PR' and kodeorg in (select kodeorganisasi from ".$dbname.".organisasi where induk='".$_SESSION['empl']['induk']."')";
