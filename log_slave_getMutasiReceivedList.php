...
//==================
  ...
  while($bar=mysql_fetch_object($res))
  {
	...
	$sSj="select distinct nosj from ".$dbname.".log_suratjalandt where notransaksireferensi='".$bar->notransaksireferensi."'";
	...
	if($bar->post!=1) {
		echo "<img src=images/application/application_delete.png class=resicon  caption='Delete' 
				onclick=\"del('".$bar->notransaksi."');\">";
	}
	echo "</td>
	  </tr>";
  }
