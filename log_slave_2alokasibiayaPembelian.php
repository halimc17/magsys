...
//$periode=	isset($_POST['periodeBeli'])? $_POST['periodeBeli']: '';
...
switch($proses)
{
                ...
                <legend>".$_SESSION['lang']['find']." ".$_SESSION['lang']['namabarang']."</legend>
                    ...
                    else
                    {
                        ...
                        while ($d=mysql_fetch_assoc($n))
                        {
                            ...
                            $no+=1;
                            echo"
                            <tr class=rowcontent  style='cursor:pointer;' title='Click It' onclick=\"moveDataBarang('".$d['supplierid']."','".$nmBrg[$d['supplierid']]."');\">
                                    <td>".$no."</td>
                                    <td>".$d['supplierid']."</td>
	...
	{ 
		...
		//$newWhere = " and nopo like '%".$_SESSION['empl']['lokasitugas']."%'";
...
//			onclick=\"masterPDF('log_poht','".$rPembelian['nopo']."','','log_slave_print_log_po',event);\"
			...
			//echo"<tr class=rowcontent onclick=masterPDF('log_poht','".$rPembelian['nopo']."','','log_slave_print_detail_po',event)\" title=Click>
...
//get posted by
	...
	$strx="select * from ".$dbname.".log_poht where tglrelease like '%".$periode."%' ".$newWhere."";
	*/
