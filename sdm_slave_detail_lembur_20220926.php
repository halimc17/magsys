...
switch($proses)
{
        ...
        $table .= "<td>".$_SESSION['lang']['beban']."</td>";
	...
	case'loadDetail':
        ...
        while($rDet=mysql_fetch_assoc($qDt))
        {
                ...
                <td>".$rDet['noba']."</td>
                <td><img src=images/application/application_edit.png class=resicon  title='Edit' onclick=\"editDetail('".$rDet['karyawanid']."','".$rDet['tipelembur']."','".$rDet['jamaktual']."','".$rDet['uangmakan']."','".$rDet['uangtransport']."','".$rDet['uangkelebihanjam']."','".$rDet['noba']."','".$rDet['beban']."');\">
