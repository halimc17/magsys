...
$sData2="select sum(debet) as jumlah, kodevhc,noakun from ".$dbname.".keu_jurnaldt_vw where tanggal>='".$rPeriode['tanggalmulai']."' and tanggal<='".$rPeriode['tanggalsampai']."' and (noakun between '".$rList['noakundebet']."' and '".$rList['sampaidebet']."')
...
<thead>
<tr class=rowheader>   
<td ".$bgBelakang.">".$_SESSION['lang']['jenisvch']."</td>
...
$tab.="<td align=right>".number_format($totalbiaya)."</td>";
foreach($listNoakun as $dafNoakun)
{
    $tab.="<td align=right>".number_format($totalperakun[$dafNoakun])."</td>";
}
