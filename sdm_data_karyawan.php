...
if(trim($_SESSION['empl']['tipelokasitugas'])=='HOLDING')//user holding dapat menempatkan dimana saja
{
    $str="select namaorganisasi,kodeorganisasi from ".$dbname.".organisasi where tipe not in('BLOK','PT','STENGINE','STATION') 
        ...
        while($bar=mysql_fetch_object($res))
        {
            ...
            $optAll.="<option value='".$bar->kodeorganisasi."'>".$bar->namaorganisasi."</option>";	
        }
            ...
            while($bardy=mysql_fetch_object($redy))
            {
                    ...
                    $optAll.="<option value='".$bardy->kodeorganisasi."'>".$bardy->namaorganisasi."</option>";	
            }	
}
else if(trim($_SESSION['empl']['tipelokasitugas'])=='KANWIL')
{
    $wheredt="regional='".$_SESSION['empl']['regional']."'";
    if($_SESSION['empl']['regional']=='SUMSEL'){
        $wheredt="regional in ('".$_SESSION['empl']['regional']."','LAMPUNG')";
    }
    $str="select namaorganisasi,kodeorganisasi from ".$dbname.".organisasi where tipe not in('BLOK','PT','STENGINE','STATION')
        ...
        while($bar=mysql_fetch_object($res))
        {
            ...
            $stdy="select namaorganisasi,kodeorganisasi from ".$dbname.".organisasi where tipe not in('PT','BLOK','STENGINE')
                   and induk in (select distinct kodeunit from ".$dbname.".bgt_regional_assignment where ".$wheredt.")
                   order by kodeorganisasi asc";
            //echo $stdy;
            $redy=mysql_query($stdy);
            while($bardy=mysql_fetch_object($redy))
...
if(trim($_SESSION['empl']['tipelokasitugas'])=='HOLDING')//jika user holding dapat memunculkan pilihan Permanen(staff))
  ...
  $str="select * from ".$dbname.".sdm_5tipekaryawan where id not in (0,7,8) order by tipe";
...
echo"<table>
     <tr valign=moiddle>
         ...
         <td><fieldset><legend>".$_SESSION['lang']['find']."</legend>"; 
                        ...
                        echo $_SESSION['lang']['lokasitugas'].":<select id=schorg style='width:100px' onchange=changeCaption(this.options[this.selectedIndex].text);><option value=''>".$_SESSION['lang']['all']."</option>".$optAll."</select>";
...
//kode organisasi harus PT
                ...
                {
                    $str="select distinct induk from ".$dbname.".organisasi where kodeorganisasi in (select distinct kodeunit from ".$dbname.".bgt_regional_assignment where regional='".$_SESSION['empl']['regional']."')
...
$frm[0]="<fieldset><legend>".$_SESSION['lang']['inputdatakaryawan']."</legend>
         <table border=0 cellspacing=1>
                 <tr>
                    <td align=right>".$_SESSION['lang']['nik']."</td><td><input type=text class=myinputtext id=nik size=26 maxlength=10 onkeypress=\"return tanpa_kutip(event);\" disabled></td>
                 ...
                 <tr>
                    ...
                    <td align=right>".$_SESSION['lang']['passport']."</td><td><input type=text class=myinputtext id=nopassport size=26 maxlength=30 onkeypress=\"return tanpa_kutip(event);\"><img src=images/obl.png title='Obligatory'></td>
				 ...
				 <tr>
                    ...
                    <td align=right>".$_SESSION['lang']['tanggalpengangkatan']."</td><td><input type=text class=myinputtext id=tanggalpengangkatan size=26 maxlength=10 onkeypress=\"return false;\" onmousemove=setCalendar(this)></td> 
                 ...
                 <tr>
					...
					<td align=right>".$_SESSION['lang']['bpjs']." (".$_SESSION['lang']['kesehatan'].")</td><td><input type=text id=bpjs size=26 maxlength=30 class=myinputtext onkeypress=\"return tanpa_kutip(event);\"></td>
                    <td align=right style='display:none'>".$_SESSION['lang']['pembagiancatu']."</td><td style='display:none'><select id=catu style='width:150px;'>".$optCatu."</select></td>
                 </tr>
				 <tr>
                            <td align=right>".$_SESSION['lang']['statusakad']."</td><td><select id=statusakad style='width:150px;'>
                 ...
                 <tr>
                    <td align=right style='display:none'>".$_SESSION['lang']['premi']."</td>
...
$frm[4]="<fieldset><legend>".$_SESSION['lang']['keluarga']."</legend>
         <table border=0 cellspacing=1>
                 ...
                 <tr>
                        <td align=right>".$_SESSION['lang']['pendidikan']."</td><td><select id=keluargapendidikan  style='width:170px;'>".$optpendidikan."</select></td>
                 ...
                 <tr>
                        <td align=right>".$_SESSION['lang']['tanggungan']."</td><td><select id=keluargatanggungan style='width:170px;'><option value=0>".$_SESSION['lang']['no']."</option><option value=1>".$_SESSION['lang']['yes']."</option></select></td>
						<td align=right>".$_SESSION['lang']['emplasment']."</td><td><select id=keluargaemplasment style='width:170px;'><option value=0>".$_SESSION['lang']['no']."</option><option value=1>".$_SESSION['lang']['yes']."</option></select></td>
                 </tr>
                 </table>
                ...
                <table class=sortable border=0 cellspacing=1 width=100%>
                        ...
                        <tr class=rowheader>
                          ...
                          <td>".$_SESSION['lang']['emplasment']."</td>
                          <td style='text-align:center;'>".$_SESSION['lang']['action']."</td>
                        </tr>
                        </thead>
