...
class PDF extends FPDF
{
    ...
    function Header()
     ...
     $this->Ln();
        ...
        $pdf->Cell(26,5,$_SESSION['lang']['jamaktual'],1,0,'C',1);
        $pdf->Cell(23,5,$_SESSION['lang']['uangmakan'],1,0,'C',1);
        $pdf->Cell(23,5,$_SESSION['lang']['penggantiantransport'],1,0,'C',1);
        $pdf->Cell(23,5,$_SESSION['lang']['uangkelebihanjam'],1,0,'C',1);		
        ...
        $pdf->SetFont('Arial','',8);
                ...
                while($res=mysql_fetch_assoc($re))
                {
                        ...
                        $pdf->Cell(26,5,$res['jamaktual'],1,0,'C',1);
                        $pdf->Cell(23,5,number_format($res['uangmakan'],2),1,0,'R',1);
                        $pdf->Cell(23,5,number_format($res['uangtransport'],2),1,0,'R',1);
                        $pdf->Cell(23,5,number_format($res['uangkelebihanjam'],2),1,0,'R',1);	
