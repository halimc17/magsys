...
while($rData=  mysql_fetch_assoc($qData))
{
	...
	$dtusbcpo[$rData['tanggal']]=$rData['uscpo'];
    ...
    $dthydrocyclone[$rData['tanggal']]=$rData['hydrocyclone'];
...
{
$tab.="<table cellpadding=2 cellspacing=1 border=".$brdr." class=sortable><thead>";
$tab.="<tr>";
...
$tab.="<td  colspan=16 align=center  ".$bgclr.">CPO Loses</td>";
$tab.="<td  colspan=14 align=center  ".$bgclr.">Kernel Loses</td></tr><tr>";
...
$tab.="<td colspan=2 align=center ".$bgclr.">Usb</td>";
...
$tab.="<td colspan=2 align=center ".$bgclr.">Usb</td>";
$tab.="<td colspan=2 align=center ".$bgclr.">Hydro Cyclone</td>";
$tab.="<td colspan=2 align=center ".$bgclr.">Total</td>";
$tab.="</tr><tr>";
for($arre=1;$arre<=16;$arre++)
{
...
{$ared++;
    /*if($ared==0)
    {
		setIt($dtTbsDiolah[$dtTanggal],0);
		setIt($dtoer[$dtTanggal],0);
		setIt($dtffa[$dtTanggal],0);
		setIt($dtkadarkotoran[$dtTanggal],0);
		setIt($dtkadarair[$dtTanggal],0);
		setIt($dtoerpk[$dtTanggal],0);
		setIt($dtffapk[$dtTanggal],0);
		setIt($dtkadarkotoranpk[$dtTanggal],0);
		setIt($dtkadarairpk[$dtTanggal],0);
        ...
        $tab.="<td align=right>".number_format($dtkadarkotoran[$dtTanggal],3)."</td>";
		...
		setIt($dtFruit[$dtTanggal],0);
		setIt($dtEbstalk[$dtTanggal],0);
		setIt($dtFibre[$dtTanggal],0);
		setIt($dtNut[$dtTanggal],0);
		setIt($dtEffluent[$dtTanggal],0);
		setIt($dtSolid[$dtTanggal],0);
		setIt($dtusbcpo[$dtTanggal],0);
		setIt($total[$dtTanggal],0);
		
		setIt($dtFruitinebker[$dtTanggal],0);
		setIt($dtCyclone[$dtTanggal],0);
		setIt($dtLtds[$dtTanggal],0);
		setIt($dtClaybath[$dtTanggal],0);
		setIt($dtusbpk[$dtTanggal],0);
		setIt($dthydrocyclone[$dtTanggal],0);
		setIt($total2[$dtTanggal],0);
		
        $tab.="<td align=right>".number_format($dtFruit[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtFruit[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtEbstalk[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtEbstalk[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtFibre[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtFibre[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtNut[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtNut[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtEffluent[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtEffluent[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtSolid[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtSolid[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtusbcpo[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($$dtusbcpo[$dtTanggal],2)."</td>";
        $total[$dtTanggal]=$dtFruit[$dtTanggal]+$dtEbstalk[$dtTanggal]+$dtFibre[$dtTanggal]+$dtNut[$dtTanggal]+$dtEffluent[$dtTanggal]+$dtSolid[$dtTanggal]+$dtusbcpo[$dtTanggal];
        $tab.="<td align=right>".number_format($total[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($total[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtFruitinebker[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtFruitinebker[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtCyclone[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtCyclone[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtLtds[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtLtds[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtClaybath[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtClaybath[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtusbpk[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtusbpk[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dthydrocyclone[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dthydrocyclone[$dtTanggal],2)."</td>";
		$total2[$dtTanggal]=$dtFruitinebker[$dtTanggal]+$dtCyclone[$dtTanggal]+$dtLtds[$dtTanggal]+$dtClaybath[$dtTanggal]+$dtusbpk[$dtTanggal]+$dthydrocyclone[$dtTanggal];
        $tab.="<td align=right>".number_format($total2[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($total2[$dtTanggal],2)."</td>";
        $tab.="</tr>";
    }
    else
    {*/
		...
		@$dtusbcpoSi[$dtTanggal]=(($dtusbcpo[$dtTanggal]*$dtTbsDiolah[$dtTanggal])+($dtusbcpoSi[$tglkmrn2]*$des[$tglkmrn2]))/$des[$dtTanggal];
		...
		@$dtusbpkSi[$dtTanggal]=(($dtusbpk[$dtTanggal]*$dtTbsDiolah[$dtTanggal])+($dtusbpkSi[$tglkmrn2]*$des[$tglkmrn2]))/$des[$dtTanggal];
		@$dthydrocycloneSi[$dtTanggal]=(($dthydrocyclone[$dtTanggal]*$dtTbsDiolah[$dtTanggal])+($dthydrocycloneSi[$tglkmrn2]*$des[$tglkmrn2]))/$des[$dtTanggal];
        ...
        $tab.="<td align=right>".number_format($dtFruit[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dFruitSi[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtEbstalk[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtEbstalkSi[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtFibre[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtFibreSi[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtNut[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtNutSi[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtEffluent[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtEffluentSi[$dtTanggal],2)."</td>";
		$tab.="<td align=right>".number_format($dtSolid[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtSolidSi[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtusbcpo[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtusbcpoSi[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($total[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($totalSi[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtFruitinebker[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtFruitinebkerSi[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtCyclone[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtCycloneSi[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtLtds[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtLtdsSi[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtClaybath[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtClaybathSi[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtusbpk[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dtusbpkSi[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dthydrocyclone[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($dthydrocycloneSi[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($total2[$dtTanggal],2)."</td>";
        $tab.="<td align=right>".number_format($total2Si[$dtTanggal],2)."</td>";
        $tab.="</tr>";
    /*}
    $ared+=1;
     */
