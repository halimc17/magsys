...
//$dateDt=dates_inbetwee($tgl_1,$tgl_2);
$dateDt=rangeTanggal($tgl_1,$tgl_2);
...
//            }
        ...
        echo $_SESSION['lang']['rPenerimaanTbs'].", ".$_SESSION['lang']['periode']." :".$_POST['tgl_1']." s.d. ".$_POST['tgl_2']."<br>";
        ...
        $sData="select notransaksi,kodeorg,jumlahtandan1 as jjg,beratbersih as netto,kodecustomer,substr(tanggal,1,10) as tanggal,
                supir,nokendaraan,nospb,thntm1,intex,kgpotsortasi, jammasuk, jamkeluar, millcode, kriteriabuah, trpcode
...
//                        if($tipeIntex==0)echo"<td>".$_SESSION['lang']['harga']."</td>";
                                echo"<td>".$_SESSION['lang']['sopir']."</td>
...
//                                        if($tipeIntex==0)echo"<td align=right>".number_format($harga,0)."</td>";
                                        ...
                                        $subBrtPot+=$rData['kgpotsortasi'];
                                         ...
                                         if($rowData==$rd)
                                         {
//                                             $tab.="<tr class=rowcontent><td colspan=7>".$intex[$rData['intex']]."</td>";
...
//                                    if($tipeIntex==0)echo"<td align=right>".number_format($subharga,0)."</td>";
                                    echo"<td colspan=2 align=right>Total (JJG)</td>
