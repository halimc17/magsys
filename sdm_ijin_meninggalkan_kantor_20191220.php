...
if(trim($_SESSION['empl']['tipelokasitugas'])=='HOLDING'){
   ...
   if($_SESSION['empl']['tipekaryawan']=='1' or $_SESSION['empl']['tipekaryawan']=='2' or $_SESSION['empl']['tipekaryawan']=='3'){
		$sOrg="select karyawanid, namakaryawan from ".$dbname.".datakaryawan where (tanggalkeluar = '0000-00-00' or tanggalkeluar > '".date("Y-m-d")."') and tipekaryawan in ('0','2','6','7','8','9') and lokasitugas='".$_SESSION['empl']['lokasitugas']."' and karyawanid!='".$_SESSION['standard']['userid']."' order by namakaryawan asc";
   }else{
		$sOrg="select karyawanid, namakaryawan from ".$dbname.".datakaryawan where (tanggalkeluar = '0000-00-00' or tanggalkeluar > '".date("Y-m-d")."') and tipekaryawan in ('0','2','6','7','8','9') and kodegolongan in ('DIR','KOM','MGR','SR MGR','ASST MGR','PJS MGR') and lokasitugas not like '%HO' and kodeorganisasi='".$_SESSION['empl']['kodeorganisasi']."' and karyawanid!='".$_SESSION['standard']['userid']."' or karyawanid=770 or kodejabatan=332 order by namakaryawan asc";
   }
}
...
if(trim($_SESSION['empl']['tipelokasitugas'])=='HOLDING'){
   ...
   $sHRD="select karyawanid, namakaryawan from ".$dbname.".datakaryawan where (tanggalkeluar = '0000-00-00' or tanggalkeluar > '".date("Y-m-d")."') and tipekaryawan in ('0','2','3','6','7','8','9') and bagian in ('HRA','HHRS') and lokasitugas not like '%HO' and karyawanid!='".$_SESSION['standard']['userid']."' and kodeorganisasi='".$_SESSION['empl']['kodeorganisasi']."' order by namakaryawan asc";
}
