...
function getStasiun(){
    ...
    tujuan='pabrik_lapservicehm_slave.php';
...
function showpopup(kdorg,stasiun,kodemesin,type,ev){
   ...
   showDialog1('Laporan HM '+kdorg+' '+stasiun+' '+kodemesin,content,width,height,ev); 
}
...
<legend><b><?php echo $_SESSION['lang']['laporan']." HM Service ".$_SESSION['lang']['mesin'];?></b></legend>
...
<tr><td colspan="2">
	<button onclick="zPreview('pabrik_lapservicehm_slave','<?php echo $arr;?>','printContainer')" class="mybutton" name="preview" id="preview">Preview</button>
	<button onclick="zExcel(event,'pabrik_lapservicehm_slave.php','<?php echo $arr;?>')" class="mybutton" name="preview" id="preview">Excel</button>
