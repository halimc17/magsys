...
//        @$dzArr[$bar1->afdeling][$bar1->tanggal]['jjgoutput']=$dzArr[$bar1->afdeling][$bar1->tanggal]['jjgmasak']/$dzArr[$bar1->afdeling][$bar1->tanggal]['hkdigunakan'];
...
//        @$dzArr[$kebun][$bar1->tanggal]['jjgoutput']=$dzArr[$kebun][$bar1->tanggal]['jjgmasak']/$dzArr[$kebun][$bar1->tanggal]['hkdigunakan'];
...
//        ";
    ...
    if(!empty($keyTgl))foreach($keyTgl as $tgl){
        ...
        <td ".$bgcoloraja." align=right>".number_format($dzArr[$kebun][$tgl]['hkpanen'])."</td>
        ...
        if(!empty($keyAfd))foreach($keyAfd as $afd){
			...
			<td align=right>".number_format($dzArr[$afd][$tgl]['hkpanen'])."</td>
