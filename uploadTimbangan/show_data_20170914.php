...
$DtTime=date("Y-m-d H:i:s");
 ...
 switch($proses)
 {
	 case'showData':
                 $message="Ambil Data";   
                 $sCob="SELECT * from ".$dbnm.".mstrxtbs WHERE (GI='0' or GI='') and netto != 0 and OUTIN=0 and PRODUCTCODE in ('40000001','40000002','40000003','40000004','40000005','40000006','40000007') ORDER BY `TICKETNO2` ASC limit 0,1";
                    //echo $sCob;exit();
	 ...
	 case'uploadData':
             ...
             mysql_query($strx,$conn);         
                        ...
                        $sIns="INSERT INTO ".$dbname.".pabrik_timbangan (`notransaksi`, `tanggal`, `kodeorg`, `kodecustomer`, `jumlahtandan1`, `kodebarang`, `jammasuk`, `beratmasuk`, `jamkeluar`, `beratkeluar`, `nokendaraan`, `supir`, `nospb`, `nokontrak`, `nodo`, `nosipb`, `thntm1`, `thntm2`, `thntm3`, `jumlahtandan2`, `jumlahtandan3`, `brondolan`, `username`, `millcode`, `beratbersih`,`intex`,`timbangonoff`,`kgpotsortasi`,`jjgsortasi`,`sloc`) 
						       VALUES ('".$idTimbangan2."','".$tglData2."','".$kbn2."','".$custData2."','".$jmlhjjg2."','".$kdBrg2."','".$jmMasuk2."','".$brtMsk2."','".$jmKeluar2."','".$brtOut2."','".$kdVhc2."','".$spir2."','".$spbno2."','".$kntrkNo2."','".$nodo2."','".$sibno2."','".$thnTnm2."','".$thnTnm22."','".$thnTnm32."','".$jmlhjjg22."','".$jmlhjjg32."','".$brndln2."','".$usrNm2."','".$pabrik2."','".$brtBrsih2."','".$inTex2."','0',".$potsortasi.",".$jmlhjjg2.",'".$sloc."')";     
