...
y='';
	switch (x){
      case 203:
	  y='Dibutuhkan Authority';
	  break;
	  case 400:
	  y='Error Server';
	  break;
	  case 403:
	  y='Anda dilarang masuk';
	  break;
	  case 404:
	  y='File tidak ditemukan';
	  break;
	  case 405:
	  y='Method tidak diijinkan';
	  break;
	  case 407:
	  y='Proxy Error';
	  break;
	  case 408:
	  y='Permintaan terlalu lama';
	  break;
	  case 409:
	  y='Query Conflict';
	  break;
	  case 414:
	  y='ULI terlalu panjang';
	  break;
	  case 412:
	  y='Variable terlalu banyak';
	  break;
	  case 415:
	  y='Unsupported Media Type';
	  break;
	  case 500:
	  y='Server busy, try submit later';
	  break;
	  case 502:
	  y='Bad gateway';
	  break;
	  case 505:
	  y='Browser anda terlalu tua';	    
      break;
}
return y;
}
