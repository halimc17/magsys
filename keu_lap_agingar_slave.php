<?php
	...
	while($bar_2=mysql_fetch_object($res_2)){
		if($no!=0 and $kdcust!=$bar_2->namacustomer){
			$stream.="<tr bgcolor='#00FFFF' class=rowcontent>
					<td colspan=5 bgcolor='#00FFFF' align='center'>Sub Total ".$kdcust."</td>
					<td bgcolor='#00FFFF' align='right'>".number_format($stnilai,2)."</td>
					<td colspan=1 bgcolor='#00FFFF' align='center'></td>
					<td colspan=1 bgcolor='#00FFFF' align='center'></td>
					<td bgcolor='#00FFFF' align='right'>".number_format($stbelum,2)."</td>
					<td bgcolor='#00FFFF' align='right'>".number_format($st01_30,2)."</td>
					<td bgcolor='#00FFFF' align='right'>".number_format($st31_60,2)."</td>
					<td bgcolor='#00FFFF' align='right'>".number_format($st61_90,2)."</td>
					<td bgcolor='#00FFFF' align='right'>".number_format($st91_xx,2)."</td>
					<td bgcolor='#00FFFF' align='right'>".number_format($stbayar,2)."</td>
					<td colspan=1 bgcolor='#00FFFF' align='center'></td>
					<td bgcolor='#00FFFF' align='right'>".number_format($stsaldo,2)."</td>
					<td colspan=1 bgcolor='#00FFFF' align='center'></td>
				</tr>";
			$stnilai=0;
			$stbelum=0;
		...
		if($tglhitung<=$bar_2->jatuhtempo){
			$stream.="<td align='right'>".number_format($bar_2->nilaiinvoice+$bar_2->nilaippn-$bar_2->nilaiklaim,2)."</td>";
		...
		$stnilai+=($bar_2->nilaiinvoice+$bar_2->nilaippn-$bar_2->nilaiklaim);
		$stbelum+=($bar_2->nilaiinvoice+$bar_2->nilaippn-$bar_2->nilaiklaim);
		$st01_30+=($bar_2->nilaiinvoice+$bar_2->nilaippn-$bar_2->nilaiklaim);
		$st31_60+=($bar_2->nilaiinvoice+$bar_2->nilaippn-$bar_2->nilaiklaim);
		$st61_90+=($bar_2->nilaiinvoice+$bar_2->nilaippn-$bar_2->nilaiklaim);
		$st91_xx+=($bar_2->nilaiinvoice+$bar_2->nilaippn-$bar_2->nilaiklaim);
		$stbayar+=$bar_2->jmlbayar;
		$stsaldo+=($bar_2->selisih<0 ? 0 : $bar_2->selisih);
	...
	if($gtnilai!=0){
		$stream.="<tr bgcolor='#00FFDD' class=rowcontent>
					<td colspan=5 bgcolor='#00FFDD' align='center'>Grand Total</td>
					<td bgcolor='#00FFDD' align='right'>".number_format($gtnilai,2)."</td>
					<td colspan=1 bgcolor='#00FFDD' align='center'></td>
					<td colspan=1 bgcolor='#00FFDD' align='center'></td>
					<td bgcolor='#00FFDD' align='right'>".number_format($gtbelum,2)."</td>
					<td bgcolor='#00FFDD' align='right'>".number_format($gt01_30,2)."</td>
					<td bgcolor='#00FFDD' align='right'>".number_format($gt31_60,2)."</td>
					<td bgcolor='#00FFDD' align='right'>".number_format($gt61_90,2)."</td>
					<td bgcolor='#00FFDD' align='right'>".number_format($gt91_xx,2)."</td>
					<td bgcolor='#00FFDD' align='right'>".number_format($gtbayar,2)."</td>
					<td colspan=1 bgcolor='#00FFDD' align='center'></td>
					<td bgcolor='#00FFDD' align='right'>".number_format($gtsaldo,2)."</td>
					<td colspan=1 bgcolor='#00FFDD' align='center'></td>
				</tr>";
	}
	$stream.="</tbody></table>";
